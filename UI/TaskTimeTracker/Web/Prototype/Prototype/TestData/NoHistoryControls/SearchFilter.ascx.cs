...
namespace Shared.UI.Web.ApplicationManagement.Development.TestData.NoHistoryControls
{
    public partial class SearchFilter : Framework.UI.Web.BaseClasses.ControlSearchFilter
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                var domainData = Framework.Components.DataAccess.SetupConfiguration.GetListConnectionKeyName(SessionVariables.RequestProfile.AuditId);
                ...
                var systemEntityData = Framework.Components.DataAccess.SetupConfiguration.Search(connectionKeyName, SessionVariables.RequestProfile.AuditId);
