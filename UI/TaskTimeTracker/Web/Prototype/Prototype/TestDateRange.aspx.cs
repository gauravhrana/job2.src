...
namespace Shared.UI.Web.ApplicationManagement.Development
{
	public partial class TestDateRange : Framework.UI.Web.BaseClasses.PageBasePage
	{
		...
		protected void btnSearch_Click(object sender, EventArgs e)
		{
			...
			PreferenceUtility.UpdateUserPreference("General", ApplicationCommon.DateRangeFormat, oDate.DateRangeFormatId.ToString());
			PreferenceUtility.UpdateUserPreference("General", ApplicationCommon.FromDateRange, oDate.FromDate.ToString());
