...
namespace Shared.UI.Web.ApplicationManagement.Development
{
	public partial class CheckDefaultView : Framework.UI.Web.BaseClasses.PageBasePage
	{
		...
		{			
			...
			DetailUserPreferenceCategoryId = PreferenceUtility.CreateUserPreferenceCategoryIfNotExists(SettingCategory, SettingCategory);
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			{				
				...
				drpGroupBy.SelectedValue = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.GroupBy, SettingCategory);				
				//ddlApplication.SelectedValue = PreferenceUtility.GetUserPreferenceByKey("DefaultViewApplicationId", SettingCategory);
		...
		protected void btnSearch_Click(object sender, EventArgs e)
		{
			...
			//PreferenceUtility.UpdateUserPreference(SettingCategory, "DefaultViewApplicationId", ddlApplication.SelectedValue);			
			PreferenceUtility.UpdateUserPreference(SettingCategory, ApplicationCommon.GroupBy, drpGroupBy.SelectedValue);
		}
