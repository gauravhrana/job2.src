...
{
	public partial class SampleByPerson : Framework.UI.Web.BaseClasses.PageBasePage
    {
        private void PopulateDropDownList()
        {
			...
			////Source List
			//var ApplicationRoleEntry = Framework.Components.ApplicationUser.ApplicationRole.GetList(SessionVariables.RequestProfile.AuditId);
        ...
        {
			//var RoleEntry = Framework.Components.ApplicationUser.ApplicationRole.GetList(SessionVariables.RequestProfile.AuditId);
