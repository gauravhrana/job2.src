...
namespace Shared.UI.Web.Configuration.MenuCategoryXMenu
{
	public partial class CrossReference : Framework.UI.Web.BaseClasses.PageBasePage
	{
		...
		private List<MenuDataModel> GetMenuList()
		{
			var dt = Framework.Components.Core.MenuDataManager.GetList(SessionVariables.RequestProfile.ApplicationId, SessionVariables.RequestProfile);
		...
		private List<MenuCategoryDataModel> GetMenuCategoryList()
		{
