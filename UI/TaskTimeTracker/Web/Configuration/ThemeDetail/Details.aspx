<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.Configuration.ThemeDetail.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        ...
        <tr>
            <td>
                <dc:DetailsControl ID="oDetailsControl" EntityName="ThemeDetail" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
