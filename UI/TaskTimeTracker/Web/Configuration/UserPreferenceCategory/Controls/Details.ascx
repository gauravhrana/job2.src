<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.Configuration.UserPreferenceCategory.Controls.Details" %>
...
<div class="panel panel-info table-bordered">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblUserPreferenceCategoryIdText" runat="server" CssClass="control-label">UserPreferenceCategoryId:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblUserPreferenceCategoryId" runat="server"></asp:Label></div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"></div>
            <div class="col-sm-10"><asp:PlaceHolder ID="dynUserPreferenceCategoryId" runat="server" /></div>
        </div>
