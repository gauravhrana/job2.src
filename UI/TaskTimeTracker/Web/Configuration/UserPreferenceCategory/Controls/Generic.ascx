<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.UserPreferenceCategory.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblUserPreferenceCategoryId" Text="UserPreferenceCategory Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtUserPreferenceCategoryId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtUserPreferenceCategoryId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
