<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" CodeBehind="Update.aspx.cs" Inherits="Shared.UI.Web.Configuration.ThemeCategory.Update" %>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Configuration/TabParentStructure/Controls/Generic.ascx" %>
