<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" CodeBehind="Delete.aspx.cs" Inherits="Shared.UI.Web.Configuration.ThemeCategory.Delete" %>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Configuration/ThemeCategory/Controls/Details.ascx" %>
