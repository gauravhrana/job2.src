<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.ThemeCategory.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblThemeCategoryId" Text="ThemeCategory Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtThemeCategoryId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtThemeCategoryId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
