    ...
    public partial class InlineUpdate : PageInlineUpdate
    {
        ...
        protected override DataTable GetData()
        {
            try
            {
                ...
                var selectedrows = new List<ApplicationDataModel>();
                ...
                if (!string.IsNullOrEmpty(SuperKey))
                {
                    ...
                    foreach (var entityKey in lstEntityKeys)
                    {
						...
						var result = Framework.Components.ApplicationUser.ApplicationDataManager.GetDetails(applicationdata, SessionVariables.RequestProfile);
                        selectedrows.Add(result);
                    }
                }
                else
                {
                    applicationdata.ApplicationId = SetId;
					var result = Framework.Components.ApplicationUser.ApplicationDataManager.GetDetails(applicationdata, SessionVariables.RequestProfile);
                    selectedrows.Add(result);
