<%@ Page Title="Clone" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true"
    CodeBehind="Clone.aspx.cs" Inherits="Shared.UI.Web.Configuration.ApplicationMode.Clone" %>

<%@ Register TagPrefix="gnrc" TagName="GenericControl" Src="~/Configuration/ApplicationMode/Controls/Generic.ascx" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <br />
    <br />
    <asp:Label ID="Label1" Text="Please enter the ApplicationModeId" runat="server" />
