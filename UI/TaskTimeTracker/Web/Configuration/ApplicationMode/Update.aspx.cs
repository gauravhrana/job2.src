...
namespace Shared.UI.Web.Configuration.ApplicationMode
{
    public partial class Update : Framework.UI.Web.BaseClasses.PageUpdate
    {
        ...
        private DataTable GetRunTimeFeatureData(int applicationModeId)
        {
            ...
            var runTimeFeaturedt = TaskTimeTracker.Components.BusinessLayer.Feature.RunTimeFeatureDataManager.Search(
                new RunTimeFeatureDataModel(){ RunTimeFeatureId = -1}, SessionVariables.RequestProfile);
