...
SearchColumns.Rows[i]["Name"].ToString(), PreferenceUtility.GetUserPreferenceByKey(SearchColumns.Rows[i]["Name"].ToString(),
category));
		...
		protected void SearchParametersRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
		{
			if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
			{
				...
				if (label != null && txtbox != null && dropdownlist != null)
				{
					...
					var obj = FieldConfigurationDataManager.GetDetails(data, SessionVariables.RequestProfile);
                    if (obj != null)
					{
