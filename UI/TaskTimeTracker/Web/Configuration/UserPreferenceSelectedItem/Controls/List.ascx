            ...
            <asp:GridView ID="GridView1" AllowSorting="true"   AutoGenerateColumns="false" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField HeaderText="Details"
                            ...
                            DataNavigateUrlFormatString="~/Configuration/UserPreferenceSelectedItem/Details.aspx?SetId={0}" />
                    ...
                    <asp:HyperLinkField HeaderText ="Update" 
                            ...
                            Text="Update" 
                            DataNavigateUrlFields="UserPreferenceSelectedItemId" 
                            DataNavigateUrlFormatString="~/Configuration/UserPreferenceSelectedItem/Update.aspx?SetId={0}" />

                    <asp:HyperLinkField HeaderText="Delete"
                            ItemStyle-HorizontalAlign="Center"
                            Text="Delete" 
                            DataNavigateUrlFields="UserPreferenceSelectedItemId"
                            DataNavigateUrlFormatString="~/Configuration/UserPreferenceSelectedItem/Delete.aspx?SetId={0}" />
                    ...
                    <asp:HyperLinkField 
                            ...
                            ItemStyle-HorizontalAlign="Center"
                            DataNavigateUrlFields="UserPreferenceSelectedItemId" 
                            DataNavigateUrlFormatString="~/Configuration/UserPreferenceSelectedItem/Clone.aspx?SetId={0}" />
                </Columns>
            </asp:GridView>                
        </td>
    </tr>
