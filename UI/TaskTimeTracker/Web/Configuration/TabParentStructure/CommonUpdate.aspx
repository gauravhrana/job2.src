<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommonUpdate.aspx.cs" MasterPageFile="~/MasterPages/Site.master"
    Inherits="Shared.UI.Web.Configuration.TabParentStructure.CommonUpdate" %>
...
<asp:Content ID="UpdateContent" ContentPlaceHolderID="MainContent" runat="server">
    <table >
        ...
        <tr>
            <td>
                <asp:GridView ID="MainGridView" PageSize="100" Width="1000px" AllowPaging="true"
                    AllowSorting="true" AutoGenerateColumns="true" runat="server" CellPadding="5"
                    ShowFooter="true">
                </asp:GridView>
            </td>
        </tr>
