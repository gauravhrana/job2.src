<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.TabParentStructure.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblTabParentStructureId" Text="TabParentStructure Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtTabParentStructureId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtTabParentStructureId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        <label class="col-sm-2 control-label" for="<%=txtIsAllTab.ClientID%>">IsAllTab:</label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtIsAllTab" runat="server" CssClass="form-control" ></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynIsAllTab" runat="server" />
        </div>
    </div> 
