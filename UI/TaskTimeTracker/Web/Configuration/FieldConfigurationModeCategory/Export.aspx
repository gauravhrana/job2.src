...
Inherits="Shared.UI.Web.Configuration.FieldConfigurationModeCategory.Export" %>
...
<asp:Content ID="exportHeading" ContentPlaceHolderID="SectionName" runat="server">
    <asp:Label ID="Label1" Text="FieldConfigurationModeCategorySearch" runat="server" ForeColor="Red" />
</asp:Content> 
