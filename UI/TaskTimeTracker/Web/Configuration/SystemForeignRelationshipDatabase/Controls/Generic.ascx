<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.SystemForeignRelationshipDatabase.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblSystemForeignRelationshipDatabaseId" Text="SystemForeignRelationshipDatabase Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtSystemForeignRelationshipDatabaseId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtSystemForeignRelationshipDatabaseId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynSystemForeignRelationshipDatabaseId" runat="server" />
        </div>
    </div>
