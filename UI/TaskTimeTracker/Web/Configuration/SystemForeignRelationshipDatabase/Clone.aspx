<%@ Page Title="Clone" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true"
    CodeBehind="Clone.aspx.cs" Inherits="Shared.UI.Web.Configuration.SystemForeignRelationshipDatabase.Clone" %>

<%@ Register TagPrefix="gnrc" TagName="GenericControl" Src="~/Configuration/SystemForeignRelationshipDatabase/Controls/Generic.ascx" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <br />
    <br />
    <asp:Label ID="Label1" Text="Please enter the SystemForeignRelationshipDatabaseId" runat="server" />
