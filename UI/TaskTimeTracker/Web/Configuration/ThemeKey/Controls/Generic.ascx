<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.ThemeKey.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblThemeKeyId" Text="ThemeKey Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtThemeKeyId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtThemeKeyId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
