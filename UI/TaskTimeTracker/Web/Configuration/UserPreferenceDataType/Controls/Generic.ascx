<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.UserReferenceDataType.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblUserPreferenceDataTypeId" Text="UserPreferenceDataType Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtUserPreferenceDataTypeId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtUserPreferenceDataTypeId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
