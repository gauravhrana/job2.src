<%@ Page Title="ApplicationRoute - List" Language="C#" MasterPageFile="~/MasterPages/Default.master"
    AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Shared.UI.Web.Configuration.ApplicationRoute.Default" %>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Configuration/ApplicationRoute/Controls/SearchFilter.ascx" %>
