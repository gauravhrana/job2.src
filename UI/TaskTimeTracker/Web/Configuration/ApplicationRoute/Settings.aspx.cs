...
namespace Shared.UI.Web.Configuration.ApplicationRoute
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.ApplicationRoute, "ApplicationRoute");
		}
		...
		{
			Response.Redirect("~/Configuration/ApplicationRoute/Default.aspx");
		}
	}
}