<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.Configuration.FieldConfigurationModeAccessMode.Controls.Details" %>
...
<div class="panel panel-info table-bordered">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblFieldConfigurationModeAccessModeIdText" runat="server" CssClass="control-label">FieldConfigurationModeAccessModeId:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblFieldConfigurationModeAccessModeId" runat="server"></asp:Label></div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"></div>
            <div class="col-sm-10"><asp:PlaceHolder ID="dynFieldConfigurationModeAccessModeId" runat="server" /></div>
        </div>
