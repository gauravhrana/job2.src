<%@ Page Title="Delete" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    Language="C#" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="Shared.UI.Web.Configuration.FieldConfigurationModeAccessMode.Delete" %>
<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Configuration/FieldConfigurationModeAccessMode/Controls/Details.ascx" %>
                ...
                <table  cellpadding="2" cellspacing="2" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            FieldConfigurationModeAccessMode Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
