...
namespace Shared.UI.Web.Configuration.FieldConfiguration.Controls
{
    public partial class Generic : Framework.UI.Web.BaseClasses.ControlGeneric
    {
		...
		public override int? Save(string action)
		{
			...
			if (action == "Insert")
			{
				if(!FieldConfigurationDataManager.DoesExist(data, SessionVariables.RequestProfile))
				{
		...
		private void SetupDropdown()
		{
			...
			var fieldConfigurationModeData = FieldConfigurationModeDataManager.GetEntityDetails(data, SessionVariables.RequestProfile, ApplicationCommon.ReturnAuditInfoFalse);
		...
		public void LoadData(int fieldConfigurationId, bool showId)
		{
			...
			// get data
			var items = FieldConfigurationDataManager.GetEntityDetails(data, SessionVariables.RequestProfile, ApplicationCommon.ReturnAuditInfoFalse);
