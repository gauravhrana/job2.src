...
namespace TaskTimeTracker.UI.Web.Areas.ReleaseNoteQualitative.Controllers
{
	public class DBComponentNameController : Controller
	{
		...
		public DBComponentNameDataModel GetById(int id)
		{
			...
			var list = DBComponentNameDataManager.GetEntityDetails(obj, SessionVariables.AuditId);
		...
		public ActionResult Index(string searchString, int? page, int? pageSize)
		{
			...
			var list = DBComponentNameDataManager.GetEntitySearch(obj, SessionVariables.AuditId);
		...
		public ActionResult Create(DBComponentNameDataModel obj)
		{
			...
			{
				DBComponentNameDataManager.Create(obj, SessionVariables.AuditId);
		...
		public ActionResult Edit(DBComponentNameDataModel obj)
		{
			if (ModelState.IsValid)
			{
				DBComponentNameDataManager.Update(obj, SessionVariables.AuditId);
				return RedirectToAction("Index");
			}
