...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblReportCategoryId" Text="ReportCategory Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtReportCategoryId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtReportCategoryId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
