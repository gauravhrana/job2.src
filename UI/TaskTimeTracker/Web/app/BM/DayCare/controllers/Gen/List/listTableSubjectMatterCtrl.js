	...
	angular.module('rootAppShell')
		.controller('listTableSubjectMatterCtrl', [
			...
			dataAutoCompleteService, userService, userPreferenceUtilityService) {
				...
				$scope.entityName = 'SubjectMatter';
				var entityService = $injector.get('subjectMatterService');
				...
				$scope.PrimaryKey = 'SubjectMatterId';
