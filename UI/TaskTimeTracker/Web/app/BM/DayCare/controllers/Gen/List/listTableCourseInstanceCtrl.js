...
angular.module('rootAppShell')
	.controller('listTableCourseInstanceCtrl', [
		...
		dataAutoCompleteService, userService, userPreferenceUtilityService) {
			...
			$scope.entityName = 'CourseInstance';
			var entityService = $injector.get('courseInstanceService');
			...
			$scope.PrimaryKey = 'CourseInstanceId';
