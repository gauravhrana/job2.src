	...
	angular.module('rootAppShell')
		.controller('listTableScheduleStateCtrl', [
			...
			dataAutoCompleteService, userService, userPreferenceUtilityService) {
				...
				$scope.entityName = 'ScheduleState';
				var entityService = $injector.get('scheduleStateService');
				...
				$scope.PrimaryKey = 'ScheduleStateId';
