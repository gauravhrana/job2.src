...
function MasterCtrl($scope, $cookieStore, $injector, menuService, $routeParams, $location, userService) {
    ...
    $scope.$on('$routeChangeSuccess', function () {
        ...
        if (angular.isDefined($cookieStore.get('applicationModuleDayCare'))) {

            // switch in cookie if different module encountered
            var cookieModule = $cookieStore.get('applicationModuleDayCare');
            if (cookieModule != $scope.module) {
                ...
                $cookieStore.put('applicationModuleDayCare', $scope.module);
