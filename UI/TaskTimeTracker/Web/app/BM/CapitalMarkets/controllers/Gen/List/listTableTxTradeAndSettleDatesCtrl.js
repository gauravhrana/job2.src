	...
	angular.module('rootAppShell')
		.controller('listTableTxTradeAndSettleDatesCtrl', [
			...
			dataAutoCompleteService, userService, userPreferenceUtilityService) {
				...
				$scope.entityName = 'TxTradeAndSettleDates';
				var entityService = $injector.get('txTradeAndSettleDatesService');
				...
				$scope.PrimaryKey = 'TxTradeAndSettleDatesId';
