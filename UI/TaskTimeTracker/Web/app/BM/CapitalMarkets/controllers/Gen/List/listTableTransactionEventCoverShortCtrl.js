										...
										angular.module('rootAppShell')
											.controller('listTableTransactionEventCoverShortCtrl', [
												...
												dataAutoCompleteService, userService, userPreferenceUtilityService) {
													...
													$scope.entityName = 'TransactionEventCoverShort';
													var entityService = $injector.get('transactionEventCoverShortService');
													...
													$scope.PrimaryKey = 'TransactionEventCoverShortId';
													...
													function onSuccessLoad(data) {
														...
														if ($scope.groupByColumn != undefined  && $scope.groupByColumn != -1) {
