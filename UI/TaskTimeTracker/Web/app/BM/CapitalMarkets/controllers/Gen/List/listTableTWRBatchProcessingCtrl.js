			...
			angular.module('rootAppShell')
				.controller('listTableTWRBatchProcessingCtrl', [
					...
					dataAutoCompleteService, userService) {
						...
						$scope.entityName = 'TWRBatchProcessing';
						var entityService = $injector.get('tWRBatchProcessingService');
						...
						$scope.PrimaryKey = 'TWRBatchProcessingId';
