					...
					angular.module('rootAppShell')
						.controller('listTableTxSettlementInfoCtrl', [
							...
							dataAutoCompleteService, userService, userPreferenceUtilityService) {
								...
								$scope.entityName = 'TxSettlementInfo';
								var entityService = $injector.get('txSettlementInfoService');
								...
								$scope.PrimaryKey = 'TxSettlementInfoId';
