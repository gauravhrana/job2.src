...
angular.module('rootAppShell')
	.controller('listTableTransactionEventCtrl', [
		...
		dataAutoCompleteService, userService, userPreferenceUtilityService) {
			...
			$scope.entityName = 'TransactionEvent';
			var entityService = $injector.get('transactionEventService');
			...
			$scope.PrimaryKey = 'TransactionEventId';
