			...
			angular.module('rootAppShell')
				.controller('listTableTxTradeFiguresCtrl', [
					...
					dataAutoCompleteService, userService, userPreferenceUtilityService) {
						...
						$scope.entityName = 'TxTradeFigures';
						var entityService = $injector.get('txTradeFiguresService');
						...
						$scope.PrimaryKey = 'TxTradeFiguresId';
