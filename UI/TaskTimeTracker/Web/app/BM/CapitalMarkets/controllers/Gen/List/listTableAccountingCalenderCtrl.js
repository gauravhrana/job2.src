	...
	angular.module('rootAppShell')
		.controller('listTableAccountingCalenderCtrl', [
			...
			dataAutoCompleteService, userService) {
				...
				$scope.entityName = 'AccountingCalender';
				var entityService = $injector.get('accountingCalenderService');
				...
				$scope.PrimaryKey = 'AccountingCalenderId';
