	...
	angular.module('rootAppShell')
		.controller('listTablePerformanceParametersCtrl', [
			...
			dataAutoCompleteService, userService) {
				...
				$scope.entityName = 'PerformanceParameters';
				var entityService = $injector.get('performanceParametersService');
				...
				$scope.PrimaryKey = 'PerformanceParametersId';
