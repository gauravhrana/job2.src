    ...
    public partial class List : Shared.UI.WebFramework.BaseControl
    {
        ...
        public bool HideData
        {
            set
            {
                ...
                this.GridView1.Columns[5].Visible = !value;
                this.GridView1.Columns[6].Visible = !value;
                this.GridView1.Columns[4].Visible = !value;
        ...
        private System.Data.DataTable GetData(string name)
        {
            ...
            var data = new DataModel.Framework.Audit.AuditAction();

            data.Name = name;

			var dt = Framework.Components.Audit.AuditActionDataManager.Search(data, SessionVariables.RequestProfile);
            return dt;
        }
