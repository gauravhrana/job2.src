...
{
	public partial class DeployScripts : Framework.UI.Web.BaseClasses.PageBasePage
	{
        ...
        public static string GetAceEditorNoOfLines()
        {
            ...
            aceEditorNoOfLines = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.AceEditorNoOfLines);
        ...
        {
            PreferenceUtility.UpdateUserPreference("General", ApplicationCommon.AceEditorNoOfLines, aceEditorNoOfLines);
        }
		...
		protected override void OnInit(EventArgs e)
		{
			...
			SettingCategory = "DeployScriptsDefaultView";
