...
namespace Shared.UI.Web.Admin.Log4Net
{
	public partial class ElapsedTimeData : PageCommon
	{
		...
		protected override void OnInit(EventArgs e)
		{
			...
			DetailUserPreferenceCategoryId = PreferenceUtility.CreateUserPreferenceCategoryIfNotExists("ElapsedTimeData", "ElapsedTimeData");
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				txtComputerName.Text = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.Computer);
				txtConnectionKey.Text = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.ConnectionKey);
				txtApplicationUserList.Text = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.LogUser);
				drpGroupBy.SelectedValue = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.GroupBy);
		...
		protected void btnSearch_Click(object sender, EventArgs e)
		{
			...
			PreferenceUtility.UpdateUserPreference("General", ApplicationCommon.Computer, ComputerName);
			PreferenceUtility.UpdateUserPreference("General", ApplicationCommon.ConnectionKey, ConnectionKey);
			PreferenceUtility.UpdateUserPreference("General", ApplicationCommon.LogUser, LogUser);
			PreferenceUtility.UpdateUserPreference("General", ApplicationCommon.GroupBy, drpGroupBy.SelectedValue);
		}
		#endregion
