    ...
    public partial class InlineUpdate : PageInlineUpdate
    {
        ...
        protected override DataTable GetData()
        {
            try
            {
                ...
                var selectedrows = new List<FileTypeDataModel>();
                ...
                if (!string.IsNullOrEmpty(SuperKey))
                {
                    ...
                    foreach (var entityKey in lstEntityKeys)
                    {
                        ...
                        var result = Framework.Components.Import.FileTypeDataManager.GetDetails(fileTypedata, SessionVariables.RequestProfile);
                        selectedrows.Add(result);
                    }
                }
                else
                {
                    fileTypedata.FileTypeId = SetId;
                    var result = Framework.Components.Import.FileTypeDataManager.GetDetails(fileTypedata, SessionVariables.RequestProfile);
                    selectedrows.Add(result);
