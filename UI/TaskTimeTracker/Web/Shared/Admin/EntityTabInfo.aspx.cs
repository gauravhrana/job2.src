...
namespace Shared.UI.Web.Admin
{
	public partial class EntityTabInfo : Framework.UI.Web.BaseClasses.PageBasePage
	{
		...
		protected void massageData()
		{
			...
			var TabParentDT = Framework.Components.Core.TabParentStructureDataManager.GetList(SessionVariables.RequestProfile);
			var TabChildrenDT = Framework.Components.Core.TabChildStructureDatManager.GetList(SessionVariables.RequestProfile);
			/*
