<%@ Page Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true" CodeBehind="Details.aspx.cs"
    EnableEventValidation="false" Inherits="Shared.UI.Web.Admin.SystemEntityType.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        ...
        <tr>
            <td>
                <dc:DetailsControl ID="oDetailsControl" EntityName="SystemEntityType" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
