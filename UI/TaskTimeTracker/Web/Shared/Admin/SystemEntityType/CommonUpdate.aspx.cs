...
namespace Shared.UI.Web.Admin.SystemEntityType
{
    public partial class CommonUpdate : PageCommonUpdate
    {
	    ...
	    {
			var UpdatedData = new List<SystemEntityTypeDataModel>();
			...
			for (var i = 0; i < SelectedData.Rows.Count; i++)
			{
				...
				var dt = Framework.Components.Core.SystemEntityTypeDataManager.GetEntityDetails(data, SessionVariables.RequestProfile);
        ...
        protected override DataTable GetEntityData(int? entityKey)
        {
			...
			var results = Framework.Components.Core.SystemEntityTypeDataManager.GetEntityDetails(systemEntityTypedata, SessionVariables.RequestProfile, ApplicationCommon.ReturnAuditInfoFalse);
