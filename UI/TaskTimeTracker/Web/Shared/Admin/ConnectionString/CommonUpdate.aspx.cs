...
namespace Shared.UI.Web.Admin.ConnectionString
{
	public partial class CommonUpdate : Framework.UI.Web.BaseClasses.PageCommonUpdate
	{
		...
		{
			var UpdatedData = new List<ConnectionStringDataModel>();
			...
			{				
				...
				var dt = Framework.Components.Core.ConnectionStringDataManager.GetEntityDetails(data, SessionVariables.RequestProfile);
		...
		protected override DataTable GetEntityData(int? entityKey)
		{
			...
			var results = Framework.Components.Core.ConnectionStringDataManager.GetEntityDetails(connectionStringdata, SessionVariables.RequestProfile, ApplicationCommon.ReturnAuditInfoFalse);
