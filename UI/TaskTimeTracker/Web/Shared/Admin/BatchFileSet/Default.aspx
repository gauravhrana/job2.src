<%@ Page Title="Default" Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="Shared.UI.Web.BatchFileSet.Default" %>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Shared/Admin/BatchFileSet/Controls/SearchFilter.ascx" %>
