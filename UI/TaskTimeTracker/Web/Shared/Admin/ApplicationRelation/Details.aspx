<%@ Page Title="ApplicationRelation - Details" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.Admin.ApplicationRelation.Details"
    EnableEventValidation="false" %>
<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/Admin/ApplicationRelation/Controls/Details.ascx" %>
