<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.SystemIntegrity.SearchKeyDetail.Details" %>
    
<%@ Register Src="~/Shared/Admin/SystemIntegrity/SearchKeyDetail/Controls/Details.ascx" TagName="DetailsControl" TagPrefix="dc" %>
