<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" MasterPageFile="~/MasterPages/Default.master"
    Inherits="Shared.UI.Web.SystemIntegrity.SearchKeyDetail.Default" %>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Shared/Admin/SystemIntegrity/SearchKeyDetail/Controls/SearchFilter.ascx" %>
