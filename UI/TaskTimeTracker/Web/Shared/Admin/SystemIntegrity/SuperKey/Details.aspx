<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.SystemIntegrity.SuperKey.Details" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/Admin/SystemIntegrity/SuperKey/Controls/Details.ascx" %>
