...
namespace Shared.UI.Web.SystemIntegrity.StoredProcedureLogRaw.Controls
{
	public partial class SearchFilter : Framework.UI.Web.BaseClasses.ControlSearchFilter
	{
		...
		public Framework.Components.LogAndTrace.StoredProcedureLogRawDataModel SearchParameters
		{
			get
			{
		...
		protected override void GetSettings()
		{
			...
			txtSearchConditionStoredProcedureLogId.Text = PreferenceUtility.GetUserPreferenceByKey(Framework.Components.LogAndTrace.StoredProcedureLogRawDataModel.DataColumns.StoredProcedureLogId, category);
		}
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				...
				oSearchActionBar.Setup("StoredProcedureLogRaw");	
			}
		}
