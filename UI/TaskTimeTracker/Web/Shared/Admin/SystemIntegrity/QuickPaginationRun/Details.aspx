<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.SystemIntegrity.QuickPaginationRun.Details" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/Admin/SystemIntegrity/QuickPaginationRun/Controls/Details.ascx" %>
