    ...
    public partial class Generic : Framework.UI.Web.BaseClasses.ControlGeneric
    {
        ...
        public void LoadData(int QuickPaginationRunId, bool showId)
        {
            ...
            if (oDetail != null)
            {
                ...
                if (!showId)
                {
                    txtQuickPaginationRunId.Text = oDetail.QuickPaginationRunId.ToString();
                ...
                txtWhereClause.Text			                = oDetail.WhereClause;
                txtSortClause.Text						    = oDetail.SortClause;
                txtApplicationUserId.Text					= oDetail.ApplicationUserId.ToString();
                ...
                txtExpirationTime.Text				        = oDetail.ExpirationTime.ToString();
                drpApplicationUser.SelectedValue            = oDetail.ApplicationUserId.ToString();
