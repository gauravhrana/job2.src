...
namespace Shared.UI.Web.SystemIntegrity.StoredProcedureLogDetail
{
	public partial class Default : Framework.UI.Web.BaseClasses.PageDefault
	{
		...
		{
			string strUserTheme = PreferenceUtility.GetUserTheme();
		}

		protected override DataTable GetData()
		{
			var dt = Framework.Components.LogAndTrace.StoredProcedureLogDetailDataManager.Search(oSearchFilter.SearchParameters, SessionVariables.RequestProfile);
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            PrimaryEntity = Framework.Components.DataAccess.SystemEntity.StoredProcedureLogDetail;
            PrimaryEntityKey = "StoredProcedureLogDetail";
            PrimaryEntityIdColumn = "StoredProcedureLogDetailId";
