...
namespace Shared.UI.Web.SystemIntegrity.StoredProcedureLogDetail.Controls
{
	public partial class SearchFilter : Framework.UI.Web.BaseClasses.ControlSearchFilter
	{
		...
		protected override void GetSettings()
		{
			...
			txtSearchConditionStoredProcedureLogId.Text = PreferenceUtility.GetUserPreferenceByKey(Framework.Components.LogAndTrace.StoredProcedureLogDetailDataModel.DataColumns.StoredProcedureLogId, category);
		}
