<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.SystemDevNumbers.Details" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/Admin/SystemIntegrity/SystemDevNumbers/Controls/Details.ascx" %>
