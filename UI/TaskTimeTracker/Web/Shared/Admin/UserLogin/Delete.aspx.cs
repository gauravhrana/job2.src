	...
	public partial class Delete : Framework.UI.Web.BaseClasses.PageDelete
	{
        ...
        protected override void OnInit(EventArgs e)
        {
            try
            {
                ...
                var detailsControlPath = "~/Shared/Admin/UserLogin/Controls/Details.ascx";
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {                
                ...
                foreach (string index in deleteIndexList)
                {
                    ...
                    data.UserLoginId = int.Parse(index);
                    Framework.Components.LogAndTrace.UserLoginDataManager.Delete(data, SessionVariables.RequestProfile);
                }

                //Framework.Components.Audit.AuditHistory.DeleteDataBySystemEntity(DeleteIds, (int)Framework.Components.DataAccess.SystemEntity.Country, AuditId);
        ...
        {
            Response.Redirect(Page.GetRouteUrl("UserLoginEntityRoute", new { Action = "Default" }), false);
        }
