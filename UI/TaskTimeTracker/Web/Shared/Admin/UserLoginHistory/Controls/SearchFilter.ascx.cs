	...
	public partial class SearchFilter : Framework.UI.Web.BaseClasses.ControlSearchFilter
	{
		...
		public Framework.Components.LogAndTrace.UserLoginHistoryDataModel SearchParameters
		{
			get
			{
				...
				if (PreferenceUtility.GetUserPreferenceByKeyAsBoolean(Framework.Components.LogAndTrace.UserLoginHistoryDataModel.DataColumns.UserName + "Visibility", SettingCategory))
				{
				...
				if (PreferenceUtility.GetUserPreferenceByKeyAsBoolean(Framework.Components.LogAndTrace.UserLoginHistoryDataModel.DataColumns.DateRangeValue + "Visibility", SettingCategory))
				{
