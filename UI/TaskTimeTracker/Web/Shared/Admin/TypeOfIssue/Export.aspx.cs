...
namespace Shared.UI.Web.Admin.TypeOfIssue
{
	public partial class Export : Shared.UI.WebFramework.BasePage
	{
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.TypeOfIssue, "DBColumns", SessionVariables.RequestProfile);
		}
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				oList.Setup("TypeOfIssue", " ", "TypeOfIssueId", false, GetData, GetColumns, false);
