<%@ Page Title="Clone" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true"
    CodeBehind="Delete.aspx.cs" Inherits="Shared.UI.Web.Admin.SubscriberApplicationRole.Delete" EnableEventValidation="false" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/Admin/SubscriberApplicationRole/Controls/Details.ascx" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            SubscriberApplicationRole Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
