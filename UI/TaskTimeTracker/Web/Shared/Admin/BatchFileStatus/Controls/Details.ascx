<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.BatchFileStatus.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
      ...
      <tr>
            <td class="ralabel">
                <asp:Label ID="lblBatchFileStatusIdText" runat="server" >BatchFileStatusId :</asp:Label>
            </td>
            <td>
                <asp:Label ID="lblBatchFileStatusId" runat="server"></asp:Label>
            </td>
            <td>
