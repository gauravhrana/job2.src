<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.BatchFileStatus.Controls.Generic" %>
        ...
        <tr>
            <td>
                <table   >
                    <tr>
                        <td class="ralabel">
                            <asp:Label ID="lblBatchFileStatusId" Text="BatchFileStatusId:" runat="server"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtBatchFileStatusId" runat="server"></asp:TextBox>
                        </td>
                        <td>
