...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblUserLoginStatusId" Text="UserLoginStatus Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtUserLoginStatusId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtUserLoginStatusId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
