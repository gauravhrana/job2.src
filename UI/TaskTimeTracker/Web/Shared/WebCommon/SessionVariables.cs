    ...
    public class SessionVariables
    {
		...
		public static string UserMenuCategory
		{
			get
			{
				...
				{
                    HttpContext.Current.Session["UserMenuCategory"] = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.UserMenuCategory);
				}
        ...
        public static int UserApplicationMode
        {
            get
            {
                ...
                {
                    HttpContext.Current.Session["UserApplicationModeId"] = PreferenceUtility.GetUserPreferenceByKeyAsInt(ApplicationCommon.UserApplicationModeId);
                }
		...
		public static List<MenuCategoryDataModel> MenuCategoryList 
		{
			get
			{
                ...
                return (List<MenuCategoryDataModel>)(HttpContext.Current.Session["MenuCategoryList"]);
			}
			set
			{
        ...
        public static List<ApplicationModeDataModel> ApplicationModeList
		{
			get
			{
                ...
                return (List<ApplicationModeDataModel>)(HttpContext.Current.Session["ApplicationModeList"]);
			}
			set
			{
        ...
        public static int DefaultRowCount
        {
            get
            {
                ...
                {
                    HttpContext.Current.Session["DefaultRowCount"] = PreferenceUtility.GetUserPreferenceByKeyAsInt(ApplicationCommon.DefaultRowCountKey);
                }
        ...
        public static string UserDateFormat
        {
            get
            {
                ...
                {
                    HttpContext.Current.Session["UserDateFormat"] = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.UserDateFormat);
                }
        ...
        public static string UserTimeFormat
        {
            get
            {
                ...
                {
                    HttpContext.Current.Session["UserTimeFormat"] = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.UserTimeFormat);
                }
		...
		public static List<JiraDataModel> ClosedJiraData
		{
			get
			{
				var objClosedJiras = HttpContext.Current.Session["ClosedJiras"];

				if (objClosedJiras == null)
				{
					var data = new JiraDataModel();
					objClosedJiras = TaskTimeTracker.Components.Module.TimeTracking.JiraDataManager.GetAllClosedJiras(data);

					HttpContext.Current.Session["ClosedJiras"] = objClosedJiras;
				}

				return (List<JiraDataModel>)objClosedJiras;
			}
			set
			{
				HttpContext.Current.Session["ClosedJiras"] = value;
			}
		}

		public static List<JiraDataModel> OpenJiraData
		{
			get
			{
				var objOpenJiras = HttpContext.Current.Session["OpenJiras"];

				if (objOpenJiras == null)
				{
					var data = new JiraDataModel();
					objOpenJiras = TaskTimeTracker.Components.Module.TimeTracking.JiraDataManager.GetAllOpenJiras(data);

					HttpContext.Current.Session["OpenJiras"] = objOpenJiras;
				}

				return (List<JiraDataModel>)objOpenJiras;
			}
			set
			{
				HttpContext.Current.Session["OpenJiras"] = value;
			}
		}
    }
}