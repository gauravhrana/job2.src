...
namespace Shared.WebCommon.UI.Web
{
	public class ApplicationVariables
	{
        ...
        public static string EODEmailDateFormat
        {
            get
            {
                if (HttpContext.Current.Application["EODEmailDateFormat"] == null)
                {
                    HttpContext.Current.Application["EODEmailDateFormat"] = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.EODEmailDateFormat);
                }
                return Convert.ToString(HttpContext.Current.Application["EODEmailDateFormat"]);
            }
            set
            {
                HttpContext.Current.Application["EODEmailDateFormat"] = value;
            }
        }
