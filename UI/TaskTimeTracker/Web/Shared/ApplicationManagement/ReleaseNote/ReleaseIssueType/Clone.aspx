<%@ Page Title="Clone" Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master"
    CodeBehind="Clone.aspx.cs" Inherits="Shared.UI.Web.ApplicationManagement.ReleaseIssueType.Clone" %>

<%@ Register TagPrefix="gnrc" TagName="GenericControl" Src="~/Shared/ApplicationManagement/ReleaseNote/ReleaseIssueType/Controls/Generic.ascx" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <br />
    <br />
    <asp:Label ID="Label1" Text="Please enter the ReleaseIssueTypeId" runat="server" />
