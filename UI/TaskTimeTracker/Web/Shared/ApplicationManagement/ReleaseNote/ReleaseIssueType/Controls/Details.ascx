<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.ApplicationManagement.ReleaseIssueType.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblReleaseIssueTypeIdText" runat="server"><span>Issue Type Id : </span></asp:Label>
            </td>
            <td>
                <asp:Label ID="lblReleaseIssueTypeId" runat="server"></asp:Label>
            </td>
            <td>
