<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Export.Master" CodeBehind="Export.aspx.cs" Inherits="Shared.UI.Web.ApplicationManagement.ReleaseIssueType.Export" %>
...
<asp:Content ID="exportHeading" ContentPlaceHolderID="SectionName" runat="server">
    <asp:Label ID="Label1" Text="ReleaseIssueTypeSearch" runat="server" ForeColor="Red" />
</asp:Content> 
