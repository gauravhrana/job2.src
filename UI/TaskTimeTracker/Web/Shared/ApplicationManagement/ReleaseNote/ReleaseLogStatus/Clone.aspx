<%@ Page Title="Clone" Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master"
    CodeBehind="Clone.aspx.cs" Inherits="Shared.UI.Web.ApplicationManagement.ReleaseLogStatus.Clone" %>

<%@ Register TagPrefix="gnrc" TagName="GenericControl" Src="~/Shared/ApplicationManagement/ReleaseNote/ReleaseLogStatus/Controls/Generic.ascx" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <br />
    <br />
    <asp:Label ID="Label1" Text="Please enter the ReleaseLogStatusId" runat="server" />
