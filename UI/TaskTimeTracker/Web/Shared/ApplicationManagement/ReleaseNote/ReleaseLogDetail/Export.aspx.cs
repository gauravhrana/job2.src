...
namespace Shared.UI.Web.ApplicationManagement.ReleaseLogDetail
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
        ...
        {
			var validColumns = FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.ReleaseLogDetail, "Default", SessionVariables.RequestProfile);
            return validColumns;
        }
