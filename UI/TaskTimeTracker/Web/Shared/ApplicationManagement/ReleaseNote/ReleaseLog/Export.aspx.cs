...
namespace Shared.UI.Web.ApplicationManagement.ReleaseLog
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
        ...
        {
			var validColumns = FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.ReleaseLog, "Default", SessionVariables.RequestProfile);
            return validColumns;
        }
