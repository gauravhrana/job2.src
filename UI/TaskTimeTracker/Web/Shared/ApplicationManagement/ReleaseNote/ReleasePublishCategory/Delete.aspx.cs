    ...
    public partial class Delete : Framework.UI.Web.BaseClasses.PageDelete
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            foreach (string index in deleteIndexList)
            {
				...
				Framework.Components.ReleaseLog.ReleasePublishCategoryDataManager.Delete(data, SessionVariables.RequestProfile);
            }
		...
		{
			Framework.Components.Audit.AuditHistoryDataManager.DeleteDataBySystemEntity(DeleteIds, (int)Framework.Components.DataAccess.SystemEntity.ReleasePublishCategory, SessionVariables.RequestProfile);
