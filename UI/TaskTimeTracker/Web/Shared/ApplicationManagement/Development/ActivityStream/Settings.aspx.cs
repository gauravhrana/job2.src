...
namespace Shared.UI.Web.ApplicationManagement.Development.ActivityStream
{
    public partial class Settings : WebFramework.BasePage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            PreferenceUtility.UpdateUserPreference(CategoryName, ActivityStreamCommon.DateRangeKey, myGenericControl.Interval);
            PreferenceUtility.UpdateUserPreference(CategoryName, ActivityStreamCommon.BackGroungColorKey, myGenericControl.Color);
            PreferenceUtility.UpdateUserPreference(CategoryName, ActivityStreamCommon.WidthKey, myGenericControl.Width);
            PreferenceUtility.UpdateUserPreference(CategoryName, ActivityStreamCommon.DataTypeKey, myGenericControl.DataType);
            PreferenceUtility.UpdateUserPreference(CategoryName, ActivityStreamCommon.HeightKey, myGenericControl.Height);
            PreferenceUtility.UpdateUserPreference(CategoryName, ActivityStreamCommon.ActivityStreamAuditId, myGenericControl.ActivityStreamAuditId);
            PreferenceUtility.UpdateUserPreference(CategoryName, ActivityStreamCommon.ActivityStreamPageSize, myGenericControl.ActivityStreamPageSize);
            PreferenceUtility.UpdateUserPreference(CategoryName, ActivityStreamCommon.ActivityStreamPagingStyle, myGenericControl.PagingStyle);
