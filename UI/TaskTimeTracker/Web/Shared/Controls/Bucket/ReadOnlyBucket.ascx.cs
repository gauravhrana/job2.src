...
namespace Shared.UI.Web.Controls
{
    public partial class ReadOnlyBucket : BaseControl
    {
        ...
        public void ConfigureBucket(string strEntity, int setId, int TabCount,
            GetListDelegate getListDelegate, GetDataDelegate getDataDelegate, GetSelectDelegate selectDelegate)
        {
        ...
        public void ReloadBuckerList(bool isRelaodSource)
        {
            ClearItems(lstSource);
            ClearItems(lstTarget);
