...
namespace Shared.UI.Web.Controls
{
    public partial class ApplicationUserNameControl : BaseControl
    {
        ...
        public void LoadData(int applicationUserId)
        {
			...
			var obj = ApplicationUserDataManager.GetDetails(oData, SessionVariables.RequestProfile);

            if (obj != null)
            {
                txtApplicationUserName.Text           = obj.ApplicationUserName;
                ...
                drpApplicationUserTitle.SelectedValue = Convert.ToString(obj.ApplicationUserTitleId);
                txtApplicationUserTitle.Text          = Convert.ToString(obj.ApplicationUserTitleId);
            }
            else
            {
