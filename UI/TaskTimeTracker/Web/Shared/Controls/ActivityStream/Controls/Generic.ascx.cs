...
{
    public partial class Generic : Shared.UI.WebFramework.BaseControl
    {
        ...
        public void LoadData(string categoryName, bool showId)
        {
            ...
            if (userPreferenceSettingsDictionary.Values.Count > 0)
            {
                ...
                txtStartDate.Text                  = String.Format("{0:MM/dd/yyyy}", DateTime.Now);
        ...
        private DataTable LoadSystemEntities()
        {
            var dtSystemEntities = Framework.Components.Core.SystemEntityType.GetList(SessionVariables.AuditId);
            var dv = dtSystemEntities.DefaultView;
        ...
        private void LoadSource()
        {
            ...
            lstSource.DataTextField = Framework.Components.Core.SystemEntityType.DataColumns.EntityName;
            lstSource.DataValueField = Framework.Components.Core.SystemEntityType.DataColumns.SystemEntityTypeId;
            lstSource.DataBind();
        }
        ...
        private void LoadCurrentTarget()
        {
            ...
            {
                var entityText = ((Framework.Components.DataAccess.SystemEntity)Convert.ToInt32(dr[Framework.Components.UserPreference.UserPreferenceSelectedItem.DataColumns.Value])).ToString();
                var lstItem = new ListItem(entityText, Convert.ToString(dr[Framework.Components.UserPreference.UserPreferenceSelectedItem.DataColumns.Value]));                
        ...
        protected void btnFind_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtSearchSource.Text.Trim()) && SourceTable != null)
            {
                ...
                rowFilter = "[EntityName] like '%" + txtSearchSource.Text.Trim() + "%'";
