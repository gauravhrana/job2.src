...
namespace Shared.UI.Web.Controls
{
    ...
    public partial class HistoryList : BaseControl
    {
        ...
        */
        ...
        public void Setup(string _tableName, string _tableFolder, string _primaryKey, bool _pageLoad, bool _isPaging, int systemEntityId, int entityKey, string UserPreferenceCategory = "")
        {
            var tableName = "AuditHistory";
            var primaryKey = "AuditHistoryId";
            var isPaging = true;
            ...
            var userGrouping = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.HistoryAdvancedModeGroupingKey, userPreferenceCategory);
            if (userGrouping == "timeinterval")
            {
                AdvancedModeGrouping = GridViewAdvancedModeGrouping.TimeInterval;
                txtInterval.Text = Convert.ToString(ConvertTimeIntervalInMinute(PreferenceUtility.GetUserPreferenceByKeyAsInt(ApplicationCommon.HistoryAdvancedModeIntervalKey)));
		...
		public void Setup(SystemEntity systemEntity, int entityKey, string userPreferenceCategory = "")
		{
			Setup((int) systemEntity, entityKey, userPreferenceCategory);
		}
        ...
        protected void drpGridViewMode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                txtInterval.Text = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.HistoryAdvancedModeIntervalKey);
