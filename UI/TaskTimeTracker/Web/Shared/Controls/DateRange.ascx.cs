...
namespace Shared.UI.Web.Controls
{
    public partial class DateRangeControl : BaseControl
    {
		...
		public void SaveDateValues(string daterangevalue, string fromdate, string todate)
		{
			...
			PreferenceUtility.UpdateUserPreference(SettingCategory, ApplicationCommon.DateRangeFormat, daterangevalue);
        ...
        {
			chkDate.Attributes.Add("onclick", "chkdate_checkedchanged"+ GetKey() +"();");
			drpDateRange.Attributes.Add("onchange", "Fillup" + GetKey() + "();");
