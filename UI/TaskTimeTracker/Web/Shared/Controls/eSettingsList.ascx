<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="eSettingsList.ascx.cs" Inherits="Shared.UI.Web.Controls.eSettingsListControl" %>
                    ...
                    <ItemTemplate>
                        <table class="DetailControlBorder">
                            <tr>
                                ...
                                <td style="text-align: right;">Formatting: 
                                </td>
                                <td style="width: 100px;">
                                    <%# Eval("Formatting")%>
                                </td>
                                <td style="text-align: right;">Control Type: 
                                </td>
                                <td style="width: 100px;">
                                    <%# Eval("ControlType")%>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;">GridViewPriority: 
                                </td>
                                <td style="width: 100px;">
                                    <%# Eval("GridViewPriority")%>
                                </td>
                                <td style="text-align: right;">HorizontalAlignment: 
                                </td>
                                <td style="width: 100px;">
                                    <%# Eval("HorizontalAlignment")%>
                                </td>

                            </tr>
                            <tr>
                                <td style="text-align: right;">DetailsViewPriority: 
                                </td>
                                <td style="width: 100px;">
                                    <%# Eval("DetailsViewPriority")%>
                                </td>
    ...
    <tr>
        <td>
            <div id="griddiv" runat="server">
                <asp:GridView ID="EditableGridView" AllowSorting="true" PageSize="100" runat="server" AutoGenerateColumns="true"
                    AllowPaging="true" AutoGenerateEditButton="false"
                    AutoGenerateDeleteButton="true" OnRowDeleting="EditableGridView_RowDeleting"
    ...
    <tr>
        <td>
            <div id="Div1" runat="server" class="DetailControlBorder">
                <asp:Repeater ID="EditableRepeater" runat="server">
                    <HeaderTemplate>
                        <table>
                            <tr>
                                <td>
                    ...
                    <ItemTemplate>
                        <table class="DetailControlBorder">
                            <tr>
                                ...
                                <td style="width: 100px;">
                                    <asp:TextBox ID="txtName" runat="server" Text='<%# Bind("Name") %>' Columns="16"></asp:TextBox>
                                </td>
                                <td style="text-align: right;">Value: 
                                </td>
                                <td style="width: 100px;">
                                    <asp:TextBox ID="txtValue" runat="server" Text='<%# Bind("Value") %>' Columns="16"></asp:TextBox>
                                </td>
                                <td style="text-align: right;">Formatting: 
                                </td>
                                <td style="width: 100px;">
                                    <asp:TextBox ID="txtFormatting" runat="server" Text='<%# Bind("Formatting") %>' Columns="16"></asp:TextBox>
                                </td>
                                <td style="text-align: right;">Control Type: 
                                </td>
                                <td style="width: 100px;">
                                    <asp:TextBox ID="txtControlType" runat="server" Text='<%# Bind("ControlType") %>' Columns="16"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right;">Width: 
                                ...
                                <td style="width: 100px;">
                                    <asp:TextBox ID="txtWidth" runat="server" Text='<%# Bind("Width") %>' Columns="16"></asp:TextBox>
                                </td>
                                <td style="text-align: right;">GridViewPriority: 
                                </td>
                                <td style="width: 100px;">
                                    <asp:TextBox ID="txtGridViewPriority" runat="server" Text='<%# Bind("GridViewPriority") %>' Columns="16"></asp:TextBox>
                                </td>
                                <td style="text-align: right;">HorizontalAlignment: 
                                </td>
                                <td style="width: 100px;">
                                    <asp:TextBox ID="txtHorizontalAlignment" runat="server" Text='<%# Bind("HorizontalAlignment") %>' Columns="16"></asp:TextBox>
                                </td>

                                <td style="width: 100px;">
                                    <asp:HiddenField ID="hdnFieldConfigurationId" runat="server" Value='<%# Bind("FieldConfigurationId") %>'></asp:HiddenField>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 100px;">
                                    <asp:TextBox ID="txtDetailsViewPriority" runat="server" Text='<%# Bind("DetailsViewPriority") %>' Columns="16"></asp:TextBox>
                                </td>
                         ...
                         <tr>
                            ...
                            <td style=" width:100px;">
                                <asp:TextBox ID="txtAEFLModeId" runat="server" Text='<%# Bind("FieldConfigurationModeId") %>' Columns="16"></asp:TextBox>
                            </td>
