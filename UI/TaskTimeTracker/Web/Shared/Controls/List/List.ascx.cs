...
namespace Shared.UI.Web.Controls
{
	public partial class ListControl : BaseControl
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			// TODO: Move to CSS
			//GridActionBarBackgroundColor = PreferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.GridActionBarBackgroundColor);
			//GridActionBarForegroundColor = PreferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.GridActionBarForegroundColor);
			//GridActionBarFontFamily = PreferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.GridActionBarFontFamily);
			//GridActionBarFontSize = PreferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.GridActionBarFontSize);
			...
			var isButtonPanelVisible = PreferenceUtility.GetUserPreferenceByKeyAsBoolean(ApplicationCommon.ControlVisible, SettingCategory + "ButtonPanel");
			var isAdvancedButtonPanelVisible = PreferenceUtility.GetUserPreferenceByKeyAsBoolean(ApplicationCommon.ControlVisible, SettingCategory + "AdvancedButtonPanel");

			//var isPagingPangelVisible        = PreferenceUtility.GetUserPreferenceByKeyAsBoolean(ApplicationCommon.ControlVisible, this.SettingCategory + "PagingPanel");
			var isSortingPangelVisible = PreferenceUtility.GetUserPreferenceByKeyAsBoolean(ApplicationCommon.ControlVisible, SettingCategory + "SortingPanel");
			var isChcekedBoxColumnVisible = PreferenceUtility.GetUserPreferenceByKeyAsBoolean(ApplicationCommon.ControlVisible, SettingCategory + "CheckedBoxColumn");
			var isFontPanelVisible = PreferenceUtility.GetUserPreferenceByKeyAsBoolean(ApplicationCommon.ControlVisible, SettingCategory + "FontPanel");
		...
		protected void MainGridView_Sorted(object sender, EventArgs e)
		{
			...
			var userSortArrowStyle = PreferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.SortArrowStyle);
