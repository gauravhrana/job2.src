...
namespace Shared.UI.Web.HelpPage.Controls
{
    public partial class Generic : Framework.UI.Web.BaseClasses.ControlGeneric
    {
        ...
        public void LoadData(int HelpPageId, bool showId)
        {
			...
			var oHelpPage = Framework.Components.Core.HelpPageDataManager.GetDetails(data, SessionVariables.RequestProfile);
            ...
            if (oHelpPage != null)
            {
                ...
                if (!showId)
                {
                    ...
                    txtHelpPageId.Text = oHelpPage.HelpPageId.ToString();
                ...
                txtHelpContent.Text               = oHelpPage.Content;
                txtName.Text                      = oHelpPage.Name;
                txtSortOrder.Text                 = oHelpPage.SortOrder.ToString();
                txtSystemEntityTypeId.Text        = oHelpPage.SystemEntityTypeId.ToString();
                drpSystemEntityType.SelectedValue = oHelpPage.SystemEntityTypeId.ToString();
                drpHelpPageContext.SelectedValue  = oHelpPage.HelpPageContextId.ToString();
                txtHelpPageContextId.Text         = oHelpPage.HelpPageContextId.ToString();
               
				oUpdateInfo.LoadText(oHelpPage);
            }
            else
            {
