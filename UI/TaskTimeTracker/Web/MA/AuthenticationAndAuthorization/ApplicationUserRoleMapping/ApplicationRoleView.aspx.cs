...
namespace Shared.UI.Web.AuthenticationAndAuthorization.ApplicationUserRoleMapping
{
	public partial class ApplicationRoleView : Shared.UI.WebFramework.BasePage
	{
		...
		private void PopulateDropDownList()
		{
			...
			lstSource.DataSource = ApplicationUserEntry;
		...
		private void CleanUp()
		{
			...
			foreach (DataRow row in CurrentAssignment.Rows)
			{
				...
				var appRole = Framework.Components.ApplicationUser.ApplicationUserDataManager.GetDetails(data, SessionVariables.RequestProfile);
				item.Value = appRole.ApplicationUserId.ToString();
				item.Text = appRole.FullName;
