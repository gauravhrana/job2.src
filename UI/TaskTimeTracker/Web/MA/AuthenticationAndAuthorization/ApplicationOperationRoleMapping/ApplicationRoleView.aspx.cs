...
namespace Shared.UI.Web.AuthenticationAndAuthorization.ApplicationOperationRoleMapping
{
    public partial class ApplicationRoleView : Shared.UI.WebFramework.BasePage
    {
        ...
        private void PopulateDropDownList()
        {
            ...
            // Source List
			var ApplicationOperationEntry = Framework.Components.ApplicationUser.ApplicationOperationDataManager.GetList(SessionVariables.RequestProfile);
            lstSource.DataSource = ApplicationOperationEntry;
            lstSource.DataTextField = "Name";
            lstSource.DataValueField = "ApplicationOperationId";
            lstSource.DataBind();
        ...
        private void PopulateTarget()
        {
            ...
            lstTarget.DataTextField = "ApplicationOperation";
            lstTarget.DataValueField = "ApplicationOperationId";
            lstTarget.DataBind();
        }
        ...
        private void CleanUp()
        {
            ...
            foreach (DataRow row in CurrentAssignment.Rows)
            {
                ...
                item.Value = obj.ApplicationOperationId.ToString();
                item.Text = obj.Name;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
			...
			Framework.Components.ApplicationUser.ApplicationOperationXApplicationRoleDataManager.DeleteByApplicationRole(ParentId, SessionVariables.RequestProfile);

            // Save final list
			Framework.Components.ApplicationUser.ApplicationOperationXApplicationRoleDataManager.CreateByApplicationRole(ParentId, finalList, SessionVariables.RequestProfile);
        }
