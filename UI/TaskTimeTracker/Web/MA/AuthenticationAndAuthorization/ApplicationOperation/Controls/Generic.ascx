<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.AuthenticationAndAuthorization.ApplicationOperation.Controls.Generic" %>
            ...
            <td>
                <table   >
                    <tr>
                        <td class="ralabel">
                            <b>
                                <asp:Label ID="lblApplicationOperationId" Text="ApplicationOperationId:"
                                    runat="server"></asp:Label></b>
                        </td>
                        <td>
                            <asp:TextBox ID="txtApplicationOperationId" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:PlaceHolder ID="dynApplicationOperationId" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="ralabel">
                    ...
                    <tr>
                        <td class="ralabel">
                            <asp:Label ID="lblOperationValue" Text="OperationValue:" runat="server"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtOperationValue" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:PlaceHolder ID="dynOperationValue" runat="server" />
                        </td>
                    </tr>
                </table> 
