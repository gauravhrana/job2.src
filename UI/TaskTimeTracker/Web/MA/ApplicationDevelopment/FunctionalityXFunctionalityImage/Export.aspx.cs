...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityXFunctionalityImage
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
        ...
        {
            return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.FunctionalityXFunctionalityImage, "DBColumns", SessionVariables.RequestProfile);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("FunctionalityXFunctionalityImage", "Shared/QualityAssurance", "FunctionalityXFunctionalityImageId", false, GetData, GetColumns, false);
