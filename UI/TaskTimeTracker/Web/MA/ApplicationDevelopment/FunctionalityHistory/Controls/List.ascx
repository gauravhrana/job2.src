<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityHistory.Controls.List" %>
    ...
    <tr>
        <td>
            <asp:GridView ID="GridView1" AllowSorting="true"   AutoGenerateColumns="false" runat="server" 
                ...
                <Columns>
                    <asp:BoundField DataField="FunctionalityHistoryId" SortExpression="FunctionalityHistoryId" HeaderText="ID" ItemStyle-HorizontalAlign="Center"/>
                    ...
                    <asp:HyperLinkField HeaderText="Details"
                            ...
                            DataTextField="Name" 
                            SortExpression="Name"
                            DataNavigateUrlFields="FunctionalityHistoryId" 
