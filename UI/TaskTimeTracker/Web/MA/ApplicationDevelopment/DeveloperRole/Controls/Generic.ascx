<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.DeveloperRole.Controls.Generic" %>
        ...
        <tr>
            <td>
                <table   >
                    <tr>
                        <td class="ralabel">
                            <asp:Label ID="lblDeveloperRoleId" Text="DeveloperRoleId:"
                                runat="server"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtDeveloperRoleId" runat="server"></asp:TextBox>
                        </td>
                        <td>
