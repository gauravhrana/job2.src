...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.AllEntityDetail
{
	public partial class CommonUpdate : PageCommonUpdate
	{
		...
		{
			var UpdatedData = new List<AllEntityDetailDataModel>();
			...
			for (var i = 0; i < SelectedData.Rows.Count; i++)
			{
				...
				var dt = TaskTimeTracker.Components.Module.ApplicationDevelopment.AllEntityDetailDataManager.GetEntityDetails(data, SessionVariables.RequestProfile);
		...
		protected override DataTable GetEntityData(int? entityKey)
		{
			...
			var results = TaskTimeTracker.Components.Module.ApplicationDevelopment.AllEntityDetailDataManager.GetEntityDetails(allEntityDetaildata, SessionVariables.RequestProfile, ApplicationCommon.ReturnAuditInfoFalse);
