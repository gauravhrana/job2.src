		...
		protected void btnDelete_Click(object sender, EventArgs e)
		{
			try
			{
				...
				foreach (string index in deleteIndexList)
				{
					...
					if (!TaskTimeTracker.Components.Module.ApplicationDevelopment.WorkTicketDataManager.IsDeletable(data, SessionVariables.RequestProfile))
					{
						notDeletableIds.Add(Convert.ToInt32(data.WorkTicketId));
					}
				}
