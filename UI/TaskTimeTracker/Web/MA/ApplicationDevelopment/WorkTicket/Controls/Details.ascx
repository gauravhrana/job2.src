<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" 
    Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.WorkTicket.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblWorkTicketIdText" runat="server"><span>WorkTicketId: </span></asp:Label>
            </td>
            <td>
