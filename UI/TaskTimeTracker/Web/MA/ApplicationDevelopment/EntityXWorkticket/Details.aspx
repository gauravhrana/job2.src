<%@ Page Title="EntityXWorkTicket - Details" Language="C#" AutoEventWireup="true"
    MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false" CodeBehind="Details.aspx.cs"
    Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.EntityXWorkTicket.Details" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
   <a href="Default.aspx">EntityXWorkTicket </a> : Details
</asp:Content>
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        ...
        <tr>
            <td>
               <dc:DetailsControl ID="oDetailsControl" EntityName="EntityXWorkTicket" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
