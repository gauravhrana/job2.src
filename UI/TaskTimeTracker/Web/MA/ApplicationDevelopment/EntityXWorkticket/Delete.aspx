<%@ Page Title="EntityXWorkTicket - Delete" Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    CodeBehind="Delete.aspx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.EntityXWorkTicket.Delete" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="./Controls/Details.ascx" %>
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
   <a href="Default.aspx">EntityXWorkTicket </a> : Delete
</asp:Content>
