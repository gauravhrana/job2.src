	...
	public partial class InlineUpdate : PageInlineUpdate
	{
		...
		protected override DataTable GetData()
		{
			try
			{
				...
				var selectedrows = new List<EntityXWorkTicketDataModel>();
				...
				if (!string.IsNullOrEmpty(SuperKey))
				{
					...
					{
						entityXWorkTicketdata.EntityXWorkTicketId = entityKey;
						var result = TaskTimeTracker.Components.Module.ApplicationDevelopment.EntityXWorkTicketDataManager.GetDetails(entityXWorkTicketdata, SessionVariables.RequestProfile);
                        selectedrows.Add(result);
					}
				}
				else
				{
					entityXWorkTicketdata.EntityXWorkTicketId = SetId;
					var result = TaskTimeTracker.Components.Module.ApplicationDevelopment.EntityXWorkTicketDataManager.GetDetails(entityXWorkTicketdata, SessionVariables.RequestProfile);
                    selectedrows.Add(result);
