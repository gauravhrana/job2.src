...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityEntityStatus.Controls
{
	public partial class FESSummaryChart : BaseControl
	{
		...
		{
			PreferenceUtility.UpdateUserPreference(SettingCategory, FunctionalityEntityStatusDataModel.DataColumns.Functionality, drpSearchConditionFunctionality.SelectedItem.Text);
			PreferenceUtility.UpdateUserPreference(SettingCategory, "GroupBy", ddlGroupBy.SelectedItem.Text);
			PreferenceUtility.UpdateUserPreference(SettingCategory, "SubGroupBy", ddlSubGroupBy.SelectedItem.Text);
		}
