<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchFilter.ascx.cs"
    Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityEntityStatus.Controls.SearchFilter" %>
...
<script type="text/javascript">
    function SetDevBoxValue(dropdownid, txtbox1id) {
        ...
        //alert("hello" + dropdown.value + " - " + txtbox1.value);
		...
		<div id="tabs" style="border-color: greenyellow;border-width: 1px;">
			...
			<div id="divTabContentContainer" runat="server">
				...
				<div id="divSearchParam" class="form-horizontal">
					...
					<div class="form-group">
						<div class="col-sm-4">	
                            <asp:CheckBox ID="chkShowGraph" runat="server" Text="Show Graph" />        
						</div>
						<div class="col-sm-8" >
