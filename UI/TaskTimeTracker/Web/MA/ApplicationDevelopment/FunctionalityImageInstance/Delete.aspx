<%@ Page Title="FunctionalityImageInstance - Delete" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true"
    CodeBehind="Delete.aspx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityImageInstance.Delete" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            FunctionalityImageInstance Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
