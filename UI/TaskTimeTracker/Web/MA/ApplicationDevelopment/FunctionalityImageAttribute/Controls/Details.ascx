<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityImageAttribute.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    ...
    <table  >
        ...
        <tr>
            ...
            <td>
                <asp:Image ID="imgApplicationUserImage" runat="server" Height="300" Width="300" Visible="false" BorderWidth="4"
                                BorderColor="#465c71" />
