<%@ Page Title="FunctionalityImageAttribute - Delete" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true"
    CodeBehind="Delete.aspx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityImageAttribute.Delete" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            FunctionalityImageAttribute Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
