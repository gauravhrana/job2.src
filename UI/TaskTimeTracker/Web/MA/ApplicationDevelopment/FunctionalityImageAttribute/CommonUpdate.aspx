<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommonUpdate.aspx.cs" MasterPageFile="~/MasterPages/Site.master" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityImageAttribute.CommonUpdate" %>
...
<asp:Content ID="UpdateContent" ContentPlaceHolderID="MainContent" runat="server">
    <table style="font-weight: bold; color: Black" width="95%" borsder="0">
