...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityXFunctionalityActiveStatus
{
	public partial class Details : Framework.UI.Web.BaseClasses.PageDetails
	{
		...
		private DataTable GetFunctionalityActiveStatusData(int functionalityId)
        {
            ...
            var FunctionalityActiveStatusdt = TaskTimeTracker.Components.Module.ApplicationDevelopment.FunctionalityActiveStatusDataManager.Search(
                FunctionalityActiveStatusDataModel.Empty, SessionVariables.RequestProfile);
