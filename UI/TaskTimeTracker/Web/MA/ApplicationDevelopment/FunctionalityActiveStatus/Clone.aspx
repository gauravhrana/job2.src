<%@ Page Title="FunctionalityActiveStatus - Clone" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true"
    CodeBehind="Clone.aspx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityActiveStatus.Clone" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
    ...
    <asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        <br /><br />
        <asp:Label ID="Label1" Text="Please enter the FunctionalityActiveStatusId" runat="server"/>
