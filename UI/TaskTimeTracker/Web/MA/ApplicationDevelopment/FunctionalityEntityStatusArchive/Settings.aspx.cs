...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityEntityStatusArchive
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.FunctionalityEntityStatusArchive, "FunctionalityEntityStatusArchive");
		}
		...
		{
            Response.Redirect(Page.GetRouteUrl("FunctionalityEntityStatusArchiveEntityRoute", new { Action = "Default" }), false);
		}
	}
}