<%@ Page Title="FunctionalityOwner - Clone" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true"
    CodeBehind="Clone.aspx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityOwner.Clone" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
    ...
    <asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        <br /><br />
        <asp:Label ID="Label1" Text="Please enter the FunctionalityOwnerId" runat="server"/>
