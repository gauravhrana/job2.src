...
Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FeatureOwnerStatus.Default" %>
...
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">FeatureOwnerStatus</asp:Content>
