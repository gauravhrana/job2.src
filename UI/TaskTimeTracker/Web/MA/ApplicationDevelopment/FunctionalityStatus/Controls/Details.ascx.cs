...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityStatus.Controls
{
    public partial class Details : Framework.UI.Web.BaseClasses.ControlDetailsStandard
    {
        ...
        protected override void ShowData(int FunctionalityStatusId)
        {
            base.ShowData(FunctionalityStatusId);
            ...
            if (items.Count == 1)
            {
                ...
                oHistoryList.Setup(PrimaryEntity, FunctionalityStatusId, "FunctionalityStatus");
            }
        }
        ...
        protected override List<Label> GetLabels()
        {
            ...
            {
                LabelListCore = new List<Label>(new Label[] { lblFunctionalityStatusIdText, lblNameText, lblDescriptionText, 
                    lblSortOrderText});
            }
        ...
        public void SetData(FunctionalityStatusDataModel item)
        {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            DictionaryLabel = Shared.UI.Web.CacheConstants.FunctionalityStatusLabelDictionary;
            ...
            CoreSystemKey = lblFunctionalityStatusId;
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                lblFunctionalityStatusIdText.Visible = isTesting;
