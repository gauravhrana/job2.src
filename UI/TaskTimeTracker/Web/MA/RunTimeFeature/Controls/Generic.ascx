<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.RunTimeFeature.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblRunTimeFeatureId" Text="RunTimeFeature Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtRunTimeFeatureId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtRunTimeFeatureId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynRunTimeFeatureId" runat="server" />
        </div>
    </div>
