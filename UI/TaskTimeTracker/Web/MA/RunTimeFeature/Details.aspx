<%@ Page Title="Details" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.RunTimeFeature.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class='row'>
        <div class='col-sm-12'>
            <dc:DetailsControl ID='oDetailsControl' EntityName='RunTimeFeature' runat='server' />
        </div>
    </div>
