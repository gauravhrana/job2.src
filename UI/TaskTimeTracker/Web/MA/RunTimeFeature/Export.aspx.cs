...
namespace ApplicationContainer.UI.Web.RunTimeFeature
{
	public partial class Export : Shared.UI.WebFramework.BasePage
	{
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.RunTimeFeature, "DBColumns", SessionVariables.RequestProfile);
		}
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				oList.Setup("RunTimeFeature", " ", "RunTimeFeatureId", false, GetData, GetColumns, false);
