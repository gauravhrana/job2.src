...
namespace ApplicationContainer.UI.Web.EventNotification.NotificationPublisher
{
	public partial class Default : Framework.UI.Web.BaseClasses.PageDefault
	{
		...
		{
			var dt = Framework.Components.EventMonitoring.NotificationPublisherDataManager.Search(oSearchFilter.SearchParameters, SessionVariables.RequestProfile);
		...
		protected override void OnInit(EventArgs e)
		{
			...
			PrimaryEntityIdColumn   = "NotificationPublisherId";
