<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.EventNotification.NotificationPublisher.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblNotificationPublisherId" Text="NotificationPublisher Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtNotificationPublisherId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtNotificationPublisherId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
