<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" CodeBehind="CrossReference.aspx.cs" Inherits="ApplicationContainer.UI.Web.EventNotification.NotificationSubscriberXEventType.CrossReference" %>
                    ...
                    <tr>
                        <td width="150">
                            ...
                            <asp:DropDownList Width="300" ID="drpSelection" runat="server" AutoPostBack="true"
                                ...
                                <asp:ListItem Value="ByNotificationSubscriber">NotificationSubscriber To NotificationEventType</asp:ListItem><asp:ListItem Value="ByNotificationEventType">NotificationEventType To NotificationSubscriber</asp:ListItem></asp:DropDownList></td></tr></table></td></tr><tr>
            <td>
                <asp:PlaceHolder ID="dynNotificationSubscriber" runat="server">
                    <table>
                        <tr>
                            <td width="150">
                                NotificationSubscriber: </td><td>
                                <asp:DropDownList ID="drpNotificationSubscriber" runat="server" AutoPostBack="true"
                                OnSelectedIndexChanged="drpNotificationSubscriber_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
            ...
            <td>
                <asp:PlaceHolder ID="dynNotificationEventType" runat="server" Visible="false">
                    <table>
                        ...
                        <tr>
                            <td colspan="2">
                                <uc1:Bucket ID="BucketOfNotificationSubscriber" runat="server" />
                            </td>
                        </tr>
                    </table>
                </asp:PlaceHolder>
