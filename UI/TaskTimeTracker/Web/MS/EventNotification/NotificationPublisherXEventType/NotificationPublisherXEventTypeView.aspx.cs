...
{
	public partial class NotificationPublisherXEventTypeView : Shared.UI.WebFramework.BasePage
	{
		#region Methods

		private List<NotificationPublisherDataModel> GetNotificationPublisherList()
		{
		...
		private List<NotificationEventTypeDataModel> GetNotificationEventTypeList()
		{
