<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.EventNotification.NotificationSubscriber.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblNotificationSubscriberId" Text="NotificationSubscriber Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtNotificationSubscriberId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtNotificationSubscriberId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynNotificationSubscriberId" runat="server" />
        </div>
    </div>
