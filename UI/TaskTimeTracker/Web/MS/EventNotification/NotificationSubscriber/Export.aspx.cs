...
namespace ApplicationContainer.UI.Web.EventNotification.NotificationSubscriber
{
	public partial class Export : Shared.UI.WebFramework.BasePage
	{
		...
		private System.Data.DataTable GetData()
		{
			...
			var dt = Framework.Components.EventMonitoring.NotificationSubscriberDataManager.Search(data, SessionVariables.RequestProfile);
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				oList.Setup("NotificationSubscriber", "", "NotificationSubscriberId", false, GetData, GetColumns, false);
