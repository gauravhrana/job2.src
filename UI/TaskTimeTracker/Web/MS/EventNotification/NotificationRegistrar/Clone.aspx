<%@ Page Title="NotificationRegistrar - Clone" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true"
    CodeBehind="Clone.aspx.cs" Inherits="ApplicationContainer.UI.Web.EventNotification.NotificationRegistrar.Clone" %>
...
<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
    ...
    <asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        <br /><br />
        <asp:Label ID="Label1" Text="Please enter the NotificationRegistrarId" runat="server"/>
