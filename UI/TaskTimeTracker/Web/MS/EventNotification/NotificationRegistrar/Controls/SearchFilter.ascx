<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchFilter.ascx.cs" Inherits="ApplicationContainer.UI.Web.EventNotification.NotificationRegistrar.Controls.SearchFilter" %>
