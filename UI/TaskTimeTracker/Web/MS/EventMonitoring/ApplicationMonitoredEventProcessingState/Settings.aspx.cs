...
namespace Shared.UI.Web.EventMonitoring.ApplicationMonitoredEventProcessingState
{
    public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
    {
        ...
        {
            eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.ApplicationMonitoredEventProcessingState, "ApplicationMonitoredEventProcessingState");
        }
        ...
        {
            Response.Redirect("~/Shared/EventMonitoring/ApplicationMonitoredEventProcessingState/Default.aspx");
        }
    }
}