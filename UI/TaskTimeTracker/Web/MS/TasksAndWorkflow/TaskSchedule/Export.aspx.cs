...
namespace Shared.UI.Web.TasksAndWorkflow.TaskSchedule
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
        ...
        private System.Data.DataTable GetData()
        {
			...
			var dt = Framework.Components.TasksAndWorkflow.TaskScheduleDataManager.Search(data, SessionVariables.RequestProfile);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("TaskSchedule", " ", "TaskScheduleId", false, GetData, GetColumns, false);
