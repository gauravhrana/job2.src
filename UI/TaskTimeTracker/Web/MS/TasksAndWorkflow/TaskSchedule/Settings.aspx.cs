...
namespace Shared.UI.Web.TasksAndWorkflow.TaskSchedule
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.TaskSchedule, "TaskSchedule");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/TaskSchedule/Default.aspx");
		}
	}
}