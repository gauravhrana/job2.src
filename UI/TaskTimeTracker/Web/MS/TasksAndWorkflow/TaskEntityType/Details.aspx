<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.TasksAndWorkflow.TaskEntityType.Details" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
  <%--<a href="Default.aspx">TaskEntityType </a> : Details--%>
</asp:Content>
