<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" CodeBehind="CommonUpdate.aspx.cs" Inherits="ApplicationContainer.UI.Web.TasksAndWorkflow.TaskEntityType.CommonUpdate" %>
<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagPrefix="dyn" TagName="DynamicUpdate" Src="~/Shared/Controls/DynamicUpdate.ascx" %>
<asp:content id="Content1" runat="server" contentplaceholderid="SectionName">
    <%--<a href="Default.aspx"> TaskEntityType</a> : Common Update--%>
</asp:content>
