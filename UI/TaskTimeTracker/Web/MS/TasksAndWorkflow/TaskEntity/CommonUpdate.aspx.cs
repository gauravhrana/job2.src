...
namespace ApplicationContainer.UI.Web.TasksAndWorkflow.TaskEntity
{
    public partial class CommonUpdate : Framework.UI.Web.BaseClasses.PageCommonUpdate
	{
		...
		{
			var UpdatedData = new List<TaskEntityDataModel>();
			...
			for (var i = 0; i < SelectedData.Rows.Count; i++)
			{
				...
				var dt = Framework.Components.TasksAndWorkflow.TaskEntityDataManager.GetEntityDetails(data, SessionVariables.RequestProfile);
		...
		protected override DataTable GetEntityData(int? entityKey)
		{
			...
			var results = Framework.Components.TasksAndWorkflow.TaskEntityDataManager.GetEntityDetails(taskEntitydata, SessionVariables.RequestProfile, ApplicationCommon.ReturnAuditInfoFalse);
