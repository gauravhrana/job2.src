...
namespace Shared.UI.Web.TasksAndWorkflow.TaskRun
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.TaskRun, "DBColumns", SessionVariables.RequestProfile);
		}
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("TaskRun", " ", "TaskRunId", false, GetData, GetColumns, false);
