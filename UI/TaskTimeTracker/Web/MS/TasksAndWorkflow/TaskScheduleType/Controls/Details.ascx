<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.TasksAndWorkflow.TaskScheduleType.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
               <asp:Label ID="lblTaskScheduleTypeIdText" runat="server" >TaskScheduleTypeId :</asp:Label>
            </td>
            <td>
                <asp:Label ID="lblTaskScheduleTypeId" runat="server"></asp:Label>
            </td>
            <td>
