...
namespace Shared.UI.Web.TasksAndWorkflow.TaskScheduleType.Controls
{
    public partial class List : Shared.UI.WebFramework.BaseControl
    {
        ...
        {
			//var data = new Framework.Components.TasksAndWorkflow.TaskScheduleType.Data();

			//data.Name = name;

			//var dt = Framework.Components.TasksAndWorkflow.TaskScheduleType.Search(data, AuditId);
			//return dt;
