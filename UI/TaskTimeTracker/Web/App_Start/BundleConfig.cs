	...
	public class BundleConfig
	{
		...
		public static void RegisterBundles(BundleCollection bundles)
		{
			...
			bundles.Add(new StyleBundle("~/bundles/css").Include(
                ...
                "~/bower_components/adf-widget-clock/dist/adf-widget-clock.min.css"
			));
			...
			bundles.Add(new StyleBundle("~/Content/angular-bootstrap-datetimepicker").Include(
				"~/bower_components/src/css/datetimepicker.css"
            ));
			...
			bundles.Add(new ScriptBundle("~/bundles/DayCare").Include(
				...
				, "~/app/examples/controllers/modalRowEditorCtrl.js"
			...
			bundles.Add(new ScriptBundle("~/bundles/SystemAdmin").Include(
				...
				, "~/app/BM/SystemAdmin/services/Gen/fieldConfigurationBaseService.js"

				, "~/app/BM/SystemAdmin/controllers/Gen/Detail/*.js"
				, "~/app/BM/SystemAdmin/controllers/Gen/List/*.js"
				, "~/app/BM/SystemAdmin/controllers/Gen/Save/*.js"
			...
			bundles.Add(new ScriptBundle("~/bundles/ReferenceData").Include(
				...
				, "~/app/BM/ReferenceData/services/Gen/*.js"
				, "~/app/BM/ReferenceData/controllers/Gen/Detail/*.js"
				, "~/app/BM/ReferenceData/controllers/Gen/List/*.js"
				, "~/app/BM/ReferenceData/controllers/Gen/Save/*.js"

                , "~/app/BM/ReferenceData/controllers/Gen/CrossReference/*.js"
            ));
			...
			bundles.Add(new ScriptBundle("~/bundles/mvc").Include(
                ...
                // User Preference Utility Service
                "~/app/core/services/userPreferenceUtilityService.js",
			...
			bundles.Add(new ScriptBundle("~/bundles/kendo").Include(                
                ...
                //, "~/bower_components/kendo-ui/js/kendo.webcomponents.min.js"
                //, "~/bower_components/kendo-ui/js/kendo.autocomplete.min.js"
                //, "~/bower_components/kendo-ui/js/kendo.combobox.min.js"
            ));

            // Kendo -- TODO : these all seem WRONG
            bundles.Add(new ScriptBundle("~/bundles/kendoMVC").Include(
            ...
            // Angular Bootstrap DatePicker
            bundles.Add(new ScriptBundle("~/bundles/angular-bootstrap-datetimepicker").Include(
