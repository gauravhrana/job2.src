<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.EntityDateRangeStateType.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblEntityDateRangeStateTypeId" Text="EntityDateRangeStateType Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtEntityDateRangeStateTypeId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtEntityDateRangeStateTypeId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
