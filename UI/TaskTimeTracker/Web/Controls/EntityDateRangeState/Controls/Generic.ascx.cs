...
namespace ApplicationContainer.UI.Web.EntityDateRangeState.Controls
{
	public partial class Generic : ControlGeneric
	{
		...
		public override int? Save(string action)
		{
			...
			if (action == "Insert")
			{
                if(!EntityDateRangeStateDataManager.DoesExist(data, SessionVariables.RequestProfile))
				{
		...
		private void SetupDropdown()
		{
			...
			var dateRangeStateTypeData = EntityDateRangeStateTypeDataManager.GetEntityDetails(EntityDateRangeStateTypeDataModel.Empty, SessionVariables.RequestProfile, ApplicationCommon.ReturnAuditInfoFalse);
