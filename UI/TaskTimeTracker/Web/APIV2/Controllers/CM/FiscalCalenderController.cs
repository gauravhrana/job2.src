...
{
	//[Authorize]
	public class FiscalCalenderController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<FiscalCalenderDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			FiscalCalenderDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
