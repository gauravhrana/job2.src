...
namespace Web.Api.Controllers
{
	...
	public class ManagerController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<ManagerDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			ManagerDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<ManagerDataModel>(jsonString);
			ManagerDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new ManagerDataModel();
			dataDelete.ManagerId = int.Parse(value);
			ManagerDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
