...
namespace Web.Api.Controllers
{
	...
	public class CurrencyController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<CurrencyDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			CurrencyDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<CurrencyDataModel>(jsonString);
			CurrencyDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new CurrencyDataModel();
			dataDelete.CurrencyId = int.Parse(value);
			CurrencyDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
