...
namespace Web.Api.Controllers
{
	...
	public class CalendarController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<CalendarDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			CalendarDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<CalendarDataModel>(jsonString);
			CalendarDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new CalendarDataModel();
			dataDelete.CalendarId = int.Parse(value);
			CalendarDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
