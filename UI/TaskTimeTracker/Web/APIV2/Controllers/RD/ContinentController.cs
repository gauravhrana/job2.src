...
namespace Web.Api.Controllers
{
	...
	public class ContinentController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<ContinentDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			ContinentDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<ContinentDataModel>(jsonString);
			ContinentDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new ContinentDataModel();
			dataDelete.ContinentId = int.Parse(value);
			ContinentDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
