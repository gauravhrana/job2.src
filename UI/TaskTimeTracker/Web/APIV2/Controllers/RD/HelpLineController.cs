...
namespace Web.Api.Controllers
{
	...
	public class HelpLineController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<HelpLineDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			HelpLineDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<HelpLineDataModel>(jsonString);
			HelpLineDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new HelpLineDataModel();
			dataDelete.HelpLineId = int.Parse(value);
			HelpLineDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
