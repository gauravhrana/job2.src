...
namespace Web.Api.Controllers
{
	...
	public class ReligionController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<ReligionDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			ReligionDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<ReligionDataModel>(jsonString);
			ReligionDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new ReligionDataModel();
			dataDelete.ReligionId = int.Parse(value);
			ReligionDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
