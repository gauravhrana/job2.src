...
namespace Web.Api.Controllers
{
    public class DatabaseCleanupController : ApiController
    {
        ...
        public IEnumerable<ConnectionStringXApplicationDataModel> ListDatabaseNames()
        {
			...
			var listConnectionStrings = ConnectionStringXApplicationDataManager.GetEntityDetails(data, SessionVariables.RequestProfile, ApplicationCommon.ReturnAuditInfoFalse);
