...
namespace Web.Api.Controllers
{
	...
	public class FoodTypeController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<FoodTypeDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			FoodTypeDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<FoodTypeDataModel>(jsonString);
			FoodTypeDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new FoodTypeDataModel();
			dataDelete.FoodTypeId = int.Parse(value);
			FoodTypeDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
