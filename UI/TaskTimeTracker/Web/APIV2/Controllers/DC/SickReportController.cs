...
namespace Web.Api.Controllers
{
	...
	public class SickReportController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<SickReportDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			SickReportDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<SickReportDataModel>(jsonString);
			SickReportDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new SickReportDataModel();
			dataDelete.SickReportId = int.Parse(value);
			SickReportDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
