...
namespace Web.Api.Controllers
{
	...
	public class RegistrationController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<RegistrationDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			RegistrationDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<RegistrationDataModel>(jsonString);
			RegistrationDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new RegistrationDataModel();
			dataDelete.RegistrationId = int.Parse(value);
			RegistrationDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
