...
namespace Web.Api.Controllers
{
	...
	public class ActivitySubTypeController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<ActivitySubTypeDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			ActivitySubTypeDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<ActivitySubTypeDataModel>(jsonString);
			ActivitySubTypeDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new ActivitySubTypeDataModel();
			dataDelete.ActivitySubTypeId = int.Parse(value);
			ActivitySubTypeDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
