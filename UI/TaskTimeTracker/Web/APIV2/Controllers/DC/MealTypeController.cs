...
namespace Web.Api.Controllers
{
	...
	public class MealTypeController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<MealTypeDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			MealTypeDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<MealTypeDataModel>(jsonString);
			MealTypeDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new MealTypeDataModel();
			dataDelete.MealTypeId = int.Parse(value);
			MealTypeDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
