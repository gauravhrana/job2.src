...
namespace Web.Api.Controllers
{
	...
	public class DepartmentController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<DepartmentDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			DepartmentDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<DepartmentDataModel>(jsonString);
			DepartmentDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new DepartmentDataModel();
			dataDelete.DepartmentId = int.Parse(value);
			DepartmentDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
