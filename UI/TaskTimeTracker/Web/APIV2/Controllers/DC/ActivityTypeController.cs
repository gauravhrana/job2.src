...
namespace Web.Api.Controllers
{
	...
	public class ActivityTypeController : ApiController
	{
		...
		public void Create([FromBody]dynamic data)
		{
			...
			var dataCreate = JsonConvert.DeserializeObject<ActivityTypeDataModel>(jsonString);

			dataCreate.ApplicationId = SessionVariables.RequestProfile.ApplicationId;

			ActivityTypeDataManager.Create(dataCreate, SessionVariables.RequestProfile);
		}
		...
		{
			var jsonString = JsonConvert.SerializeObject(data);
			var dataUpdate = JsonConvert.DeserializeObject<ActivityTypeDataModel>(jsonString);
			ActivityTypeDataManager.Update(dataUpdate, SessionVariables.RequestProfile);
		}

		[System.Web.Http.AcceptVerbs("DELETE", "GET", "POST")]
		public void Delete(string value)
		{
			var dataDelete = new ActivityTypeDataModel();
			dataDelete.ActivityTypeId = int.Parse(value);
			ActivityTypeDataManager.Delete(dataDelete, SessionVariables.RequestProfile);
		}
	}
}
