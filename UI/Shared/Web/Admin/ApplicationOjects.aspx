<%@ Page Title="Application Objects" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <table cellpadding="5" style="font-weight: bold; color: Black" width="100%" border="0">
        <tr>
            <td>
            </td>
        </tr>
