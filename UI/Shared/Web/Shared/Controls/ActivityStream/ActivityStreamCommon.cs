...
namespace Shared.UI.Web.ActivityStream
{
    public class ActivityStreamCommon
    {
        ...
        public static Dictionary<string, string> GetUserPreferencesForActivityStream(string upCategory)
        {
            ...
            {
                settings.Add(upKey, PreferenceUtility.GetUserPreferenceByKey(upKey, upCategory));
            }
        ...
        {
            var upValue = PreferenceUtility.GetUserPreferenceByKey(ActivityStreamExcludedEntities, categoryName, categoryName);
        ...
        {
            var upValue = PreferenceUtility.GetUserPreferenceByKey(ActivityStreamExcludedEntities, categoryName, categoryName);
            var upkId = PreferenceUtility.GetUserPreferenceKey(ActivityStreamExcludedEntities);
