    ...
    public partial class DetailListControl : BaseControl
    {
        ...
        private void SetHyperLink(DataColumn dataColumn, string[] str, string entity, bool enableLInk)
        {
            ...
            if (!enableLInk)
            {
                ...
                userClickAction = PreferenceUtility.GetUserPreferenceByKey(ApplicationCommon.GridDefaultClickActionKey);
        ...
        private int GetSystemEntityTypeId()
        {
			...
			var dtEntityRow = SystemEntityTypeDataManager.GetEntityDetails(data, SessionVariables.RequestProfile)[0];
            var entityId = dtEntityRow.SystemEntityTypeId.Value;
