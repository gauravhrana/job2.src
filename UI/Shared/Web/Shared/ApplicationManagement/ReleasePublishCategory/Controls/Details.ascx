<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.ApplicationManagement.ReleasePublishCategory.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblReleasePublishCategoryIdText" runat="server"><span>Publish Category Id: </span></asp:Label>
            </td>
            <td>
                <asp:Label ID="lblReleasePublishCategoryId" runat="server"></asp:Label>
            </td>
            <td>
