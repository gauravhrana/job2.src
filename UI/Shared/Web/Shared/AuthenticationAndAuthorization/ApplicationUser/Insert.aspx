<%@ Page Title="Insert" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true"
    CodeBehind="Insert.aspx.cs" Inherits="Shared.UI.Web.AuthenticationAndAuthorization.ApplicationUser.Insert" %>

<%@ Register TagPrefix="gnrc" TagName="GenericControl" Src="~/Shared/AuthenticationAndAuthorization/ApplicationUser/Controls/Generic.ascx" %>
