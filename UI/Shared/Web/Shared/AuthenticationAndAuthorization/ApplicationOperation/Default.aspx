<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" MasterPageFile="~/MasterPages/Default.master"
    Inherits="Shared.UI.Web.AuthenticationAndAuthorization.ApplicationOperation.Default" %>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Shared/AuthenticationAndAuthorization/ApplicationOperation/Controls/SearchFilter.ascx" %>
