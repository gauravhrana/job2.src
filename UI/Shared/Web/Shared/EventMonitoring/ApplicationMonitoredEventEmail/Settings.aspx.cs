...
namespace Shared.UI.Web.EventMonitoring.ApplicationMonitoredEventEmail
{
    public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
    {
        ...
        {
            eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.ApplicationMonitoredEventEmail, "ApplicationMonitoredEventEmail");
        }
        ...
        {
            Response.Redirect("~/Shared/EventMonitoring/ApplicationMonitoredEventEmail/Default.aspx");
        }
    }
}