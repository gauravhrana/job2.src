<%@ Page Title="Update" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Update.aspx.cs" Inherits="Shared.UI.Web.ApplicationMonitoredEventEmail.Update"
    EnableEventValidation="false" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/EventMonitoring/ApplicationMonitoredEventEmail/Controls/Generic.ascx" %>
