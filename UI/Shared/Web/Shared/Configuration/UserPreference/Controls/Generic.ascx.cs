...
namespace Shared.UI.Web.Configuration.UserPreference.Controls
{
    public partial class Generic : Framework.UI.Web.BaseClasses.ControlGeneric
    {
        ...
        protected override string ValidationConfigFile
        {
            get
            {
                return Server.MapPath("~/Shared/Configuration/UserPreference/Controls/Validation.xml"); //"R:\Projects\Task Time Tracker\Dev\UI\Web\ValidationDataFile\dvc.xml";
            }
        }
        ...
        private void SetupDropdown()
        {
            ...
            UIHelper.LoadDropDown(dataTypeData, drpDataTypeList, StandardDataModel.StandardDataColumns.Name, Framework.Components.UserPreference.UserPreferenceDataTypeDataModel.DataColumns.UserPreferenceDataTypeId);
