    ...
    public partial class Delete : Framework.UI.Web.BaseClasses.PageDelete
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            try
            {
                ...
                var detailsControlPath = "~/Shared/Configuration/UserPreferenceSelectedItem/Controls/Details.ascx";
                ...
                if (!string.IsNullOrEmpty(SuperKey))
                {
                    ...
                    data.SystemEntityTypeId = (int)Framework.Components.DataAccess.SystemEntity.UserPreferenceSelectedItem;
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            SettingCategory = "UserPreferenceSelectedItemDefaultView";
