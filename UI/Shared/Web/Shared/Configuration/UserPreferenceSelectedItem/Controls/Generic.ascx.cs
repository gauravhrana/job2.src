...
namespace Shared.UI.Web.Configuration.UserPreferenceSelectedItem.Controls
{
    public partial class Generic : Framework.UI.Web.BaseClasses.ControlGeneric
    {
        ...
        protected override string ValidationConfigFile
        {
            get
            {
                return Server.MapPath("~/Shared/Configuration/UserPreferenceSelectedItem/Controls/Validation.xml"); //"R:\Projects\Task Time Tracker\Dev\UI\Web\ValidationDataFile\dvc.xml";
            }
        }
