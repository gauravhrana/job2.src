	...
	public partial class Export : Shared.UI.WebFramework.BasePage
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				oList.Setup("ApplicationEntityFieldLabel", " ", "ApplicationEntityFieldLabelId", false, new List.GetDataDelegate(GetData), new List.GetColumnDelegate(GetColumns), false);
