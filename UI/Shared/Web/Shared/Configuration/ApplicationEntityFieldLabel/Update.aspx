<%@ Page Title="Update" MasterPageFile="~/Site.Master" EnableEventValidation="false"
    Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="Shared.UI.Web.Configuration.ApplicationEntityFieldLabel.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/Configuration/ApplicationEntityFieldLabel/Controls/Generic.ascx" %>
<%@ Reference Control="Controls/Details.ascx" %>
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
   <a href="Default.aspx">ApplicationEntityFieldLabel </a> : Update
</asp:Content>
