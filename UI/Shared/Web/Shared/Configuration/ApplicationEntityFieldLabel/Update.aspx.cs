	...
	public partial class Update : Shared.UI.WebFramework.BasePage
	{
		...
		protected override void OnInit(EventArgs e)
		{
			...
			try
			{
				...
				var path = "~/Shared/Configuration/ApplicationEntityFieldLabel/Controls/Details.ascx";
				var genericcontrolpath = "~/Shared/Configuration/ApplicationEntityFieldLabel/Controls/Generic.ascx";
