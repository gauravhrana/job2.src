...
namespace Shared.UI.Web.Configuration.UserPreferenceCategory
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.UserPreferenceCategory, "UserPreferenceCategory");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/UserPreferenceCategory/Default.aspx");
		}
	}
}