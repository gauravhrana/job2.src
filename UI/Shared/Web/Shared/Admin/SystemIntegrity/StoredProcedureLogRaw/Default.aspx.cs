...
namespace Shared.UI.Web.SystemIntegrity.StoredProcedureLogRaw
{
	public partial class Default : Framework.UI.Web.BaseClasses.PageDefault
	{
		...
		{
			var dt = Framework.Components.LogAndTrace.StoredProcedureLogRawDataManager.Search(oSearchFilter.SearchParameters, SessionVariables.RequestProfile);
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            PrimaryEntity         = Framework.Components.DataAccess.SystemEntity.StoredProcedureLogRaw;
            PrimaryEntityKey      = "StoredProcedureLogRaw";
            PrimaryEntityIdColumn = "StoredProcedureLogRawId";
