...
namespace Shared.UI.Web.SystemIntegrity.StoredProcedureLogStoredProcedureLogRaw.Controls
{
	public partial class List : Shared.UI.WebFramework.BaseControl
	{
		...
		private DataTable GetData(string StoredProcedureLog)
		{
			...
			var dt = Framework.Components.LogAndTrace.StoredProcedureLogRawDataManager.Search(data, SessionVariables.RequestProfile);
			return dt;
		}
