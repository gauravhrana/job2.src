...
namespace Shared.UI.Web.SystemIntegrity.StoredProcedureLogStoredProcedureLogDetail.Controls
{
	public partial class List : Shared.UI.WebFramework.BaseControl
	{
		...
		private DataTable GetData(string StoredProcedureLog)
		{
			var data = new Framework.Components.LogAndTrace.StoredProcedureLogDetailDataModel();

			data.StoredProcedureLogId = int.Parse(StoredProcedureLog);

			var dt = Framework.Components.LogAndTrace.StoredProcedureLogDetailDataManager.Search(data, SessionVariables.RequestProfile);
			return dt;
		}
