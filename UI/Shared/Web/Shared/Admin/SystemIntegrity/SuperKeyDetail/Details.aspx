<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.SystemIntegrity.SuperKeyDetail.Details" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/Admin/SystemIntegrity/SuperKeyDetail/Controls/Details.ascx" %>
