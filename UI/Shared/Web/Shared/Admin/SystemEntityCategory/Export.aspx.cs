...
namespace Shared.UI.Web.Admin.SystemEntityCategory
{
	public partial class Export : Shared.UI.WebFramework.BasePage
	{
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.SystemEntityCategory, "DBColumns", SessionVariables.RequestProfile);
		}
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				oList.Setup("SystemEntityCategory", " ", "SystemEntityCategoryId", false, GetData, GetColumns, false);
