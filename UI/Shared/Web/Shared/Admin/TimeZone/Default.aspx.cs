...
namespace Shared.UI.Web.Admin.TimeZone
{
    public partial class Default : Framework.UI.Web.BaseClasses.PageDefault
    {
        ...
        {
			var dt = Framework.Components.Core.TimeZoneDataManger.Search(oSearchFilter.SearchParameters, SessionVariables.RequestProfile);
            return dt;
        }
		...
		protected override void OnInit(EventArgs e)
		{
			...
			PrimaryEntityIdColumn = "TimeZoneId";
