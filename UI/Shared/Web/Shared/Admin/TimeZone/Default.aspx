<%@ Page Title="Default" Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="Shared.UI.Web.Admin.TimeZone.Default" %>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Shared/Admin/TimeZone/Controls/SearchFilter.ascx" %>
