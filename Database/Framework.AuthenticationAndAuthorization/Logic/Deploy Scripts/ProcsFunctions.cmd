...
for %%f in ("..\Stored Procedures\ApplicationUser\*.sql") DO sqlcmd -S %1 -d %2 -i "%%f" -b -U %3 -P %4
for %%f in ("..\Stored Procedures\Person\*.sql") DO sqlcmd -S %1 -d %2 -i "%%f" -b -U %3 -P %4
for %%f in ("..\Stored Procedures\PersonTitle\*.sql") DO sqlcmd -S %1 -d %2 -i "%%f" -b -U %3 -P %4
