<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" EnableEventValidation="false"
    MasterPageFile="~/MasterPages/Site.master" Inherits="Shared.UI.Web.AuthenticationAndAuthorization.ApplicationOperation.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/AuthenticationAndAuthorization/ApplicationOperation/Controls/Generic.ascx" %>
