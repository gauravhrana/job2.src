<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Clone.aspx.cs" MasterPageFile="~/MasterPages/Site.master"
    Inherits="Shared.UI.Web.AuthenticationAndAuthorization.ApplicationOperation.Clone" %>

<%@ Register TagPrefix="gnrc" TagName="GenericControl" Src="~/Shared/AuthenticationAndAuthorization/ApplicationOperation/Controls/Generic.ascx" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <br />
    <br />
    <asp:Label Text="Please enter the ApplicationOperationId" runat="server" />
