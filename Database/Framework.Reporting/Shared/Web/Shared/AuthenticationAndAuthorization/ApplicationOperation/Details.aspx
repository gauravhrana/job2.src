<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.AuthenticationAndAuthorization.ApplicationOperation.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        ...
        <tr>
            <td>
                <dc:DetailsControl ID="oDetailsControl" EntityName="ApplicationOperation" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
