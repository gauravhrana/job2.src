<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    CodeBehind="Delete.aspx.cs" Inherits="Shared.UI.Web.AuthenticationAndAuthorization.ApplicationOperation.Delete" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/AuthenticationAndAuthorization/ApplicationOperation/Controls/Details.ascx" %>
