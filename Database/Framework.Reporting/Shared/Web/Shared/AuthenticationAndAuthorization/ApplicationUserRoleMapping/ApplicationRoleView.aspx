...
MasterPageFile="~/MasterPages/Site.master" Inherits="Shared.UI.Web.AuthenticationAndAuthorization.ApplicationUserRoleMapping.ApplicationRoleView" %>
...
<asp:Content ID="DefaultContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table  border="1" width="300">
        <tr>
            ...
            <td>Current ApplicationUsers alloted to ApplicationRole:</td>
            <td width="*">
