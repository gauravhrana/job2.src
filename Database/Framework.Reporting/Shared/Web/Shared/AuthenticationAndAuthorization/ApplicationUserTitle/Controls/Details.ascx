...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblApplicationUserTitleIdText" runat="server"><span>ApplicationUserTitleId: </span></asp:Label>
            </td>
            <td>
                <asp:Label ID="lblApplicationUserTitleId" runat="server"></asp:Label>
            </td>
            <td>
