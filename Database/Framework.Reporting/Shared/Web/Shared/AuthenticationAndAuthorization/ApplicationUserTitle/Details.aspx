<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Details.aspx.cs"
    Inherits="Shared.UI.Web.AuthenticationAndAuthorization.ApplicationUserTitle.Details" MasterPageFile="~/MasterPages/Site.master" %>
<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/AuthenticationAndAuthorization/ApplicationUserTitle/Controls/Details.ascx" %>
