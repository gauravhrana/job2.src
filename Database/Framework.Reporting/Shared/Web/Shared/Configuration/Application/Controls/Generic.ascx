<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.Application.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblApplicationId" Text="Application Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtApplicationId"></asp:Label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label" for="txtCode" >Code:</label>
        <div class="col-sm-8">
