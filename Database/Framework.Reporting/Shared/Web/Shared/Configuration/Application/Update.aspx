<%@ Page Title="Update" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Update.aspx.cs" Inherits="Shared.UI.Web.Configuration.Application.Update"
    EnableEventValidation="false" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/Configuration/Application/Controls/Generic.ascx" %>
