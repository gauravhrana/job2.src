...
<div id="borderdiv" runat="server">
    <table  >
       ...
       <tr>
            <td class="ralabel">
               <asp:Label ID="lblUserPreferenceCategoryIdText" runat="server">UserPreferenceCategoryId :</asp:Label>
            </td>
            <td>
                <asp:Label ID="lblUserPreferenceCategoryId" runat="server"></asp:Label>
            </td>
            <td>
