<%@ Page Title="Update" MasterPageFile="~/MasterPages/Site.master" Language="C#" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="Shared.UI.Web.Configuration.UserPreferenceCategory.Update" %>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/Configuration/UserPreferenceCategory/Controls/Generic.ascx" %>
