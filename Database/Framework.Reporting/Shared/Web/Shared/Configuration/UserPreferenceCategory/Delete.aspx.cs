    ...
    public partial class Delete : Framework.UI.Web.BaseClasses.PageDelete
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            try
            {
                ...
                var detailsControlPath = "~/Shared/Configuration/UserPreferenceCategory/Controls/Details.ascx";
                ...
                {                    
                    ...
                    data.SystemEntityTypeId = (int)Framework.Components.DataAccess.SystemEntity.UserPreferenceCategory;
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            SettingCategory = "UserPreferenceCategoryDefaultView";
        ...
        {
            Response.Redirect(Page.GetRouteUrl("UserPreferenceCategoryEntityRoute", new { Action = "Default" }), false);
        }
