<%@ Page Title="Clone" Language="C#" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="Shared.UI.Web.Configuration.UserPreferenceCategory.Delete" %>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/Configuration/UserPreferenceCategory/Controls/Details.ascx" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            UserPreferenceCategory Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
