...
namespace Shared.UI.Web.Configuration.ApplicationEntityFieldLabel
{
    public partial class Details : Shared.UI.WebFramework.BasePage
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(SuperKey))
            {
                Response.Redirect(Page.GetRouteUrl("ConfiguratonSubRoutesSuperKey", new { EntityName = "ApplicationEntityFieldLabel", Action = "Delete", SuperKey = SuperKey }), false);
            }
            else
            {
                Response.Redirect(Page.GetRouteUrl("ConfiguratonSubRoutes", new { EntityName = "ApplicationEntityFieldLabel", Action = "Delete", SetId = SetId }), false);
            }
        }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(SuperKey))
            {
                Response.Redirect(Page.GetRouteUrl("ConfiguratonSubRoutesSuperKey", new { EntityName = "ApplicationEntityFieldLabel", Action = "Update", SuperKey = SuperKey }), false);
            }
            else
            {
                Response.Redirect(Page.GetRouteUrl("ConfiguratonSubRoutes", new { EntityName = "ApplicationEntityFieldLabel", Action = "Update", SetId = SetId }), false);
            }	
        }

        protected void btnClone_Click(object sender, EventArgs e)
        {
            Response.Redirect(Page.GetRouteUrl("ConfiguratonSubRoutes", new { EntityName = "ApplicationEntityFieldLabel", Action = "Clone", SetId = SetId }), false);
        }
