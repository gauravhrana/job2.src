<%@ Page Title="Insert" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Insert.aspx.cs" Inherits="Shared.UI.Web.Configuration.ApplicationEntityFieldLabel.Insert" %>
<%@ Register TagPrefix="gnrc" TagName="GenericControl" Src="~/Shared/Configuration/ApplicationEntityFieldLabel/Controls/Generic.ascx"%>
    ...
    <asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
       <a href="Default.aspx">ApplicationEntityFieldLabel </a> : Insert
    </asp:Content>
