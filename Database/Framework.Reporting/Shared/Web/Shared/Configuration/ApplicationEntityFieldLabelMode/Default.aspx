<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Default.aspx.cs" Inherits="Shared.UI.Web.Configuration.ApplicationEntityFieldLabelMode.Default" %>

<%@ Register Src="~/Shared/Controls/List.ascx" TagName="DefaultWindowControl" TagPrefix="dc" %>
<%@ Register Src="~/Shared/Configuration/ApplicationEntityFieldLabelMode/Controls/SearchFilter.ascx" TagName="SearchFilter" TagPrefix="sr" %>
