<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="Shared.UI.Web.Configuration.ApplicationEntityFieldLabelMode.Delete" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
     <a href="Default.aspx">ApplicationEntityFieldLabelMode </a> : Delete
</asp:Content>
                ...
                <table width="100%" cellpadding="2" cellspacing="2" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            ApplicationEntityFieldLabelMode Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
