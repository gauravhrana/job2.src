<%@ Page Title="Insert" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true" CodeBehind="Insert.aspx.cs" Inherits="Shared.UI.Web.Configuration.UserPreference.Insert" %>
<%@ Register TagPrefix="gnrc" Tagname="GenericControl" Src="~/Shared/Configuration/UserPreference/Controls/Generic.ascx"%>
