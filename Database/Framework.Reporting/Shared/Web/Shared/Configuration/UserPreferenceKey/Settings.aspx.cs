...
namespace Shared.UI.Web.Configuration.UserPreferenceKey
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.UserPreferenceKey, "UserPreferenceKey");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/UserPreferenceKey/Default.aspx");
		}
	}
}