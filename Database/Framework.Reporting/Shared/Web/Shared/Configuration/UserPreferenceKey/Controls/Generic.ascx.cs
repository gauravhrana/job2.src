       ...
       protected override string ValidationConfigFile
        {
            get
            {
                return Server.MapPath("~/Shared/Configuration/UserPreferenceKey/Controls/Validation.xml"); //ConfigurationSettings.AppSettings["DynamicValidatorsConfigurationFile"];
            }
        }
