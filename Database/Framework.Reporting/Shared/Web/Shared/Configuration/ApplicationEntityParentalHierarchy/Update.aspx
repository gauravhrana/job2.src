<%@ Page Title="Update" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="Shared.UI.Web.Configuration.ApplicationEntityParentalHierarchy.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/Configuration/ApplicationEntityParentalHierarchy/Controls/Generic.ascx" %>
