	...
	public partial class Details : Framework.UI.Web.BaseClasses.PageDetails
	{
        ...
        protected override void OnInit(EventArgs e)
        {
            try
            {
				...
				var detailsControlPath = ApplicationCommon.GetControlPath("ApplicationEntityParentalHierarchy", ControlType.DetailsControl);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(SuperKey))
            {
                Response.Redirect(Page.GetRouteUrl("ApplicationEntityParentalHierarchyEntityRouteSuperKey", new { Action = "Delete", SuperKey = SuperKey }), false);
            }
            else
            {
                Response.Redirect(Page.GetRouteUrl("ApplicationEntityParentalHierarchyEntityRoute", new { Action = "Delete", SetId = SetId }), false);
            }
        }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(SuperKey))
            {
                Response.Redirect(Page.GetRouteUrl("ApplicationEntityParentalHierarchyEntityRouteSuperKey", new { Action = "Update", SuperKey = SuperKey }), false);
            }
            else
            {
                Response.Redirect(Page.GetRouteUrl("ApplicationEntityParentalHierarchyEntityRoute", new { Action = "Update", SetId = SetId }), false);
            }
        }

        protected void btnClone_Click(object sender, EventArgs e)
        {
            Response.Redirect(Page.GetRouteUrl("ApplicationEntityParentalHierarchyEntityRoute", new { Action = "Clone", SetId = SetId }), false);
        }
