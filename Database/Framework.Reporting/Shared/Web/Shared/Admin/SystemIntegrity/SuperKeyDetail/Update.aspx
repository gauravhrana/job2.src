<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" EnableEventValidation="false"
    MasterPageFile="~/MasterPages/Site.master" Inherits="Shared.UI.Web.SystemIntegrity.SuperKeyDetail.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/Admin/SystemIntegrity/SuperKeyDetail/Controls/Generic.ascx" %>
