...
namespace Shared.UI.Web.Admin
{
	public partial class TestAndAuditDetails : Framework.UI.Web.BaseClasses.PageBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
		{
			//if(!IsPostBack)
			//{
			//    TestAndAuditGrid.DataSource = Shared.Components.BusinessLayer.Admin.GetList(SessionVariables.RequestProfile.AuditId);
        ...
        {
			//var dataTable = Shared.Components.BusinessLayer.Admin.GetList(SessionVariables.RequestProfile.AuditId);
