...
namespace Shared.UI.Web.BatchFile
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.BatchFile, "DBColumns", SessionVariables.RequestProfile);
		}
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("Import", "Admin ", "BatchFileId", false, GetData, GetColumns, false);
