<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Admin.Audit.AuditAction.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblAuditActionId" Text="AuditAction Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtAuditActionId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtAuditActionId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
