<%@ Page 
    ...
    Inherits="Shared.UI.Web.ApplicationMonitoredEventProcessingState.Default"
%>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageDefaultMaster" %>

<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Shared/EventMonitoring/ApplicationMonitoredEventProcessingState/Controls/SearchFilter.ascx" %>
...
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">ApplicationMonitoredEventProcessingState</asp:Content>
