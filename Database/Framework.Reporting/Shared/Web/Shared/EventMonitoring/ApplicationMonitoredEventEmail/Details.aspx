<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.ApplicationMonitoredEventEmail.Details"
    EnableEventValidation="false" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/EventMonitoring/ApplicationMonitoredEventEmail/Controls/Details.ascx" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            ApplicationMonitoredEventEmail Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
