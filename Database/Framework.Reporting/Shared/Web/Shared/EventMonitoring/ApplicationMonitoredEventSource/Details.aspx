<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.ApplicationMonitoredEventSource.Details"
    EnableEventValidation="false" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/EventMonitoring/ApplicationMonitoredEventSource/Controls/Details.ascx" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            ApplicationMonitoredEventSource Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
