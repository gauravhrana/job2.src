...
namespace Shared.UI.Web.ApplicationManagement.ReleaseLog
{
    public partial class Details : Framework.UI.Web.BaseClasses.PageDetails
    {
		...
		{
			var dt = Framework.Components.ReleaseLog.ReleaseLogDetailDataManager.GetByReleaseLog(releaseLogId, AuditId);
			var releaseLogdt = Framework.Components.ReleaseLog.ReleaseLogDetailDataManager.GetList(AuditId);
