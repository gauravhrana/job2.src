<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    CodeBehind="Delete.aspx.cs" Inherits="Shared.UI.Web.ApplicationManagement.ReleaseLog.Delete" %>

<%@ MasterType VirtualPath="~/MasterPages/Site.master" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/ApplicationManagement/ReleaseLog/Controls/Details.ascx" %>
