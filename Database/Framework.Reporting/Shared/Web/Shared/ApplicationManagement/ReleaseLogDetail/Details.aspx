<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.ApplicationManagement.ReleaseLogDetail.Details" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/ApplicationManagement/ReleaseLogDetail/Controls/Details.ascx" %>
