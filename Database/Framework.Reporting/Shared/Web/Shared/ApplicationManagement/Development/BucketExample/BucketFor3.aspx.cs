...
{
    public partial class BucketFor3 : System.Web.UI.Page
    {
        ...
        {		
			//var dt = Components.Module.Competency.SkillLevel.GetList(SessionVariables.AuditId);
			//return dt;
        ...
        {
			//var dt = Framework.Components.ApplicationUser.ApplicationUser.GetList(SessionVariables.AuditId);
			//return dt;
        ...
        private DataTable GetAssociatedRecords(int skillId)
        {
			...
			//var dt = Components.Module.Competency.SkillXPersonXSkillLevel.Search(data, SessionVariables.AuditId);
			//return dt;
        ...
        private void RemoveBySkill(int skillId)
        {
			//var data = new Components.SkillXPersonXSkillLevel.Data();
			//data.SkillId = skillId;
			//Components.Module.Competency.SkillXPersonXSkillLevel.Delete(data, SessionVariables.AuditId);
        }
        ...
        private void SaveSkillXPersonXSkillLevel(int skillId, int applicationUserId, int skillLevelId)
        {
			...
			//Components.Module.Competency.SkillXPersonXSkillLevel.Create(data, SessionVariables.AuditId);
        }
