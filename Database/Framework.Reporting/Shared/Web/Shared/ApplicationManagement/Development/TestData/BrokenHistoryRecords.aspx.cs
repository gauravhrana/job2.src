...
{
    public partial class BrokenHistoryRecords : Shared.UI.WebFramework.BasePage
    {
        ...
        private DataTable GetData()
        {
            ...
            var dt = Framework.Components.Audit.AuditHistory.SearchBrokenHistoryRecords(data, SessionVariables.AuditId);
        ...
        {
			var validColumns = Framework.Components.ApplicationSecurity.GetAuditHistoryColumns("Find", SessionVariables.AuditId);
            return validColumns;
        }
