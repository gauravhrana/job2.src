<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List.ascx.cs" Inherits="Shared.UI.Web.ApplicationManagement.Development.TestData.Controls.List" %>
        ...
        <td>
            <div id="griddiv" runat="server">
                ...
                <asp:GridView ID="MainGridView" AllowPaging="true" PageSize="100" Width="1000px"
                    ...
                    OnRowCreated="GridView_RowCreated" CellPadding="5" OnPageIndexChanging="GridView_PageIndexChanging"
                    OnSelectedIndexChanged="MainGridView_SelectedIndexChanged" OnRowDataBound="MainGridView_RowDataBound"
                    OnSorted="GridView_Sorted" DataKeyNames="SystemEntityType">
                    <Columns>
                        <%--<asp:TemplateField>
                        <HeaderTemplate>
