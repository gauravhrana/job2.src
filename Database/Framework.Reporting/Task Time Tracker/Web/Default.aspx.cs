...
namespace ApplicationContainer.UI.Web
{
    public partial class Default : Framework.UI.Web.BaseClasses.PageBasePage
	{
        ...
        private void SyncMenuModuleWise()
        {
			...
			//MenuDataManager.SyncModule("AA", 100072, "AA", 100, SessionVariables.RequestProfile);

			// PMT AA Module Menu Sync
			//MenuDataManager.SyncModule("AA", 100, "AA", 100071, SessionVariables.RequestProfile);

			// TE AA Module Menu Sync
			//MenuDataManager.SyncModule("AA", 100047, "AA", 100, SessionVariables.RequestProfile);

			// DayCare AA Module Menu Sync
			//MenuDataManager.SyncModule("AA", 200, "AA", 100, SessionVariables.RequestProfile); 

			// Capital Markets AA Module Menu Sync
			//MenuDataManager.SyncModule("AA", 100068, "AA", 100, SessionVariables.RequestProfile); 
			...
			//MenuDataManager.SyncModule("AA", 100067, "AA", 100, SessionVariables.RequestProfile); 

			// Product Management Tracker AA Module Menu Sync
			//MenuDataManager.SyncModule("AA", 100065, "AA", 100, SessionVariables.RequestProfile); 
