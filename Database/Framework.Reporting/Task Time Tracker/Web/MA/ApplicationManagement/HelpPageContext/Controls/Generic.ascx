<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.ApplicationManagement.HelpPageContext.Controls.Generic" %>
        ...
        <tr>
            <td>
                <table   >
                    <tr>
                        <td class="ralabel">
                            <asp:Label ID="lblHelpPageContextId" Text="HelpPageContextId:"
                                runat="server"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtHelpPageContextId" runat="server"></asp:TextBox>
                        </td>
                        <td>
