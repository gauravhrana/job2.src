	...
	public partial class InlineUpdate : PageInlineUpdate
    {
        ...
        protected override DataTable GetData()
		{
			try
			{
				...
				selectedrows = TaskTimeTracker.Components.Module.ApplicationDevelopment.ModuleOwnerDataManager.GetDetails(moduleOwnerdata, SessionVariables.RequestProfile).Clone();
