<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MOStatGrid.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.ModuleOwner.Controls.MOStatGrid" %>
<!--Bootstrap -->
