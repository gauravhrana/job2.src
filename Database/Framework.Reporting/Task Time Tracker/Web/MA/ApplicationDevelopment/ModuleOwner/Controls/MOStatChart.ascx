<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MOStatChart.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.ModuleOwner.Controls.MOStatChart" %>
        ...
        <tr>
            <td>
                <asp:Chart ID="statChart" 
                    ...
                    runat="server" onload="statChart_Load" Height="400px" Width="600px">
                    <chartareas>
