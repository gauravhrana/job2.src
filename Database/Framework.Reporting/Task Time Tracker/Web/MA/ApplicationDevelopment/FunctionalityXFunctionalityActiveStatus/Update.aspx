<%@ Page Title="FunctionalityXFunctionalityActiveStatus - Update" Language="C#" AutoEventWireup="true"
    CodeBehind="Update.aspx.cs" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityXFunctionalityActiveStatus.Update" %>
