...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.DeveloperRole.Controls
{
    public partial class Generic : Framework.UI.Web.BaseClasses.ControlGenericStandard
    {
        ...
        public override int? Save(string action)
        {
            ...
            if (action == "Insert")
            {
				var dtDeveloperRole = TaskTimeTracker.Components.Module.ApplicationDevelopment.DeveloperRoleDataManager.DoesExist(data, SessionVariables.RequestProfile);

                if (dtDeveloperRole.Rows.Count == 0)
                {
