<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.DeveloperRole.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblDeveloperRoleIdText" runat="server"><span>DeveloperRoleId: </span></asp:Label>
            </td>
            <td>
                <asp:Label ID="lblDeveloperRoleId" runat="server"></asp:Label>
            </td>
            <td>
