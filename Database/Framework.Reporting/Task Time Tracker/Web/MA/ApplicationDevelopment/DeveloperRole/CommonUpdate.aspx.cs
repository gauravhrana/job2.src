...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.DeveloperRole
{
	public partial class CommonUpdate : PageCommonUpdate
	{
		...
		protected override DataTable UpdateData()
		{
			...
			UpdatedData = TaskTimeTracker.Components.Module.ApplicationDevelopment.DeveloperRoleDataManager.Search(data, SessionVariables.RequestProfile).Clone();
			for (var i = 0; i < SelectedData.Rows.Count; i++)
			{
				...
				var dt = TaskTimeTracker.Components.Module.ApplicationDevelopment.DeveloperRoleDataManager.Search(data, SessionVariables.RequestProfile);
        ...
        protected override DataTable GetEntityData(int? entityKey)
        {
			...
			var results = TaskTimeTracker.Components.Module.ApplicationDevelopment.DeveloperRoleDataManager.Search(developerRoledata, SessionVariables.RequestProfile);
            return results;
        }
