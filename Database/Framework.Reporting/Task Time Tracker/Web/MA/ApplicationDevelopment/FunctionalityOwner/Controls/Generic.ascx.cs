...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityOwner.Controls
{
	public partial class Generic : Framework.UI.Web.BaseClasses.ControlGeneric
	{
        ...
        public override int? Save(string action)
        {
            ...
            if (action == "Insert")
            {
                var dtEntityOwner = TaskTimeTracker.Components.Module.ApplicationDevelopment.FunctionalityOwnerDataManager.DoesExist(data, SessionVariables.RequestProfile);
