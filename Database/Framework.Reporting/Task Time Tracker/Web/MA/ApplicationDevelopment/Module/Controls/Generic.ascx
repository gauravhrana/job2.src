<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.Module.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblModuleId" Text="Module Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtModuleId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtModuleId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
