<%@ Page Title="FunctionalityEntityStatus - Clone" Language="C#" AutoEventWireup="true"
    CodeBehind="Clone.aspx.cs" MasterPageFile="~/MasterPages/Site.master" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityEntityStatus.Clone" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <br />
    <br />
    <asp:Label Text="Please enter the FunctionalityEntityStatusId" runat="server" />
