<%@ Page Title="FunctionalityImageInstance - Details" MasterPageFile="~/MasterPages/Site.Master" Language="C#" AutoEventWireup="true"
    CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityImageInstance.Details" EnableEventValidation="false" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        ...
        <tr>
            <td>
               <dc:DetailsControl ID="oDetailsControl" EntityName="FunctionalityImageInstance" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
