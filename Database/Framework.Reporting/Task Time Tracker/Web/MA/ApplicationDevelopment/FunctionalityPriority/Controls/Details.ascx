<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityPriority.Controls.Details" %>
...
<div class="panel panel-info table-bordered">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblFunctionalityPriorityIdText" runat="server" CssClass="control-label">FunctionalityPriorityId:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblFunctionalityPriorityId" runat="server"></asp:Label></div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"></div>
            <div class="col-sm-10"><asp:PlaceHolder ID="dynFunctionalityPriorityId" runat="server" /></div>
        </div>
