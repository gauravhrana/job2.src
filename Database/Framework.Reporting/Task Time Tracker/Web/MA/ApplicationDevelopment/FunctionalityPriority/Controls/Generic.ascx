<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityPriority.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblFunctionalityPriorityId" Text="FunctionalityPriority Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtFunctionalityPriorityId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtFunctionalityPriorityId" runat="server" CssClass="form-control"></asp:TextBox>
        </div> 
        <div class="col-sm-2">
