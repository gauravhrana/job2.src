<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.Entity.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblEntityId" Text="Entity Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtEntityId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtEntityId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
