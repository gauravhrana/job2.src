<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.WorkTicket.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblWorkTicketId" Text="WorkTicket Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtWorkTicketId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtWorkTicketId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
