...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.WorkTicket
{
	public partial class Default : Framework.UI.Web.BaseClasses.PageDefault
	{
		...
		{
			var dt = WorkTicketDataManager.Search(oSearchFilter.SearchParameters, SessionVariables.RequestProfile);
		...
		protected override void OnInit(EventArgs e)
		{
			...
			PrimaryEntity = SystemEntity.WorkTicket;
			PrimaryEntityKey = "WorkTicket";
			PrimaryEntityIdColumn = "WorkTicketId";
