<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityHistory.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblFunctionalityHistoryIdText" runat="server"><span>FunctionalityId: </span></asp:Label>
            </td>
            <td>
                <asp:Label ID="lblFunctionalityHistoryId" runat="server"></asp:Label>
            </td>
            <td>
                <asp:PlaceHolder ID="dynFunctionalityHistoryId" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="ralabel">
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblMemoText" runat="server"><span>Memo: </span></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblAcknowledgeByText" runat="server"><span>AcknowledgedBy: </span></asp:Label>
            </td>
            <td>
