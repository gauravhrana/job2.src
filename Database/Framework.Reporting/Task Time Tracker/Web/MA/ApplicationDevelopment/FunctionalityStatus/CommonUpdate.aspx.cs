...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityStatus
{
	public partial class CommonUpdate : PageCommonUpdate
	{
		...
		{	
			...
			UpdatedData = TaskTimeTracker.Components.Module.ApplicationDevelopment.FunctionalityStatusDataManager.Search(data, SessionVariables.RequestProfile).Clone();
			for (var i = 0; i < SelectedData.Rows.Count; i++)
			{
				data.FunctionalityStatusId =
					Convert.ToInt32(SelectedData.Rows[i][FunctionalityStatusDataModel.DataColumns.FunctionalityStatusId].ToString());
				...
				var dt = TaskTimeTracker.Components.Module.ApplicationDevelopment.FunctionalityStatusDataManager.Search(data, SessionVariables.RequestProfile);
        ...
        protected override DataTable GetEntityData(int? entityKey)
        {
            ...
            var results = TaskTimeTracker.Components.Module.ApplicationDevelopment.FunctionalityStatusDataManager.Search(functionalityStatusdata, SessionVariables.RequestProfile);
            return results;
        }
