<%@ Page Title="FunctionalityImageAttribute - Details" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FunctionalityImageAttribute.Details" EnableEventValidation="false" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        ...
        <tr>
            <td>
                <dc:DetailsControl ID="oDetailsControl" EntityName="FunctionalityImageAttribute" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
