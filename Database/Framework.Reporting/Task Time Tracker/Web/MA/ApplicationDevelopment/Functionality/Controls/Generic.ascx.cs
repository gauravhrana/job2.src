...
namespace ApplicationContainer.UI.Web.ApplicationDevelopment.Functionality.Controls
{
    public partial class Generic : Framework.UI.Web.BaseClasses.ControlGenericStandard
    {
        ...
        private void SetupDropdown()
        {
			...
			var functionalityActiveStatusData = TaskTimeTracker.Components.Module.ApplicationDevelopment.FunctionalityActiveStatusDataManager.GetDetails(FunctionalityActiveStatusDataModel.Empty,SessionVariables.RequestProfile);
            ...
            var functionalityPriorityData = TaskTimeTracker.Components.Module.ApplicationDevelopment.FunctionalityPriorityDataManager.GetDetails(FunctionalityPriorityDataModel.Empty,SessionVariables.RequestProfile);
