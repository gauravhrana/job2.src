<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.ApplicationDevelopment.FeatureOwnerStatus.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblFeatureOwnerStatusId" Text="FeatureOwnerStatus Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtFeatureOwnerStatusId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtFeatureOwnerStatusId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
