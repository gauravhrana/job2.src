    ...
    public partial class InlineUpdate : PageInlineUpdate
    {
        ...
        protected override DataTable GetData()
        {
            try
            {
                ...
                selectedrows = TaskTimeTracker.Components.BusinessLayer.Feature.RunTimeFeatureDataManager.GetDetails(runTimeFeaturedata, SessionVariables.RequestProfile).Clone();
