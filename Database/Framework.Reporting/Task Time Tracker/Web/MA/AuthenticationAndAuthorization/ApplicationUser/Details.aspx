<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.AuthenticationAndAuthorization.ApplicationUser.Details"
    EnableEventValidation="false" %>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="./Controls/Details.ascx" %>
<%@ Register TagName="RelationControl" TagPrefix="rc" Src="~/MA/AuthenticationAndAuthorization/ApplicationRole/Controls/Relation.ascx" %>
        ...
        <tr>
            <td align="left">
                <table  cellpadding="2" cellspacing="4" border="0">
                    ...
                    <%--<tr>
                        <td>
                            <rc:RelationControl ID="myRelationControl" runat="server" />
                        </td>
                    </tr>--%>
                </table>
            </td>
