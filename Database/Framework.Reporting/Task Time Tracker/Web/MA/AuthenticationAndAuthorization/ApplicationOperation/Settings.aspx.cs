...
namespace Shared.UI.Web.AuthenticationAndAuthorization.ApplicationOperation
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.ApplicationOperation, "ApplicationOperation");
		}
		...
		{
            Response.Redirect(Page.GetRouteUrl("AuthenticationAndAuthorizationSubRoutes", new { EntityName = "ApplicationOperation", Action = "Default" }), false);
		}
	}
}