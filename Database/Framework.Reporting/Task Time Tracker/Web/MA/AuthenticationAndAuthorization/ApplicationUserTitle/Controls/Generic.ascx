<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.AuthenticationAndAuthorization.ApplicationUserTitle.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblApplicationUserTitleId" Text="ApplicationUserTitle Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtApplicationUserTitleId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtApplicationUserTitleId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
