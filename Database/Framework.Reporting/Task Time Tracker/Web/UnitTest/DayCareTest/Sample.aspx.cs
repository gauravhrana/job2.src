...
namespace ApplicationContainer.UI.Web.UnitTest.DayCareTest
{
	public partial class Sample : System.Web.UI.Page
	{
		...
		protected void Search_Click(object sender, EventArgs e)
		{
			...
			//dt=DayCare.Components.BusinessLayer.EventTypeDataManager.Search(model, SessionVariables.RequestProfile);
			//testing1.DataSource = dt;
			//testing1.DataBind();

			//var model = new DataModel.DayCare.AccidentPlaceDataModel();
			//model.Name = "Testing Update of Accident Place";
			//DataTable dt = new DataTable();
			//dt = DayCare.Components.BusinessLayer.AccidentPlaceDataManager.Search(model, SessionVariables.RequestProfile);
			//testing1.DataSource = dt;
			//testing1.DataBind();
			...
			//model.Name = "Testing Update of Accident Report";
			//DataTable dt = new DataTable();
			//dt = DayCare.Components.BusinessLayer.AccidentReportDataManager.Search(model, SessionVariables.RequestProfile);
			//testing1.DataSource = dt;
			//testing1.DataBind();
			...
			//model.Name = "Testing Update of Activity Sub Type";
			//DataTable dt = new DataTable();
			//dt = DayCare.Components.BusinessLayer.ActivitySubTypeDataManager.Search(model, SessionVariables.RequestProfile);
			//testing1.DataSource = dt;
			//testing1.DataBind();
			...
			//model.Name = "Testing Update of Activity  Type";
			//DataTable dt = new DataTable();
			//dt = DayCare.Components.BusinessLayer.ActivityTypeDataManager.Search(model, SessionVariables.RequestProfile);
			//testing1.DataSource = dt;
			//testing1.DataBind();
		}
		...
		{
			//var model = new DataModel.DayCare.AccidentPlaceDataModel();
			//model.AccidentPlaceId = 37475;			
			//DayCare.Components.BusinessLayer.AccidentPlaceDataManager.Delete(model, SessionVariables.RequestProfile);

			//var model = new DataModel.DayCare.AccidentReportDataModel();
			//model.AccidentReportId = 37472;
			//DayCare.Components.BusinessLayer.AccidentReportDataManager.Delete(model, SessionVariables.RequestProfile);

			//var model = new DataModel.DayCare.EventTypeDataModel();
			//model.EventTypeId = 37476;
			//DayCare.Components.BusinessLayer.EventTypeDataManager.Delete(model, SessionVariables.RequestProfile);
