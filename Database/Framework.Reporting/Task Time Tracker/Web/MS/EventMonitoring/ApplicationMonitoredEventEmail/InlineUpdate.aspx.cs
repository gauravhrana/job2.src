	...
	public partial class InlineUpdate : PageInlineUpdate
    {
        ...
        protected override DataTable GetData()
		{
			try
			{
				...
				selectedrows = Framework.Components.EventMonitoring.ApplicationMonitoredEventEmailDataManager.GetDetails(applicationMonitoredEventEmaildata, SessionVariables.RequestProfile).Clone();
