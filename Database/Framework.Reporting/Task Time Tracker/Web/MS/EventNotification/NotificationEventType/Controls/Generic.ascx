<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.EventNotification.NotificationEventType.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblNotificationEventTypeId" Text="NotificationEventType Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtNotificationEventTypeId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtNotificationEventTypeId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
