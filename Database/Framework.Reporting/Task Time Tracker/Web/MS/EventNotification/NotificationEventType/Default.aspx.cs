...
namespace ApplicationContainer.UI.Web.EventNotification.NotificationEventType
{
    public partial class Default : Framework.UI.Web.BaseClasses.PageDefault
    {
        ...
        {
			var dt = Framework.Components.EventMonitoring.NotificationEventTypeDataManager.Search(oSearchFilter.SearchParameters, SessionVariables.RequestProfile);
		...
		protected override void OnInit(EventArgs e)
		{
			...
			PrimaryEntityIdColumn   = "NotificationEventTypeId";
