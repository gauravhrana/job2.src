...
namespace ApplicationContainer.UI.Web.EventNotification.NotificationRegistrar.Controls
{
    public partial class Generic : Framework.UI.Web.BaseClasses.ControlGeneric
    {
		...
		public override int? Save(string action)
		{
			...
			if (action == "Insert")
			{
				var dtNotificationRegistrar = Framework.Components.EventMonitoring.NotificationRegistrarDataManager.DoesExist(data, SessionVariables.RequestProfile);

				if (dtNotificationRegistrar.Rows.Count == 0)
				{
