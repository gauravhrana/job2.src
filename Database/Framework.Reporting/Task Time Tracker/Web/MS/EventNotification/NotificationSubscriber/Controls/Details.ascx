<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.EventNotification.NotificationSubscriber.Controls.Details" %>
...
<div class="panel panel-info table-bordered">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblNotificationSubscriberIdText" runat="server" CssClass="control-label">NotificationSubscriberId:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblNotificationSubscriberId" runat="server"></asp:Label></div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"></div>
            <div class="col-sm-10"><asp:PlaceHolder ID="dynNotificationSubscriberId" runat="server" /></div>
        </div>
