    ...
    public partial class InlineUpdate : PageInlineUpdate
    {
        ...
        protected override DataTable GetData()
        {
            try
            {
				...
				selectedrows = Framework.Components.EventMonitoring.NotificationPublisherDataManager.GetDetails(notificationPublisherdata, SessionVariables.RequestProfile).Clone();
