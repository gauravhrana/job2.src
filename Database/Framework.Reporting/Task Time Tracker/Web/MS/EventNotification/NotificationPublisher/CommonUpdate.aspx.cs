...
namespace ApplicationContainer.UI.Web.EventNotification.NotificationPublisher
{
	public partial class CommonUpdate : PageCommonUpdate
	{
		...
		protected override DataTable UpdateData()	
		{
			...
			UpdatedData = Framework.Components.EventMonitoring.NotificationPublisherDataManager.Search(data, SessionVariables.RequestProfile).Clone();
			for (var i = 0; i < SelectedData.Rows.Count; i++)
			{
				...
				var dt = Framework.Components.EventMonitoring.NotificationPublisherDataManager.Search(data, SessionVariables.RequestProfile);
        ...
        protected override DataTable GetEntityData(int? entityKey)
        {
			...
			var results = Framework.Components.EventMonitoring.NotificationPublisherDataManager.Search(notificationPublisherdata, SessionVariables.RequestProfile);
            return results;
        }
