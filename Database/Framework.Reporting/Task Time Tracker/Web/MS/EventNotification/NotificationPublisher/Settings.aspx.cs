...
namespace ApplicationContainer.UI.Web.EventNotification.NotificationPublisher
{
    public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
    {
        ...
        {
            eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.NotificationPublisher, "NotificationPublisher");
        }
        ...
        private void UpdateData(ArrayList values)
        {
            ...
            data.NotificationPublisherId = int.Parse(values[0].ToString());
        ...
        {
            var data = new NotificationPublisherDataModel();
			var dtNotificationPublisher = Framework.Components.EventMonitoring.NotificationPublisherDataManager.Search(data, SessionVariables.RequestProfile);
        }
    }
}