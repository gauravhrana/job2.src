...
namespace Shared.UI.Web.TasksAndWorkflow.TaskEntity
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.TaskEntity, "TaskEntity");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/TaskEntity/Default.aspx");
		}
	}
}