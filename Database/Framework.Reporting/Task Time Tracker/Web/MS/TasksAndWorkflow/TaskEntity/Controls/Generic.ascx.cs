...
namespace Shared.UI.Web.TasksAndWorkflow.TaskEntity.Controls
{
    public partial class Generic : Framework.UI.Web.BaseClasses.ControlGeneric
    {
		...
		public override int? Save(string action)
		{
			...
			if (action == "Insert")
			{
				var dtTaskEntity = Framework.Components.TasksAndWorkflow.TaskEntityDataManager.DoesExist(data, SessionVariables.RequestProfile);

				if (dtTaskEntity.Rows.Count == 0)
				{
