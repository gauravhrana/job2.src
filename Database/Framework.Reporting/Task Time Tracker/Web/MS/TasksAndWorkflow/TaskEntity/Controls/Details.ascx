<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.TasksAndWorkflow.TaskEntity.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
               <asp:Label ID="lblTaskEntityIdText" runat="server" >TaskEntityId :</asp:Label>
            </td>
            <td>
                <asp:Label ID="lblTaskEntityId" runat="server"></asp:Label>
            </td>
            <td>
       ...
       <%-- <tr>
        ...
        <tr>
            <td class="ralabel">
                 <asp:Label ID="lblTaskEntityTypeText" runat="server" >TaskEntityType :</asp:Label>
            </td>
            <td>
                <asp:Label ID="lblTaskEntityType" runat="server"></asp:Label>
            </td>
            <td>
            </td>
        </tr>
