...
namespace Shared.UI.Web.TasksAndWorkflow.TaskScheduleType
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.TaskScheduleType, "DBColumns", SessionVariables.RequestProfile);
		}
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("TaskScheduleType", " ", "TaskScheduleTypeId", false, GetData, GetColumns, false);
