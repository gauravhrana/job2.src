<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.TasksAndWorkflow.TaskScheduleType.Controls.Generic" %>
        ...
        <tr>
            <td>
                <table width="95%"  >
                    <tr>
                        <td class="ralabel">
                            <asp:Label ID="lblTaskScheduleTypeId" Text="TaskScheduleTypeId:"
                                runat="server"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtTaskScheduleTypeId" runat="server"></asp:TextBox>
                        </td>
                        <td>
