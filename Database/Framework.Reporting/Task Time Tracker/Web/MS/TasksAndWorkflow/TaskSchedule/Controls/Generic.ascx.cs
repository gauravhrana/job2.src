...
namespace Shared.UI.Web.TasksAndWorkflow.TaskSchedule.Controls
{
    public partial class Generic : Framework.UI.Web.BaseClasses.ControlGeneric
    {
		...
		public override int? Save(string action)
		{
			...
			if (action == "Insert")
			{
				var dtTaskSchedule = Framework.Components.TasksAndWorkflow.TaskScheduleDataManager.DoesExist(data, SessionVariables.RequestProfile);

				if (dtTaskSchedule.Rows.Count == 0)
				{
