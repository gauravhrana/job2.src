<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.TasksAndWorkflow.TaskEntityType.Controls.Generic" %>
        ...
        <tr>
            <td>
                <table width="95%"  >
                    <tr>
                        <td class="ralabel">
                            <asp:Label ID="lblTaskEntityTypeId" Text="TaskEntityTypeId:" runat="server"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtTaskEntityTypeId" runat="server"></asp:TextBox>
                        </td>
                        <td>
