<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.Aptitude.Competency.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblCompetencyId" Text="Competency Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtCompetencyId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtCompetencyId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
