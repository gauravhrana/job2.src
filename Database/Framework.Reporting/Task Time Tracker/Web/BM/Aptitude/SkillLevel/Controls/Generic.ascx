<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.Aptitude.SkillLevel.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblSkillLevelId" Text="SkillLevel Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtSkillLevelId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtSkillLevelId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
