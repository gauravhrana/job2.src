<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.Aptitude.Skill.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class='row'>
        <div class='col-sm-12'>
            <dc:DetailsControl ID='oDetailsControl' EntityName='Skill' runat='server' />
        </div>
    </div>
