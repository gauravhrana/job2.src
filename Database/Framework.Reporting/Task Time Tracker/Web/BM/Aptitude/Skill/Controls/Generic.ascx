<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.Aptitude.Skill.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblSkillId" Text="Skill Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtSkillId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtSkillId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
