<%@ Page Title="Clone" Language="C#" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="ApplicationContainer.UI.Web.Aptitude.SkillXPersonXSkillLevel.Delete" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            SkillXPersonXSkillLevel Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
