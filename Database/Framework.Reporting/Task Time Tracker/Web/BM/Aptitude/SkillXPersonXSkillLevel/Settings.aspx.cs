...
namespace ApplicationContainer.UI.Web.Aptitude.SkillXPersonXSkillLevel
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.SkillXPersonXSkillLevel, "SkillXPersonXSkillLevel");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/SkillXPersonXSkillLevel/Default.aspx");
		}
	}
}