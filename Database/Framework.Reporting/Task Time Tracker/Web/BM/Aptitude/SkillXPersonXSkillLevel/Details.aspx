<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.Aptitude.SkillXPersonXSkillLevel.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        ...
        <tr>
            <td>
                <dc:DetailsControl ID="oDetailsControl" EntityName="SkillXPersonXSkillLevel" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
