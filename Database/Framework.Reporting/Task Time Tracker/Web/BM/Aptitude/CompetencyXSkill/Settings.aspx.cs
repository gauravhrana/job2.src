...
namespace ApplicationContainer.UI.Web.Aptitude.CompetencyXSkill
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.CompetencyXSkill, "CompetencyXSkill");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/CompetencyXSkill/Default.aspx");
		}
	}
}