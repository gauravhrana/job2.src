<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.TCM.TestCaseOwner.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblTestCaseOwnerId" Text="TestCaseOwner Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtTestCaseOwnerId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtTestCaseOwnerId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynTestCaseOwnerId" runat="server" />
        </div>
    </div>
