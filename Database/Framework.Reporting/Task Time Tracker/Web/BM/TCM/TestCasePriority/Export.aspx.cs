...
namespace ApplicationContainer.UI.Web.TCM.TestCasePriority
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
        ...
        {
            return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.TestCasePriority, "DBColumns", SessionVariables.RequestProfile);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("TestCasePriority", "", "TestCasePriorityId", false, GetData, GetColumns, false);
