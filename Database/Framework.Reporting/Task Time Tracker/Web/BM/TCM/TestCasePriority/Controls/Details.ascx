<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.TCM.TestCasePriority.Controls.Details" %>
...
<div class="panel panel-info table-bordered">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblTestCasePriorityIdText" runat="server" CssClass="control-label">TestCasePriorityId:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblTestCasePriorityId" runat="server"></asp:Label></div>
        </div>            
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"></div>
            <div class="col-sm-10"><asp:PlaceHolder ID="dynTestCasePriorityId" runat="server" /></div>
        </div>
