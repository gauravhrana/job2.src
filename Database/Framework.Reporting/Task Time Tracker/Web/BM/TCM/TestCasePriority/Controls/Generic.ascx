<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.TCM.TestCasePriority.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblTestCasePriorityId" Text="TestCasePriority Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtTestCasePriorityId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtTestCasePriorityId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
