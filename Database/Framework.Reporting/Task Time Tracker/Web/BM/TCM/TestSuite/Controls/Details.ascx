<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.TCM.TestSuite.Controls.Details" %>
...
<div class="panel panel-info table-bordered">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblTestSuiteIdText" runat="server" CssClass="control-label">TestSuiteId:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblTestSuiteId" runat="server"></asp:Label></div>
        </div>            
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"></div>
            <div class="col-sm-10"><asp:PlaceHolder ID="dynTestSuiteId" runat="server" /></div>
        </div>
