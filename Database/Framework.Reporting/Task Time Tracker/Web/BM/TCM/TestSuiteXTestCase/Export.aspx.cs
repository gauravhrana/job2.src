...
namespace ApplicationContainer.UI.Web.TCM.TestSuiteXTestCase
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
        ...
        {
			var validColumns = FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.TestSuiteXTestCase, "Default", SessionVariables.RequestProfile);
            return validColumns;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("TestSuiteXTestCase", " ", "TestSuiteXTestCaseId", false, GetData, GetColumns, false);
