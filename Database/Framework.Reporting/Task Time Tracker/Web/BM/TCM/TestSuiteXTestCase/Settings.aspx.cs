...
namespace ApplicationContainer.UI.Web.TCM.TestSuiteXTestCase
{
    public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
    {
        ...
        {
            eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.TestSuiteXTestCase, "TestSuiteXTestCase");
        }
        ...
        {
            Response.Redirect("~/Shared/Configuration/TestSuiteXTestCase/Default.aspx");
        }
    }
}