...
namespace ApplicationContainer.UI.Web.TCM.TestCaseStatus
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
        ...
        {
            return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.TestCaseStatus, "DBColumns", SessionVariables.RequestProfile);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("TestCaseStatus", "", "TestCaseStatusId", false, GetData, GetColumns, false);
