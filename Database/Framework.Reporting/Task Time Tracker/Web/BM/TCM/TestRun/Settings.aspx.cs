...
namespace ApplicationContainer.UI.Web.TCM.TestRun
{
    public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
    {
        ...
        {
            eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.TestRun, "TestRun");
        }
        ...
        private void UpdateData(ArrayList values)
        {
            ...
            data.TestRunId       = int.Parse(values[0].ToString());
        ...
        {
            var data = new TestRunDataModel();
            var dtTestRun = TestCaseManagement.Components.DataAccess.TestRunDataManager.Search(data, SessionVariables.RequestProfile);
