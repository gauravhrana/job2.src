...
namespace ApplicationContainer.UI.Web.TCM.TestRun
{
    public partial class CommonUpdate : PageCommonUpdate
    {
        ...
        protected override DataTable UpdateData()
        {
            ...
            UpdatedData = TestCaseManagement.Components.DataAccess.TestRunDataManager.Search(data, SessionVariables.RequestProfile).Clone();
            for (var i = 0; i < SelectedData.Rows.Count; i++)
            {
                data.TestRunId =
                    Convert.ToInt32(SelectedData.Rows[i][TestRunDataModel.DataColumns.TestRunId].ToString());
				...
				data = new TestRunDataModel();
                data.TestRunId = Convert.ToInt32(SelectedData.Rows[i][TestRunDataModel.DataColumns.TestRunId].ToString());
        ...
        protected override DataTable GetEntityData(int? entityKey)
        {
            ...
            var results = TestCaseManagement.Components.DataAccess.TestRunDataManager.Search(testRundata, SessionVariables.RequestProfile);
            return results;
        }
