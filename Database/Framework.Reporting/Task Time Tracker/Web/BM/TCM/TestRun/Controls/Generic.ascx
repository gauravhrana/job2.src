<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.TCM.TestRun.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblTestRunId" Text="TestRun Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtTestRunId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtTestRunId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynTestRunId" runat="server" />
        </div>
    </div>
