<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.TCM.TestCase.Controls.Generic" %>
<%@ Register TagPrefix="dc" TagName="List" Src="~/Shared/Controls/HistoryList.ascx" %>
<%@ Register Src="~/Shared/Controls/UpdateInfo.ascx" TagName="UpdateInfo" TagPrefix="ui" %>
<div class="form-horizontal">

    <div class="form-group">
        <asp:Label ID="lblTestCaseId" Text="TestCase Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtTestCaseId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtTestCaseId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
