<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.MilestoneFeatureState.Controls.Generic" %>
...
<div class="form-horizontal"> 
    ...
    <div class="form-group">
        <asp:Label ID="lblMilestoneFeatureStateId" Text="MilestoneFeatureState Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtMilestoneFeatureStateId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtMilestoneFeatureStateId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
