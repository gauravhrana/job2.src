<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.Milestone.Controls.Generic" %>
        ...
        <tr>
            <td>
                <table width="95%"  >
                    <tr>
                        <td class="ralabel">
                            <asp:Label ID="lblMilestoneId" Text="MilestoneId:" runat="server"></asp:Label>
                        </td>
                        <td>
