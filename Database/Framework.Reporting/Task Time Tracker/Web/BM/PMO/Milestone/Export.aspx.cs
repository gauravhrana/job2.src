...
namespace ApplicationContainer.UI.Web.Milestone
{
    public partial class Export : BasePage
    {
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(SystemEntity.Milestone, "DBColumns", SessionVariables.RequestProfile);
		}
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("Milestone", " ", "MilestoneId", false, GetData, GetColumns, false);
