<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.MilestoneXFeatureArchive.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblMilestoneXFeatureArchiveIdText" runat="server"
                   >MilestoneXFeatureArchiveId :</asp:Label>
            </td>
            <td>
                <asp:Label ID="lblMilestoneXFeatureArchiveId" runat="server"></asp:Label>
            </td>
            <td>
                <asp:PlaceHolder ID="dynMilestoneXFeatureArchiveId" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="ralabel">
