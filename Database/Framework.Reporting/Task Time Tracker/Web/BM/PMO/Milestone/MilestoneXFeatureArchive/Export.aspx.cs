...
namespace ApplicationContainer.UI.Web.MilestoneXFeatureArchive
{
    public partial class Export : BasePage
    {
        ...
        private DataTable GetData()
        {
			...
			var dt = MilestoneXFeatureArchiveDataManager.Search(data, SessionVariables.RequestProfile);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("MilestoneXFeatureArchive", "", "MilestoneXFeatureArchiveId", false, GetData, GetColumns, false);
