    ...
    public partial class InlineUpdate : PageInlineUpdate
    {
        ...
        protected override DataTable GetData()
        {
            try
            {
                ...
                selectedrows = LayerDataManager.GetDetails(layerdata, SessionVariables.RequestProfile).Clone();
                if (!string.IsNullOrEmpty(SuperKey))
                {
                    ...
                    foreach (var entityKey in lstEntityKeys)
                    {
                        ...
                        var result = LayerDataManager.GetDetails(layerdata, SessionVariables.RequestProfile);
                        selectedrows.ImportRow(result.Rows[0]);
                    }
                }
                else
                {
                    layerdata.LayerId = SetId;
                    var result = LayerDataManager.GetDetails(layerdata, SessionVariables.RequestProfile);
                    selectedrows.ImportRow(result.Rows[0]);
