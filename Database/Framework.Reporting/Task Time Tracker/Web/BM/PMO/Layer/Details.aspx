<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" Language="C#" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.Layer.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class='row'>
        <div class='col-sm-12'>
            <dc:DetailsControl ID='oDetailsControl' EntityName='Layer' runat='server' />
        </div>
    </div>
