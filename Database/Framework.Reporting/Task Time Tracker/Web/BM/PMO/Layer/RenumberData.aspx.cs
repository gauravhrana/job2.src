...
namespace ApplicationContainer.UI.Web.Layer
{
	public partial class RenumberData : System.Web.UI.Page
	{
		...
		protected override void OnInit(EventArgs e)
		{
			...
			{
				var superKey = "";
				var newId = Framework.Components.Core.SystemEntityTypeDataManager.GetNextSequence("Layer", (int)Framework.Components.DataAccess.SystemEntity.Layer, SessionVariables.RequestProfile);
				...
				if (Request.QueryString["SuperKey"] != null)
				{
					...
					data.SystemEntityTypeId = (int)Framework.Components.DataAccess.SystemEntity.Layer;
