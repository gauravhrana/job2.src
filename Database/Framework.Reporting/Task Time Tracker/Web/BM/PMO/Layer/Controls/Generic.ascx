<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.Layer.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblLayerId" Text="Layer Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtLayerId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtLayerId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynLayerId" runat="server" />
        </div>
    </div>
