<%@ Page Title="Details" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.ProjectPortfolioGroup.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        ...
        <tr>
            <td>
                <dc:DetailsControl ID="oDetailsControl" EntityName="ProjectPortfolioGroup" runat="server" />
            </td>
        </tr>
