<%@ Page Title="Clone" EnableEventValidation="false" Language="C#" MasterPageFile="~/MasterPages/Site.master"
    AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="ApplicationContainer.UI.Web.ProjectPortfolioGroupXProjectPortfolio.Delete" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            ProjectPortfolioGroupXProjectPortfolio Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
