<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.ProjectManagement.Project.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblProjectId" Text="Project Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtProjectId"></asp:Label>
        <div class="col-sm-8">
