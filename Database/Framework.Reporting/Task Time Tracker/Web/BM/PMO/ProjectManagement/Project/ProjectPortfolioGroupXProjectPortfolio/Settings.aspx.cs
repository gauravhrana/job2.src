...
namespace ApplicationContainer.UI.Web.ProjectPortfolioGroupXProjectPortfolio
{
	public partial class Settings : PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)SystemEntity.ProjectPortfolioGroupXProjectPortfolio, "ProjectPortfolioGroupXProjectPortfolio");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/ProjectPortfolioGroupXProjectPortfolio/Default.aspx");
		}
	}
}