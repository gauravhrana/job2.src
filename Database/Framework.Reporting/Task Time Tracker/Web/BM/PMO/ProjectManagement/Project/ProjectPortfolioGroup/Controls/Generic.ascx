<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.ProjectManagement.Project.ProjectPortfolioGroup.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblProjectPortfolioGroupId" Text="ProjectPortfolioGroup Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtProjectPortfolioGroupId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtProjectPortfolioGroupId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
