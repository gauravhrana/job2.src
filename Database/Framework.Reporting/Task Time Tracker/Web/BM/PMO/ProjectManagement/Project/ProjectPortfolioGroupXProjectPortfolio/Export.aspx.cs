...
namespace ApplicationContainer.UI.Web.ProjectPortfolioGroupXProjectPortfolio
{
	public partial class Export : BasePage
	{
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(SystemEntity.ProjectPortfolioGroupXProjectPortfolio, "DBColumns", SessionVariables.RequestProfile);
		}
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				oList.Setup("ProjectPortfolioGroupXProjectPortfolio", " ", "ProjectPortfolioGroupXProjectPortfolioId", false, GetData, GetColumns, false);
