<%@ Page 
	...
	Inherits="ApplicationContainer.UI.Web.ProjectPortfolio.Default" 
%>
...
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">ProjectPortfolio</asp:Content>
