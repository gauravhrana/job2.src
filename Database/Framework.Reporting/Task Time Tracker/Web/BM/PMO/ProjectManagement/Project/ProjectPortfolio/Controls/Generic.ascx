<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.ProjectManagement.Project.ProjectPortfolio.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblProjectPortfolioId" Text="ProjectPortfolio Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtProjectPortfolioId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtProjectPortfolioId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
