<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.PMO.Client.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblClientId" Text="Client Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtClientId"></asp:Label>
        <div class="col-sm-8">
