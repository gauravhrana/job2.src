<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.Scheduling.ScheduleState.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblScheduleStateId" Text="ScheduleState Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtScheduleStateId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtScheduleStateId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynScheduleStateId" runat="server" />
        </div>
    </div>
