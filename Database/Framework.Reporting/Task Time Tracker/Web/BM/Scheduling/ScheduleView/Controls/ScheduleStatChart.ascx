<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScheduleStatChart.ascx.cs" Inherits="ApplicationContainer.UI.Web.Scheduling.Schedule.Controls.ScheduleStatChart" %>
