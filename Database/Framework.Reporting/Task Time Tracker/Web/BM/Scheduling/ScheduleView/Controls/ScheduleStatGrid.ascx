<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScheduleStatGrid.ascx.cs" Inherits="ApplicationContainer.UI.Web.Scheduling.Schedule.Controls.ScheduleStatGrid" %>
<!--Bootstrap -->
