<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GroupControl.ascx.cs" Inherits="ApplicationContainer.UI.Web.Scheduling.Schedule.Controls.GroupControl" %>
