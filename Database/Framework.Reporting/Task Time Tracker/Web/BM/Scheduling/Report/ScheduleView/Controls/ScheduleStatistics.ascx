<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScheduleStatistics.ascx.cs" Inherits="ApplicationContainer.UI.Web.BM.Scheduling.Report.ScheduleView.Controls.ScheduleStatistics" %>
<div id="divStat" class="divSchedule">
