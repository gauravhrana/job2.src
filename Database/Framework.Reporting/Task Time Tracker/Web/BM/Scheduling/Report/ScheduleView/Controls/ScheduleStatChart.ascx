<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScheduleStatChart.ascx.cs" Inherits="ApplicationContainer.UI.Web.BM.Scheduling.Report.ScheduleView.Controls.ScheduleStatChart" %>
