<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Schedule/Site.master" CodeBehind="Settings.aspx.cs" Inherits="ApplicationContainer.UI.Web.Scheduling.ScheduleQuestion.Settings" %>

<%@ Register TagPrefix="ec" TagName="eSettingsList" Src="~/Shared/Controls/eSettingsList.ascx" %>
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
    ScheduleQuestion Settings
</asp:Content>
