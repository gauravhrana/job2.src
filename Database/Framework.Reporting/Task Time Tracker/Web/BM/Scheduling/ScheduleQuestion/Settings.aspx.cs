...
namespace ApplicationContainer.UI.Web.Scheduling.ScheduleQuestion
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.ScheduleQuestion, "ScheduleQuestion");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/ScheduleQuestion/Default.aspx");
		}
	}
}