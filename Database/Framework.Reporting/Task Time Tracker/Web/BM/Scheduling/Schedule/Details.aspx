<%@ Page Title="Details" MasterPageFile="~/MasterPages/Schedule/Site.master" EnableEventValidation="false"
    Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.Scheduling.Schedule.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        <tr>
         ...
         <tr>
            <td>
                <dc:DetailsControl ID="oDetailsControl" EntityName="Schedule" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
