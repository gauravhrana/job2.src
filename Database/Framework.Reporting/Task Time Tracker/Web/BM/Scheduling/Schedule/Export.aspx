<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Schedule/Export.Master" CodeBehind="Export.aspx.cs" Inherits="ApplicationContainer.UI.Web.Scheduling.Schedule.Export" %>
...
<asp:Content ID="exportHeading" ContentPlaceHolderID="SectionName" runat="server">
    <asp:Label Text="ScheduleSearch" runat="server" ForeColor="Red" />
</asp:Content> 
