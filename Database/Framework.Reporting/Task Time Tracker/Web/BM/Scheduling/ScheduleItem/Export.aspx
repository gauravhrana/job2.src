<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Schedule/Export.Master" CodeBehind="Export.aspx.cs" Inherits="ApplicationContainer.UI.Web.Scheduling.ScheduleItem.Export" %>
<%@ Register TagName="List" TagPrefix="sr" Src="~/Shared/Controls/List/List.ascx" %>
 ...
 <asp:Content ID="exportHeading" ContentPlaceHolderID="SectionName" runat="server">
    <asp:Label Text="ScheduleItemSearch" runat="server" ForeColor="Red" />
</asp:Content> 
