<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScheduleDetailStatChart.ascx.cs" Inherits="ApplicationContainer.UI.Web.Scheduling.ScheduleDetail.Controls.ScheduleDetailStatChart" %>
