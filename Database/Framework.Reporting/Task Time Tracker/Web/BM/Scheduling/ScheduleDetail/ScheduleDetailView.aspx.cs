...
{
	public partial class ScheduleDetailView : BasePage
	{
		#region variable
		...
		{
			var lstValues = ScheduleDetailDataManager.GetStatisticDataSummary(scheduleData, ScheduleDataModel.DataColumns.ScheduleTimeSpentConstant, ApplicationCommon.ScheduleStatisticUnknown);
		...
		protected override void OnInit(EventArgs e)
		{
			...
			oSearchFilter.GetFilter(SystemEntity.ScheduleDetail, "ScheduleDetailId");
			GetTabControl();
		}
