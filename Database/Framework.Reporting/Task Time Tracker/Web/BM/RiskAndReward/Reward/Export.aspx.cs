...
namespace ApplicationContainer.UI.Web.RiskAndReward.Reward
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.Reward, "DBColumns", SessionVariables.RequestProfile);
		}
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("Reward", "", "RewardId", false, GetData, GetColumns, false);
