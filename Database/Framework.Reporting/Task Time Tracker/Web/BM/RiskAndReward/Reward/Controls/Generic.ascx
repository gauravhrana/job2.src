<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.RiskAndReward.Reward.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblRewardId" Text="Reward Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtRewardId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtRewardId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
