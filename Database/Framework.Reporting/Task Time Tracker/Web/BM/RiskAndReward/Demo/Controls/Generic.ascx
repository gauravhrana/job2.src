...
Inherits='ApplicationContainer.UI.Web.RiskAndReward.Demo.Controls.Generic' %>
...
<div class='form-horizontal'>
	...
	<asp:Label ID='lblRiskId' Text='Risk Id:' runat='server' 
	CssClass='col-sm-2 control-label' AssociatedControlID='txtRiskId'></asp:Label>
	div class='col-sm-8'>
...
<div id='borderdiv' runat='server'><table></table></div>
