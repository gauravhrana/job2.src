...
CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.RiskAndReward.Demo.Details" 
...
<div class='row'>
	<div class='col-sm-12'>
		<dc:DetailsControl ID='oDetailsControl' EntityName='Risk' runat='server' />
	</div>
</div>
