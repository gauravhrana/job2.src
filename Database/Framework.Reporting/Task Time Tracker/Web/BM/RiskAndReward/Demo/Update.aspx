<%@ Page Title='Update' MasterPageFile='~/MasterPages/Site.Master' Language='C#' 
AutoEventWireup='true' CodeBehind='Update.aspx.cs' 
Inherits='ApplicationContainer.UI.Web.RiskAndReward.Demo.Update' EnableEventValidation='false' %>
...
<asp:Content ID='UpdateContent' ContentPlaceHolderID='MainContent' runat='server'>
	...
	<div class='row'>
		...
		<div class='col-sm-2'><asp:CheckBox ID='chkVisible' runat='server' Text='Audit History Visible' 
		OnCheckedChanged='chkVisible_CheckedChanged' AutoPostBack='true' /></div>
	</div>
