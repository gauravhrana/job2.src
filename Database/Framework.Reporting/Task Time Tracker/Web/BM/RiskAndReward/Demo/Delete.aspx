...
Inherits='ApplicationContainer.UI.Web.RiskAndReward.Demo.Delete' EnableEventValidation='false' %>
...
<asp:Content ID='BodyContent' runat='server' ContentPlaceHolderID='MainContent'>
	...
	<div class='row'>
		...
		<div class='col-sm-2'>
			<asp:CheckBox ID='chkVisible' runat='server' Text='Audit History Visible' 
			OnCheckedChanged='chkVisible_CheckedChanged' AutoPostBack='true' Enabled='true' Checked='true' />
		</div>
	</div>
