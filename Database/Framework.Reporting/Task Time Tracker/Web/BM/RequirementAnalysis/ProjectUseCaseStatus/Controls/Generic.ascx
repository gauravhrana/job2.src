<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.ProjectUseCaseStatus.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblProjectUseCaseStatusId" Text="ProjectUseCaseStatus Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtProjectUseCaseStatusId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtProjectUseCaseStatusId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
