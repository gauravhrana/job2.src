...
namespace BM.RequirementAnalysis.UI.Web
{
    public partial class Default : Framework.UI.Web.BaseClasses.PageBasePage
	{
		...
		{
            ApplicationCommon.ResetApplicationCache("PDTMGMDEVT");
        ...
        {            
            ...
            //Framework.Components.LogAndTrace.UserLoginStatusDataManager.Sync(100065, 100, SessionVariables.RequestProfile);

            //LanguageDataManager.Sync(100065, 100, SessionVariables.RequestProfile);
