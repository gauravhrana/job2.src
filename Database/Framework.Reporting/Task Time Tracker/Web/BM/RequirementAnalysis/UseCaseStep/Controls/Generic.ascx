<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.UseCaseStep.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblUseCaseStepId" Text="UseCaseStep Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtUseCaseStepId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtUseCaseStepId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
