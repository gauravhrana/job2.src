<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.Need.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblNeedId" Text="Need Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtNeedId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtNeedId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynNeedId" runat="server" />
        </div>
    </div>
