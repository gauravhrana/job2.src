...
namespace ApplicationContainer.UI.Web.ProjectXUseCase
{
	public partial class Export : Shared.UI.WebFramework.BasePage
	{
		...
		{
			var validColumns = FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.ProjectXUseCase, "DBColumns", SessionVariables.RequestProfile);
			return validColumns;
		}
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				oList.Setup("ProjectXUseCase", " ", "ProjectXUseCaseId", false, GetData, GetColumns, false);
