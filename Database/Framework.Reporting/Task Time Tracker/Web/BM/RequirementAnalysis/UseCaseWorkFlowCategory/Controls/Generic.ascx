<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.UseCaseWorkFlowCategory.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblUseCaseWorkFlowCategoryId" Text="UseCaseWorkFlowCategory Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtUseCaseWorkFlowCategoryId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtUseCaseWorkFlowCategoryId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
