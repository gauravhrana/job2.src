<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.UseCase.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblUseCaseId" Text="UseCase Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtUseCaseId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtUseCaseId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
