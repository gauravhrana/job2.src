<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.FeatureRuleStatus.Controls.Details" %>
...
<div class="panel panel-info table-bordered">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblFeatureRuleStatusIdText" runat="server" CssClass="control-label">FeatureRuleStatusId:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblFeatureRuleStatusId" runat="server"></asp:Label></div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"></div>
            <div class="col-sm-10"><asp:PlaceHolder ID="dynFeatureRuleStatusId" runat="server" /></div>
        </div>
