<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.FeatureRuleStatus.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblFeatureRuleStatusId" Text="FeatureRuleStatus Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtFeatureRuleStatusId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtFeatureRuleStatusId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
