<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.FeatureGroup.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblFeatureGroupId" Text="FeatureGroup Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtFeatureGroupId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtFeatureGroupId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynFeatureGroupId" runat="server" />
        </div>
    </div>
