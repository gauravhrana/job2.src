...
namespace ApplicationContainer.UI.Web.FeatureRule
{
	public partial class Export : Shared.UI.WebFramework.BasePage
	{
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.FeatureRule, "DBColumns", SessionVariables.RequestProfile);
		}
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				oList.Setup("FeatureRule", " ", "FeatureRuleId", false, GetData, GetColumns, false);
