<%@ Page 
	...
	Inherits="ApplicationContainer.UI.Web.Feature.FeatureRule.Default" 
%>
...
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">FeatureRule</asp:Content>
