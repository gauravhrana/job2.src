<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.Feature.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblFeatureId" Text="Feature Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtFeatureId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtFeatureId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
