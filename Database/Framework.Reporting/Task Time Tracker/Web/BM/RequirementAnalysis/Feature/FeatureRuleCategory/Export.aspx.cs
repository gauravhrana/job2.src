...
namespace ApplicationContainer.UI.Web.FeatureRuleCategory
{
	public partial class Export : Shared.UI.WebFramework.BasePage
	{
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.FeatureRuleCategory, "DBColumns", SessionVariables.RequestProfile);
		}
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				oList.Setup("FeatureRuleCategory", " ", "FeatureRuleCategoryId", false, GetData, GetColumns, false);
