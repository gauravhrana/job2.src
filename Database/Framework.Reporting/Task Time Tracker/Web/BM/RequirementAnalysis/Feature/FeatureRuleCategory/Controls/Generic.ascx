<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.FeatureRuleCategory.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblFeatureRuleCategoryId" Text="FeatureRuleCategory Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtFeatureRuleCategoryId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtFeatureRuleCategoryId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
