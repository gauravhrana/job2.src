...
namespace ApplicationContainer.UI.Web.FeatureXFeatureRule
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
        ...
        {
            var validColumns = FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.FeatureXFeatureRule, "DBColumns", SessionVariables.RequestProfile);
            return validColumns;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("FeatureXFeatureRule", " ", "FeatureXFeatureRuleId", false, GetData, GetColumns, false);
