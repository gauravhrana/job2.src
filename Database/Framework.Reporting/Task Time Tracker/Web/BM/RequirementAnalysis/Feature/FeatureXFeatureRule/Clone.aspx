<%@ Page Title="Clone" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true"
 CodeBehind="Clone.aspx.cs" Inherits="ApplicationContainer.UI.Web.FeatureXFeatureRule.Clone" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
    ...
    <asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        <br /><br />
        <asp:Label ID="Label1" Text="Please enter the FeatureXFeatureRuleId" runat="server"/>
