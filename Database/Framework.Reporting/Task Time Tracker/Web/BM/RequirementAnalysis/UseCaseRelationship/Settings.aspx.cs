...
namespace ApplicationContainer.UI.Web.UseCaseRelationship
{
    public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.UseCaseRelationship, "UseCaseRelationship");
        }
        ...
        private void UpdateData(ArrayList values)
        {
            ...
            data.UseCaseRelationshipId      = int.Parse(values[0].ToString());
        ...
        {
            var data = new UseCaseRelationshipDataModel();
            var dtUseCaseRelationship = TaskTimeTracker.Components.BusinessLayer.RequirementAnalysis.UseCaseRelationshipDataManager.Search(data, SessionVariables.RequestProfile);
