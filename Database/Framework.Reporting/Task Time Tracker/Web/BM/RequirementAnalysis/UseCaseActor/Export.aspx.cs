...
namespace ApplicationContainer.UI.Web.UseCaseActor
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
        ...
        {
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.UseCaseActor, "DBColumns", SessionVariables.RequestProfile);
        }
        ...
        {
            oList.Setup("UseCaseActor", " ", "UseCaseActorId", false, GetData, GetColumns, false);
