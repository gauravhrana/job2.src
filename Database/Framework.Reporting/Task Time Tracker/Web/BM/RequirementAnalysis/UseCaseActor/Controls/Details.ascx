<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.UseCaseActor.Controls.Details" %>
...
<div class="panel panel-info">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblUseCaseActorIdText" runat="server">Use Case ActorId:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblUseCaseActorId" runat="server"></asp:Label></div>
        </div>
       <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"></div>
            <div class="col-sm-10"><asp:PlaceHolder ID="dynUseCaseActorId" runat="server" /></div>
        </div>
