<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.UseCaseActor.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblUseCaseActorId" Text="UseCaseActor Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtUseCaseActorId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtUseCaseActorId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
