<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Export.aspx.cs" Inherits="ApplicationContainer.UI.Web.UseCaseXUseCaseStep.Export" %>
...
<asp:Content ID="exportHeading" ContentPlaceHolderID="SectionName" runat="server">
    <asp:Label Text="UseCaseXUseCaseStepSearch" runat="server" ForeColor="Red" />
</asp:Content> 
