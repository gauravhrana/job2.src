<%@ Page Title="ProjectUseCaseStatusArchive - Details" Language="C#" MasterPageFile="~/MasterPages/Site.master"
    AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.ProjectUseCaseStatusArchive.Details" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            ProjectUseCaseStatusArchive Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
