...
namespace ApplicationContainer.UI.Web.UseCaseActorXUseCase
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.UseCaseActorXUseCase, "UseCaseActorXUseCase");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/UseCaseActorXUseCase/Default.aspx");
		}
	}
}