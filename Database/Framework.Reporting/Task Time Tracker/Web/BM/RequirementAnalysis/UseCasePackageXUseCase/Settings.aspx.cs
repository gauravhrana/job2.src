...
namespace ApplicationContainer.UI.Web.UseCasePackageXUseCase
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.UseCasePackageXUseCase, "UseCasePackageXUseCase");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/UseCasePackageXUseCase/Default.aspx");
		}
	}
}