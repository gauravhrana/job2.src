<%@ Page Title="Clone" Language="C#" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="ApplicationContainer.UI.Web.Productivity.ProductivityAreaFeature.Delete" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            ProductivityAreaFeature Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
