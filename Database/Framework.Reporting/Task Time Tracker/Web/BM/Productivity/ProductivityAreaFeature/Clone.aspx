<%@ Page Title="Clone" Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true"
    CodeBehind="Clone.aspx.cs" Inherits="ApplicationContainer.UI.Web.Productivity.ProductivityAreaFeature.Clone" %>
...
<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
    ...
    <asp:Content ID="cloneContent" runat="server" ContentPlaceHolderID="MainContent">
        <br /><br />
        <asp:Label ID="Label1" Text="Please enter the ProductivityAreaFeatureId" runat="server" />
