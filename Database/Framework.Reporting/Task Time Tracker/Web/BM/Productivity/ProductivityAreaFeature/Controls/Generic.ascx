<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.Productivity.ProductivityAreaFeature.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblProductivityAreaFeatureId" Text="ProductivityAreaFeature Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtProductivityAreaFeatureId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtProductivityAreaFeatureId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynProductivityAreaFeatureId" runat="server" />
        </div>
    </div>
