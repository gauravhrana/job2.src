<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.Master" Language="C#" AutoEventWireup="true"
    CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.Productivity.ProductivityArea.Details"
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class='row'>
        <div class='col-sm-12'>
            <dc:DetailsControl ID='oDetailsControl' EntityName='ProductivityArea' runat='server' />
        </div>
    </div>
