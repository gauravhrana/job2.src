<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.Productivity.ProductivityArea.Controls.Generic" %>
...
<div class="form-horizontal"> 
    ...
    <div class="form-group">
        <asp:Label ID="lblProductivityAreaId" Text="ProductivityArea Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtProductivityAreaId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtProductivityAreaId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynProductivityAreaId" runat="server" />
        </div>
    </div>
