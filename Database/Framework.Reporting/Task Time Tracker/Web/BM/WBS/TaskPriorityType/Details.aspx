<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.WBS.TaskPriorityType.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        <tr>
         ...
         <tr>
            <td>
                <dc:DetailsControl ID="oDetailsControl" EntityName="TaskPriorityType" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
