<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.WBS.TaskPriorityType.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblTaskPriorityTypeId" Text="TaskPriorityType Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtTaskPriorityTypeId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtTaskPriorityTypeId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="<%=txtWeight.ClientID%>">Weight:</label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtWeight" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynWeight" runat="server" />
        </div>
    </div>
