<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.WBS.TaskPriorityType.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblTaskPriorityTypeIdText" runat="server" >TaskPriorityTypeId :</asp:Label>
            </td>
            <td>
                <asp:Label ID="lblTaskPriorityTypeId" runat="server"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblWeightText" runat="server">Weight :</asp:Label>
            </td>
            <td>
