...
namespace ApplicationContainer.UI.Web.WBS.TaskPriorityType
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.TaskPriorityType, "DBColumns", SessionVariables.RequestProfile);
		}
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("TaskPriorityType", "", "TaskPriorityTypeId", false, GetData, GetColumns, false);
