<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.WBS.ActivityState.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblActivityStateId" Text="ActivityState Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtActivityStateId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtActivityStateId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynActivityStateId" runat="server" />
        </div> 
    </div>
