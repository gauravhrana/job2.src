...
namespace ApplicationContainer.UI.Web.WBS.ActivityState
{
    public partial class Export : BasePage
    {
        ...
        {
			return FieldConfigurationUtility.GetEntityColumns(SystemEntity.ActivityState, "DBColumns", SessionVariables.RequestProfile);
        }
        ...
        {
            oList.Setup("ActivityState", " ", "ActivityStateId", false, GetData, GetColumns, false);
