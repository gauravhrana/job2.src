...
namespace ApplicationContainer.UI.Web.TaskPackageXOwnerXTask
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.TaskPackageXOwnerXTask, "TaskPackageXOwnerXTask");
		}
		...
		{
			Response.Redirect("~/TaskPackageXOwnerXTask/Default.aspx");
		}
	}
}