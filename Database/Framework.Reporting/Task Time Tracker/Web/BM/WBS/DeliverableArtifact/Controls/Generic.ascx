<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.DeliverableArtifact.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblDeliverableArtifactId" Text="DeliverableArtifact Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtDeliverableArtifactId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtDeliverableArtifactId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynDeliverableArtifactId" runat="server" />
        </div> 
    </div>
