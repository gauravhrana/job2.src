<%@ Page Title="Details" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.DeliverableArtifactStatus.Details" %>
...
<!--    <a href="Default.aspx">DeliverableArtifactStatus</a> : Details-->
</asp:Content>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            DeliverableArtifactStatus Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
