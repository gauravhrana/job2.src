<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.DeliverableArtifactStatus.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblDeliverableArtifactStatusId" Text="DeliverableArtifactStatus Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtDeliverableArtifactStatusId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtDeliverableArtifactStatusId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
