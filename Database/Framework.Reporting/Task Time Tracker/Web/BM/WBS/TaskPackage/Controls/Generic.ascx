<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.WBS.TaskPackage.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblTaskPackageId" Text="TaskPackage Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtTaskPackageId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtTaskPackageId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
