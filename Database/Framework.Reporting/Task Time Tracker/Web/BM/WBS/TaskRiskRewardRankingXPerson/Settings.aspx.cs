...
namespace ApplicationContainer.UI.Web.WBS.TaskRiskRewardRankingXPerson
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.TaskRiskRewardRankingXPerson, "TaskRiskRewardRankingXPerson");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/TaskRiskRewardRankingXPerson/Default.aspx");
		}
	}
}