...
Inherits="ApplicationContainer.UI.Web.WBS.TaskRiskRewardRankingXPerson.Export" %>
...
<asp:Content ID="exportHeading" ContentPlaceHolderID="SectionName" runat="server">
    <asp:Label Text="TaskRiskRewardRankingXPersonSearch" runat="server" ForeColor="Red" />
</asp:Content> 
