...
AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.TaskXDeliverableArtifact.Details" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
    <!--<a href="Default.aspx">TaskXDeliverableArtifact</a> : Details -->
</asp:Content>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            TaskXDeliverableArtifact Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
