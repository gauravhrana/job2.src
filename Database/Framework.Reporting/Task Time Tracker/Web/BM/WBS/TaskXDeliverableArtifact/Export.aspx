<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Export.aspx.cs" Inherits="ApplicationContainer.UI.Web.TaskXDeliverableArtifact.Export" %>
...
<asp:Content ID="exportHeading" ContentPlaceHolderID="SectionName" runat="server">
    <asp:Label Text="TaskXDeliverableArtifactSearch" runat="server" ForeColor="Red" />
</asp:Content> 
