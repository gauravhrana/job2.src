...
namespace ApplicationContainer.UI.Web.TaskXDeliverableArtifact
{
    public partial class Export : BasePage
    {
        ...
        {
			var validColumns = FieldConfigurationUtility.GetEntityColumns(SystemEntity.TaskXDeliverableArtifact, "DBColumns", SessionVariables.RequestProfile);
            return validColumns;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("TaskXDeliverableArtifact", " ", "TaskXDeliverableArtifactId", false, GetData, GetColumns, false);
