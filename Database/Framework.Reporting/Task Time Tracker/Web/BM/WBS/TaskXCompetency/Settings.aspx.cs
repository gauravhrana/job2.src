...
namespace ApplicationContainer.UI.Web.WBS.TaskXCompetency
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.TaskXCompetency, "TaskXCompetency");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/TaskXCompetency/Default.aspx");
		}
	}
}