...
namespace ApplicationContainer.UI.Web.WBS.TaskType
{
    public partial class Default : Framework.UI.Web.BaseClasses.PageDefault
    {
        ...
        {
            var dt = TaskTimeTracker.Components.BusinessLayer.Task.TaskTypeDataManager.Search(oSearchFilter.SearchParameters, SessionVariables.RequestProfile);
            return dt;
        }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            PrimaryEntityIdColumn = "TaskTypeId";
