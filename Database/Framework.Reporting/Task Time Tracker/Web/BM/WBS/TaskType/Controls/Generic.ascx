<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.WBS.TaskType.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblTaskTypeId" Text="TaskType Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtTaskTypeId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtTaskTypeId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
