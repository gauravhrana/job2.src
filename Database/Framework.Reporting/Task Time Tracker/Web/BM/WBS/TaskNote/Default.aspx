<%@ Page 
	...
	Inherits="ApplicationContainer.UI.Web.TaskNote.Default" 
%>
...
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">TaskNote</asp:Content>
