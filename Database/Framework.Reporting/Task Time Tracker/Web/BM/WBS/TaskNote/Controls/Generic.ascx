<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.TaskNote.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblTaskNoteId" Text="TaskNote Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtTaskNoteId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtTaskNoteId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynTaskNoteId" runat="server" />
        </div> 
    </div>
