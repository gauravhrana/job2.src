<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.WBS.TaskAlgorithm.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblTaskAlgorithmId" Text="TaskAlgorithm Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtTaskAlgorithmId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtTaskAlgorithmId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
