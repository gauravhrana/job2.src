...
Inherits="ApplicationContainer.UI.Web.WBS.TaskPriorityXApplicationUser.Export" %>
...
<asp:Content ID="exportHeading" ContentPlaceHolderID="SectionName" runat="server">
    <asp:Label ID="Label1" Text="TaskPriorityXApplicationUserSearch" runat="server" ForeColor="Red" />
</asp:Content> 
