<%@ Page Title="Default" Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="ApplicationContainer.UI.Web.WBS.TaskPriorityXApplicationUser.Default" %>
...
<asp:Content ID="VisibilityManager" runat="server" ContentPlaceHolderID="ControlVisibilityManager">
