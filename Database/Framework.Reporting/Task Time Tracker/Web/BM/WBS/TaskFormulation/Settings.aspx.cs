...
namespace ApplicationContainer.UI.Web.WBS.TaskFormulation
{
	public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
	{
		...
		{
			eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.TaskFormulation, "TaskFormulation");
		}
		...
		{
			Response.Redirect("~/Shared/Configuration/TaskFormulation/Default.aspx");
		}
	}
}