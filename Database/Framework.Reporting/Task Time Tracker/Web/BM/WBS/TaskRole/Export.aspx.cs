...
namespace ApplicationContainer.UI.Web.TaskRole
{
    public partial class Export : Shared.UI.WebFramework.BasePage
    {
        ...
        {
            return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.TaskRole, "DBColumns", SessionVariables.RequestProfile);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                oList.Setup("TaskRole", " ", "TaskRoleId", false, GetData, GetColumns, false);
