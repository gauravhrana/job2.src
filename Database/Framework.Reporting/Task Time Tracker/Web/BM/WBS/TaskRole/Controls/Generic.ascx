<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.TaskRole.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblTaskRoleId" Text="TaskRole Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtTaskRoleId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtTaskRoleId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynTaskRoleId" runat="server" />
        </div>
    </div> 
