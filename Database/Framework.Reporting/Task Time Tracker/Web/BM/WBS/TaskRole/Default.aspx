<%@ Page 
	...
	Inherits="ApplicationContainer.UI.Web.WBS.TaskRole.Default" 
%>
...
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">TaskRole</asp:Content>
