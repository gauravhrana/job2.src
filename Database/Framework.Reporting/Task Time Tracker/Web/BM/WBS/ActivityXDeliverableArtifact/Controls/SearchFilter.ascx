<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchFilter.ascx.cs" Inherits="ApplicationContainer.UI.Web.ActivityXDeliverableArtifact.Controls.SearchFilter" %>
