<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false" Language="C#"
 AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.ActivityXDeliverableArtifact.Details" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
    <!--<a href="Default.aspx">ActivityXDeliverableArtifact</a> : Details -->
</asp:Content>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            ActivityXDeliverableArtifact Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
