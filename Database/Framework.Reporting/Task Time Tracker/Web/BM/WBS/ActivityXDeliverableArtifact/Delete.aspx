...
CodeBehind="Delete.aspx.cs" Inherits="ApplicationContainer.UI.Web.ActivityXDeliverableArtifact.Delete" %>
<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="./Controls/Details.ascx" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
    <!--<a href="Default.aspx">ActivityXDeliverableArtifact</a> : Delete-->
</asp:Content>
