...
namespace ApplicationContainer.UI.Web.WBS.TaskStatusType
{
    public partial class Default : Framework.UI.Web.BaseClasses.PageDefault
    {
        ...
        {
            var dt = TaskTimeTracker.Components.BusinessLayer.Task.TaskStatusTypeDataManager.Search(oSearchFilter.SearchParameters, SessionVariables.RequestProfile);
            return dt;
        }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            PrimaryEntityIdColumn = "TaskStatusTypeId";
