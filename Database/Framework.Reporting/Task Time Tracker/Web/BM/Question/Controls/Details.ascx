<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="ApplicationContainer.UI.Web.Question.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
               <asp:Label ID="lblQuestionIdText" runat="server" >QuestionId :</asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td class="ralabel">
                 <asp:Label ID="lblQuestionText" runat="server" >Question :</asp:Label>
            </td>
            <td>
