<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="ApplicationContainer.UI.Web.QuestionCategory.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblQuestionCategoryId" Text="QuestionCategory Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtQuestionCategoryId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtQuestionCategoryId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynQuestionCategoryId" runat="server" />
        </div>
    </div> 
