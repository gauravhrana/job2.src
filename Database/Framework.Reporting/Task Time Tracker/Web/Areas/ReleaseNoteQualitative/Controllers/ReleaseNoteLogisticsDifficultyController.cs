...
{
    public class ReleaseNoteLogisticsDifficultyController : Controller
    {

		string settingCategory = "ReleaseNoteLogisticsDifficultyIndexView";
        ...
        private List<string> GetKendoColumnSetByFCMode(int fcModeId)
        {
            ...
            var systemEntityTypeId = (int)SystemEntity.ReleaseNoteLogisticsDifficulty;            
		...
		private string GetAllKendoColumns()
		{
			...
			str.AppendLine("        {");
			str.AppendLine("            title: \" \", field: 'ReleaseNoteLogisticsDifficultyId',");
			str.AppendLine("            filterable: false, sortable: false, width:30,");
			str.AppendLine("            headerTemplate: \"<input type='checkbox' id='checkAll'/>\",");
			str.AppendLine("            template: \"<input onclick='CheckWithHeader();' class='check-box' id='chkBox${ReleaseNoteLogisticsDifficultyId}' type='checkbox' value='${ReleaseNoteLogisticsDifficultyId}' /> \"");
			str.AppendLine("        },");
			...
			// Add Button Columns
			str.AppendLine("        {");
			str.AppendLine("            title: \" \", width: 140, field: 'ReleaseNoteLogisticsDifficultyId',");
			str.AppendLine("            filterable: false,");
			str.AppendLine("            template: \"<a href='/ReleaseNoteQualitative/ReleaseNoteLogisticsDifficulty/Details/${ReleaseNoteLogisticsDifficultyId}'>Details</a>\"");
			str.AppendLine("        },");
			str.AppendLine("        {");
			str.AppendLine("            title: \" \", width: 140, field: 'ReleaseNoteLogisticsDifficultyId',");
			str.AppendLine("            filterable: false,");
			str.AppendLine("            template: \"<a href='/ReleaseNoteQualitative/ReleaseNoteLogisticsDifficulty/Edit/${ReleaseNoteLogisticsDifficultyId}'>Edit</a>\"");
			str.AppendLine("        },");
			str.AppendLine("        {");
			str.AppendLine("            title: \" \", width: 140, field: 'ReleaseNoteLogisticsDifficultyId',");
			str.AppendLine("            filterable: false,");
			str.AppendLine("            template: \"<a href='/ReleaseNoteQualitative/ReleaseNoteLogisticsDifficulty/Delete/${ReleaseNoteLogisticsDifficultyId}'>Delete</a>\"");
			str.AppendLine("        }");
			str.AppendLine("    ]");
        ...
        private string GetKendoGridConfiguration(string searchString, int fcModeId)
        {
            ...
            str.AppendLine("            read: \"/ReleaseNoteQualitative/ReleaseNoteLogisticsDifficulty/IndexResult?searchString=" + searchString + "\"");
            str.AppendLine("        },");
			str.AppendLine("        schema: {");
			str.AppendLine("            model: {");
			str.AppendLine("                    fields: {");
			str.AppendLine("                        ReleaseNoteLogisticsDifficultyId: { type: \"number\" },");
        ...
        public ReleaseNoteLogisticsDifficultyDataModel GetById(int id)
        {
            var obj = new ReleaseNoteLogisticsDifficultyDataModel();
            obj.ReleaseNoteLogisticsDifficultyId = id;
            var list = ReleaseNoteLogisticsDifficultyDataManager.GetEntityDetails(obj, SessionVariables.RequestProfile);
        ...
        public JsonResult IndexResult(string name, int? page, int? pageSize)
        {
            var obj = new ReleaseNoteLogisticsDifficultyDataModel();
			obj.Name = name;
			var list = ReleaseNoteLogisticsDifficultyDataManager.GetEntitySearch(obj, SessionVariables.RequestProfile);			
        ...
        public JavaScriptResult IndexGridConfiguration(string searchString, int? page, int? pageSize)
        {
            ...
            str.AppendLine("    dataSource: {");
            str.AppendLine("        transport: {");
            str.AppendLine("            read: \"/ReleaseNoteQualitative/ReleaseNoteLogisticsDifficulty/IndexResult\"");
            str.AppendLine("        },");
            str.AppendLine("        schema: {");
            str.AppendLine("            model: {");
            str.AppendLine("                    fields: {");
		...
		public JsonResult GetSearchFilterColumns()
		{
			...
			data.SystemEntityTypeId = SystemEntity.ReleaseNoteLogisticsDifficulty.Value();
        ...
        // GET: /ReleaseNoteLogisticsDifficulty/
        public ActionResult Index(string searchString, int? page, int? pageSize)
        {
			var dtFCModes = FieldConfigurationUtility.GetApplicableModesList(SystemEntity.ReleaseNoteLogisticsDifficulty);
        ...
        //
        // GET: /ReleaseNoteLogisticsDifficulty/Details/5
        public ActionResult Details(int id, bool? isMultiple)
		{
			var lstItems = new List<ReleaseNoteLogisticsDifficultyDataModel>();
			if (isMultiple != null && isMultiple.Value)
			{
				var lstEntityKeys = ApplicationCommon.GetSuperKeyDetails(SystemEntity.ReleaseNoteLogisticsDifficulty.Value(), id.ToString());
        ...
        //
        // GET: /ReleaseNoteLogisticsDifficulty/Create
        ...
        //
        // POST: /ReleaseNoteLogisticsDifficulty/Create
        [HttpPost]
        public ActionResult Create(ReleaseNoteLogisticsDifficultyDataModel obj)
        {
            if (ModelState.IsValid)
            {
                ReleaseNoteLogisticsDifficultyDataManager.Create(obj, SessionVariables.RequestProfile);
        ...
        //
        // GET: /ReleaseNoteLogisticsDifficulty/Edit/5
        ...
        //
        // POST: /ReleaseNoteLogisticsDifficulty/Edit

        [HttpPost]
        public ActionResult Edit(List<ReleaseNoteLogisticsDifficultyDataModel> items)
        {
            if (ModelState.IsValid)
            {
				foreach (var item in items)
				{
					ReleaseNoteLogisticsDifficultyDataManager.Update(item, SessionVariables.RequestProfile);
				}
                return RedirectToAction("Index");
            }
        ...
        //
        // GET: /ReleaseNoteLogisticsDifficulty/Delete/5
        ...
        //
        // POST: /ReleaseNoteLogisticsDifficulty/Delete
        [HttpPost]
        public ActionResult Delete(List<ReleaseNoteLogisticsDifficultyDataModel> items)
        {
            if (ModelState.IsValid)
            {
				foreach (var item in items)
				{
					ReleaseNoteLogisticsDifficultyDataManager.Delete(item, SessionVariables.RequestProfile);
				}
                return RedirectToAction("Index");
			}
