...
namespace TaskTimeTracker.UI.Web.Areas.ReleaseNoteQualitative.Controllers
{
    public class DBNameController : Controller
    {
        ...
        public DBNameDataModel GetById(int id)
        {
            ...
            obj.DBNameId = id;
            var list = DBNameDataManager.GetEntityDetails(obj, SessionVariables.AuditId);
        ...
        public ActionResult Index(string searchString, int? page, int? pageSize)
        {
            ...
            var list = DBNameDataManager.GetEntitySearch(obj, SessionVariables.AuditId);
        ...
        public ActionResult Create(DBNameDataModel obj)
        {
            ...
            {
                DBNameDataManager.Create(obj, SessionVariables.AuditId);
        ...
        public ActionResult Edit(DBNameDataModel obj)
        {
            if (ModelState.IsValid)
            {
                DBNameDataManager.Update(obj, SessionVariables.AuditId);
                return RedirectToAction("Index");
            }
        ...
        public ActionResult Delete(DBNameDataModel obj)
        {
            if (ModelState.IsValid)
            {
                DBNameDataManager.Delete(obj, SessionVariables.AuditId);
                return RedirectToAction("Index");
            }
