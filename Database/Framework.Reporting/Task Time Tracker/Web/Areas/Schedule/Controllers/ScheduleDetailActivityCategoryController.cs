...
namespace ApplicationContainer.UI.Web.Areas.Schedule.Controllers
{
	public class ScheduleDetailActivityCategoryController : Controller
	{
		...
		public ScheduleDetailActivityCategoryDataModel GetById(int id)
		{
			...
			var list = ScheduleDetailActivityCategoryDataManager.GetEntityDetails(obj, SessionVariables.RequestProfile);
		...
		public JavaScriptResult IndexGridConfiguration(string searchString, int? page, int? pageSize)
		{
			...
			str.AppendLine("    dataSource: {");
			str.AppendLine("        transport: {");
			str.AppendLine("            read: \"/AreaSchedule/ScheduleDetailActivityCategory/IndexResult\"");
			str.AppendLine("        },");
			str.AppendLine("        schema: {");
			str.AppendLine("            model: {");
			str.AppendLine("                    fields: {");
		...
		// GET: /ScheduleDetailActivityCategory/
		public ActionResult Index(string searchString, int? page, int? pageSize)
		{

			var dtFCModes = FieldConfigurationUtility.GetApplicableModesList(SystemEntity.ScheduleDetailActivityCategory);
		...
		//
		// GET: /ScheduleDetailActivityCategory/Details/5
		...
		//
		// GET: /ScheduleDetailActivityCategory/Create
		...
		//
		// POST: /ScheduleDetailActivityCategory/Create
		[HttpPost]
		public ActionResult Create(ScheduleDetailActivityCategoryDataModel obj)
		{
			if (ModelState.IsValid)
			{
				ScheduleDetailActivityCategoryDataManager.Create(obj, SessionVariables.RequestProfile);
		...
		//
		// POST: /ScheduleDetailActivityCategory/Edit
		...
		public ActionResult Edit(List<ScheduleDetailActivityCategoryDataModel> items)
		{
			if (ModelState.IsValid)
			{
				...
				{
					ScheduleDetailActivityCategoryDataManager.Update(item, SessionVariables.RequestProfile);
				}
				return RedirectToAction("Index");
			}
		...
		//
		// GET: /ScheduleDetailActivityCategory/Delete/5
		...
		//
		// POST: /ScheduleDetailActivityCategory/Delete
		[HttpPost]
		public ActionResult Delete(List<ScheduleDetailActivityCategoryDataModel> items)
		{
			if (ModelState.IsValid)
			{
				foreach (var item in items)
				{
					ScheduleDetailActivityCategoryDataManager.Delete(item, SessionVariables.RequestProfile);
				}
				return RedirectToAction("Index");
			}
