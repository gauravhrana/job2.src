...
namespace Shared.UI.Web.Admin.Controls
{
    public partial class LoginSettings : Shared.UI.WebFramework.BaseControl
    {
        ...
        private void SetIsTesting()
        {
            ...
            PerferenceUtility.UpdateUserPreference("General", ApplicationCommon.UserApplicationModeId, drpIsTesting.SelectedValue);
        }
        ...
        protected override void OnInit(EventArgs e)
        {
            try
            {
                ...
                drpDateFormat.SelectedValue         = PerferenceUtility.GetUserPreferenceByKey(ApplicationCommon.UserDateFormat);
                drpTimeFormat.SelectedValue         = PerferenceUtility.GetUserPreferenceByKey(ApplicationCommon.UserTimeFormat);
                txtAuditId.Text                     = SessionVariables.RequestProfile.AuditId.ToString();

                txtActiveClient.Text                = PerferenceUtility.GetUserPreferenceByKey(ApplicationCommon.UserActiveClient);
                txtActiveProject.Text               = PerferenceUtility.GetUserPreferenceByKey(ApplicationCommon.UserActiveProject);
                txtActiveNeed.Text                  = PerferenceUtility.GetUserPreferenceByKey(ApplicationCommon.UserActiveNeed);
                txtActiveTask.Text                  = PerferenceUtility.GetUserPreferenceByKey(ApplicationCommon.UserActiveTask);
				txtDefaultRowCount.Text             = PerferenceUtility.GetUserPreferenceByKey(ApplicationCommon.DefaultRowCountKey);
        ...
        protected void btnSubmit_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt != null & dt.Rows.Count == 1)
                {
                    ...
                    PerferenceUtility.UpdateUserPreference("General", ApplicationCommon.UserDateFormat, drpDateFormat.SelectedValue);
                    PerferenceUtility.UpdateUserPreference("General", ApplicationCommon.UserTimeFormat, drpTimeFormat.SelectedValue);
					SessionVariables.UserDateFormat = drpDateFormat.SelectedValue;
                    SessionVariables.UserTimeFormat = drpTimeFormat.SelectedValue;

                    PerferenceUtility.UpdateUserPreference("General", ApplicationCommon.UserActiveClient, string.IsNullOrEmpty(txtActiveClient.Text.Trim()) ? " " : txtActiveClient.Text.Trim());
                    PerferenceUtility.UpdateUserPreference("General", ApplicationCommon.UserActiveProject, string.IsNullOrEmpty(txtActiveProject.Text.Trim()) ? " " : txtActiveProject.Text.Trim());
                    PerferenceUtility.UpdateUserPreference("General", ApplicationCommon.UserActiveNeed, string.IsNullOrEmpty(txtActiveNeed.Text.Trim()) ? " " : txtActiveNeed.Text.Trim());
                    PerferenceUtility.UpdateUserPreference("General", ApplicationCommon.UserActiveTask, string.IsNullOrEmpty(txtActiveTask.Text.Trim()) ? " " : txtActiveTask.Text.Trim());
					PerferenceUtility.UpdateUserPreference("General", ApplicationCommon.DefaultRowCountKey, string.IsNullOrEmpty(txtDefaultRowCount.Text.Trim()) ? "" : txtDefaultRowCount.Text.Trim());
