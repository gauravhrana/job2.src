<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" CodeBehind="Update.aspx.cs"
    Inherits="Shared.UI.Web.Admin.ConnectionString.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/Admin/ConnectionString/Controls/Generic.ascx" %>
