<%@ Page Language="C#" MasterPageFile="~/MasterPages/Site.master" AutoEventWireup="true" CodeBehind="Details.aspx.cs"
    EnableEventValidation="false" Inherits="Shared.UI.Web.Admin.ConnectionString.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        ...
        <tr>
            <td>
                <dc:DetailsControl ID="oDetailsControl" Name="ConnectionString" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
