<%@ Page Title="Trace - Update" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Update.aspx.cs" Inherits="Shared.UI.Web.Admin.Trace.Update" EnableEventValidation="false" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/Admin/Trace/Controls/Generic.ascx" %>
