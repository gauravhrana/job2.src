<%@ Page Title="Clone" EnableEventValidation="false" Language="C#" MasterPageFile="~/MasterPages/Site.master"
    AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="Shared.UI.Web.FileType.Delete" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/Admin/FileType/Controls/Details.ascx" %>
