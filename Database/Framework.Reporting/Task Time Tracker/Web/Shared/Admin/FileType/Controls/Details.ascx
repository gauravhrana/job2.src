<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.FileType.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        <tr>
         ...
         <tr>
            <td class="ralabel">
                <asp:Label ID="lblFileTypeIdText" runat="server" >FileTypeId :</asp:Label>
            </td>
            <td>
                <asp:Label ID="lblFileTypeId" runat="server"></asp:Label>
            </td>
            <td>
