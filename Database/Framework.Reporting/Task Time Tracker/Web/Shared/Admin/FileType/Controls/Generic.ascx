<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.FileType.Controls.Generic" %>
        ...
        <tr>
            <td>
                <table width="95%"  >
                    <tr>
                        <td class="ralabel">
                            <asp:Label ID="lblFileTypeId" Text="FileTypeId:" runat="server"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtFileTypeId" runat="server"></asp:TextBox>
                        </td>
                        <td>
