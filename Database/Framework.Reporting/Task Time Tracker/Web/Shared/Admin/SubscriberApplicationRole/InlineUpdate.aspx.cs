	...
	public partial class InlineUpdate : PageInlineUpdate
	{
        ...
        protected override DataTable GetData()
        {
            try
            {
                ...
                selectedrows = Framework.Components.Core.SubscriberApplicationRoleDataManager.GetDetails(SubscriberApplicationRoledata, SessionVariables.RequestProfile).Clone();
