<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Admin.SubscriberApplicationRole.Controls.Generic" %>
        ...
        <tr>
            <td>
                <table   >
                    <tr>
                        <td class="ralabel">
                            <asp:Label ID="lblSubscriberApplicationRoleId" Text="SubscriberApplicationRoleId:"
                                runat="server"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSubscriberApplicationRoleId" runat="server"></asp:TextBox>
                        </td>
                        <td>
