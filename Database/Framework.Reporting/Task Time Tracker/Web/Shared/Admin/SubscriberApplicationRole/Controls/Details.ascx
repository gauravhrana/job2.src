<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.Admin.SubscriberApplicationRole.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        ...
        <tr>
            <td class="ralabel">
                <asp:Label ID="lblSubscriberApplicationRoleIdText" runat="server"><span>SubscriberApplicationRoleId: </span></asp:Label>
            </td>
            <td>
                <asp:Label ID="lblSubscriberApplicationRoleId" runat="server"></asp:Label>
            </td>
            <td>
