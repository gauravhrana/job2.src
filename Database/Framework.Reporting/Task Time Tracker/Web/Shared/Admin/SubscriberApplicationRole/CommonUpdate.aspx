<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" CodeBehind="CommonUpdate.aspx.cs" Inherits="Shared.UI.Web.Admin.SubscriberApplicationRole.CommonUpdate" %>
    ...
    <table >
        ...
        <tr><td>
            <asp:GridView ID="MainGridView" PageSize="100" Width="1000px"   AllowPaging="true" AllowSorting="true"
                AutoGenerateColumns="true" runat="server" cellpadding="5" ShowFooter="true">
