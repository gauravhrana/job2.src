<%@ Page Title="Clone" EnableEventValidation="false" Language="C#" MasterPageFile="~/MasterPages/Site.master"
    AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="Shared.UI.Web.BatchFileStatus.Delete" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/Admin/BatchFileStatus/Controls/Details.ascx" %>
