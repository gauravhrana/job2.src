<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" EnableEventValidation="false"
    MasterPageFile="~/MasterPages/Site.master" Inherits="Shared.UI.Web.Admin.ApplicationRelation.Update" %>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/Admin/ApplicationRelation/Controls/Generic.ascx" %>
