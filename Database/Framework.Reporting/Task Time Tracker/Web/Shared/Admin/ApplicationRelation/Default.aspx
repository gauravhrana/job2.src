<%@ Page Title="ApplicationRelation - List" Language="C#" MasterPageFile="~/MasterPages/Default.master"
    AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Shared.UI.Web.Admin.ApplicationRelation.Default" %>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Shared/Admin/ApplicationRelation/Controls/SearchFilter.ascx" %>
