...
namespace Shared.UI.Web.Admin.TypeOfIssue
{
	public partial class Default : Framework.UI.Web.BaseClasses.PageDefault
	{
		...
		{
			var dt = Framework.Components.Audit.TypeOfIssueDataManager.Search(oSearchFilter.SearchParameters, SessionVariables.RequestProfile);
			return dt;
		}
		...
		protected override void OnInit(EventArgs e)
		{
			...
			PrimaryEntityIdColumn = "TypeOfIssueId";
