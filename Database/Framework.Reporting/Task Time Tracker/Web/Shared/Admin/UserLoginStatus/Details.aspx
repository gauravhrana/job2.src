<%@ Page Title="UserLoginStatus - Details" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.Admin.UserLoginStatus.Details"
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        ...
        <tr>
            <td>
                 <dc:DetailsControl ID="oDetailsControl" EntityName="UserLoginStatus" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
