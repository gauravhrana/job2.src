<%@ Page Title="UserLoginStatus - Update" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Update.aspx.cs" Inherits="Shared.UI.Web.Admin.UserLoginStatus.Update" EnableEventValidation="false" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/Admin/UserLoginStatus/Controls/Generic.ascx" %>
