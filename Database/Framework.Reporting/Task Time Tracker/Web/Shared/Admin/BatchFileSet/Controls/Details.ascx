<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.BatchFileSet.Controls.Details" %>
...
<div id="borderdiv" runat="server">
    <table  >
        <tr>
         ...
         <tr>
            <td class="ralabel">
                <asp:Label ID="lblBatchFileSetIdText" runat="server" >BatchFileSetId :</asp:Label>
            </td>
            <td>
                <asp:Label ID="lblBatchFileSetId" runat="server"></asp:Label>
            </td>
            <td>
