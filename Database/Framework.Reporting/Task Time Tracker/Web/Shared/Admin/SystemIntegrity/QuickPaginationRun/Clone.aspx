<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Clone.aspx.cs" MasterPageFile="~/MasterPages/Site.master" Inherits="Shared.UI.Web.SystemIntegrity.QuickPaginationRun.Clone" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
    ...
    <asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        <br /><br />
        <asp:Label Text="Please enter the QuickPaginationRunId" runat="server"/>
