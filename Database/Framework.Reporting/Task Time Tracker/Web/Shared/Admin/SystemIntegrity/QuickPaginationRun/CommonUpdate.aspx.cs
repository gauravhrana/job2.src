...
namespace Shared.UI.Web.SystemIntegrity.QuickPaginationRun
{
	public partial class CommonUpdate : PageCommonUpdate
	{
		...
		protected override DataTable UpdateData()
		{
			...
			UpdatedData = QuickPaginationRunDatatManager.Search(data, SessionVariables.RequestProfile).Clone();
			...
			for (var i = 0; i < SelectedData.Rows.Count; i++)
			{
				...
				var dt = QuickPaginationRunDatatManager.Search(data, SessionVariables.RequestProfile);
