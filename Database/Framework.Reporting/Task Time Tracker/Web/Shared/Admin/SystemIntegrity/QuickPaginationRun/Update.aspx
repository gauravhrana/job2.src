<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" EnableEventValidation="false"
    MasterPageFile="~/MasterPages/Site.master" Inherits="Shared.UI.Web.SystemIntegrity.QuickPaginationRun.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/Admin/SystemIntegrity/QuickPaginationRun/Controls/Generic.ascx" %>
