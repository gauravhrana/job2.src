<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.SystemIntegrity.SearchKey.Controls.Generic" %>
            ...
            <td>
                <table   >
                    <tr>
                        <td class="ralabel">
                            <b>
                                <asp:Label ID="lblSearchKeyId" runat="server" Text="SearchKeyId:"></asp:Label></b>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:PlaceHolder ID="dynView" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="ralabel">
