<%@ Page Language="C#" Title="Update" AutoEventWireup="true" CodeBehind="Update.aspx.cs" 
MasterPageFile="~/MasterPages/Site.master" Inherits="Shared.UI.Web.SystemIntegrity.SearchKeyDetailItem.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/Admin/SystemIntegrity/SearchKeyDetailItem/Controls/Generic.ascx" %>
