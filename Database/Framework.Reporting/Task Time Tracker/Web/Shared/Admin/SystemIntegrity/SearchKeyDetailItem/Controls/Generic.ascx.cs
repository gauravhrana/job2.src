...
namespace Shared.UI.Web.SystemIntegrity.SearchKeyDetailItem.Controls
{
	public partial class Generic : Framework.UI.Web.BaseClasses.ControlGeneric
	{
		...
		public override int? Save(string action)
		{
			...
			if (action == "Insert")
			{
				var dtSearchKeyDetail = Framework.Components.Core.SearchKeyDetailItemDataManager.DoesExist(data, SessionVariables.RequestProfile);

				if (dtSearchKeyDetail.Rows.Count == 0)
				{
