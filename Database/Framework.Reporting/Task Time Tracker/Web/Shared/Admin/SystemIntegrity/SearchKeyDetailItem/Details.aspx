<%@ Page Language="C#" Title="Details" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.SystemIntegrity.SearchKeyDetailItem.Details" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/Admin/SystemIntegrity/SearchKeyDetailItem/Controls/Details.ascx" %>
