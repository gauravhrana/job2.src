<%@ Page Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs"
    Inherits="Shared.UI.Web.Admin.SystemEntityType.Default" EnableEventValidation="false" %>
...
<%@ Register TagName="SearchFilter" TagPrefix="sr" Src="~/Shared/Admin/SystemEntityType/Controls/SearchFilter.ascx" %>
