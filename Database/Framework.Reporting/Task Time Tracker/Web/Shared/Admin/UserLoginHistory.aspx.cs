...
namespace Shared.UI.Web.Configuration
{
	public partial class UserLoginHistory : Framework.UI.Web.BaseClasses.PageBasePage
    {
		...
		protected void btnSearch_Click(object sender, EventArgs e)
		{
			...
			PerferenceUtility.UpdateUserPreference("General", ApplicationCommon.DateRangeFormat, oDateRange.DateRangeFormatId.ToString());
			PerferenceUtility.UpdateUserPreference("General", ApplicationCommon.FromDateRange, oDateRange.FromDate.ToString());
			PerferenceUtility.UpdateUserPreference("General", ApplicationCommon.ToDateRange, oDateRange.ToDate.ToString());
		}
