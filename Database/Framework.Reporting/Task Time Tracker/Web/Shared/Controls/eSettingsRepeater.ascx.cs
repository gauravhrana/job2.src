...
namespace Shared.UI.Web.Controls
{
    public partial class eSettingsRepeater : BaseControl
    {
        ...
        private void UpdateData()
        {
            ...
            eSettings.UpdateGridTableInCache(SystemEntityTypeId, AuditId);
            BindData(ApplicationId);
        ...
        {
            var applicationId = SetupConfiguration.ApplicationId;

            //Get FC columns to determine columns to be displayed in Repeater
            var dtc = eSettings.GetColumns(ApplicationId, AuditId);
