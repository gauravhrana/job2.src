...
namespace Shared.UI.Web.Controls
{
    public partial class SearchActionBar : BaseControl
    {
		...
		public void GenerateSearchStyle()
		{
			if (!SearchDisplay)
			{
				SearchBorderColor		= PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.SearchBorderColor);
				SearchBorderStyle		= PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.SearchBorderStyle);
				SearchBackgroundColor	= PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.SearchBackgroundColor);
				SearchForegroundColor	= PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.SearchForegroundColor);
				SearchFontFamily		= PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.SearchFontFamily);
				SearchFontSize			= PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.SearchFontSize);
			}
        ...
        protected void lnkClose_Click(object sender, EventArgs e)
        {
	        ...
	        PerferenceUtility.UpdateUserPreference(ParentSearchControl.SettingCategory, ApplicationCommon.ControlVisible, "false");
        }
