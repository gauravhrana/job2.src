...
{
    public partial class eSettingsListDynamic : BaseControl
    {
        ...
        public void SetUp(int systemEntityTypeId, string entityName, string entityFolder, int AEFLModeId, int applicationId)
        {
            SystemEntityTypeId = systemEntityTypeId;
            EntityName = entityName;
        ...
        protected void EditableGridView_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            //FieldConfiguration.Update(data, AuditId);
            ...
            else
            {
                foreach (RepeaterItem item in EditableRepeater.Items)
                {
                    ...
                    try
                    {
                        ...
                        {
                            var label = (Label)row.FindControl("lblcolname");
                            ...
                            if (label.Text.Equals(FieldConfigurationDataModel.DataColumns.SystemEntityTypeId))
                                data.SystemEntityTypeId = int.Parse(txtbox.Text);
