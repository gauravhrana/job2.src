    ...
    public partial class DetailsWithChildrenControl : BaseControl
	{
		...
		private void ShowSelectedRecords(StringCollection sc, Command cmd)
		{
			...
			if (sc.Count > 1)
			{
				...
				var sDt = SystemEntityTypeDataManager.Search(sData, SessionVariables.RequestProfile);
				if (sDt.Rows.Count > 0)
				{
		...
		public void ShowData(bool dataHide, bool search, bool isLoadPreferences, string userPreferenceCategory)
		{
			...
			{
				var isButtonPanelEnabled = PerferenceUtility.GetApplicationUserPreferenceByKeyAsBoolean(ApplicationCommon.DetailsButtonPanelVisible, userPreferenceCategory);
				...
				var isDetailsAEFLModeEnabled = PerferenceUtility.GetApplicationUserPreferenceByKeyAsBoolean(ApplicationCommon.DetailsAEFLModeEnabled, userPreferenceCategory);
				if (!isDetailsAEFLModeEnabled)
				{
					AEFLModeContainer.Visible = false;
				}

				var isPaging = PerferenceUtility.GetApplicationUserPreferenceByKeyAsBoolean(ApplicationCommon.DetailsPagingEnabled, userPreferenceCategory);
				if (!isPaging)
				{
		...
		//{
		//	GridView.HeaderStyle.Height = new Unit(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesHeaderStyleHeight));
		//	GridView.HeaderStyle.BackColor = ColorTranslator.FromHtml(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesHeaderBackColor));
		//	GridView.HeaderStyle.ForeColor = ColorTranslator.FromHtml(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesHeaderForeColor));
		//	GridView.HeaderStyle.Font.Size = new FontUnit(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesHeaderStyleFontSize));

		//	for (var x = 0; x < GridView.Rows.Count; x = x + 2)
		//	{
		//		GridView.Rows[x].BackColor = ColorTranslator.FromHtml(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesAlternatingRowStyleBackColor));
		//		GridView.Rows[x].Font.Size = new FontUnit(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesAlternatingRowStyleFontSize));
		//		GridView.Rows[x].Height = new Unit(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesAlternatingRowStyleHeight));
		//	}
		//}
		...
		protected void GridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {				
				...
				//	//if (ViewState["TableName"].ToString() == "ReleaseLogDetail")
				//	//{
				//	//	e.Row.BackColor = System.Drawing.ColorTranslator.FromHtml(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesRowStyleBackColor));						
				//	//	e.Row.Height = new Unit(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesRowStyleHeight));

				//	//	for (var k = 1; k < e.Row.Cells.Count; k++)
				//	//	{
				//	//		if (e.Row.Cells[k].Controls.Count != 0)
				//	//		{
				//	//			((HyperLink)(e.Row.Cells[k].Controls[0])).ForeColor = System.Drawing.ColorTranslator.FromHtml(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesRowStyleForeColor));
				//	//			((HyperLink)(e.Row.Cells[k].Controls[0])).Font.Size = new FontUnit(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesRowStyleFontSize));
				//	//		}
				...
				//				var charCount = Convert.ToInt16(PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.GridDefaultCharacterCount));
