<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs"
    Inherits="Shared.UI.Web.ApplicationManagement.Development.ActivityStream.Controls.Generic" %>
        ...
        <tr>
            <td>
                ...
                <div style="margin-top: 10px; margin-bottom: 10px;" runat="server" id="generalSettings">
                    <div>
                        <table width='100%' cellpadding='0' cellspacing='0' style='padding: 3px; background-color: #F5F5F5; margin-top: 5px; margin-bottom: 5px;'>
                            <tr>
                                <td align='left'>General Settings
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="DetailControlBorder">
                        <table width="95%">
                            <tr>
                                <td class="ralabel" width="300">Title:
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="ralabel">Activity Stream Audit Id:
                                </td>
                                <td>
                ...
                <div style="margin-top: 10px; margin-bottom: 10px;" runat="server" id="cosmeticSettings"
                    ...
                    <div>
                        <table width='100%' cellpadding='0' cellspacing='0' style='padding: 3px; background-color: #F5F5F5; margin-top: 5px; margin-bottom: 5px;'>
                            <tr>
                                <td align='left'>Cosmetic Settings
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table width="95%">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div>
                                        <asp:Panel ID="colorSample" Style="width: 18px; height: 18px; border: 1px solid #000; margin: 0 3px; float: left"
                                            runat="server" />
                                    </div>
                            ...
                            <tr>
                                <td class="ralabel">Activity Stream Page Size:
                                </td>
                                <td>
                ...
                <div style="margin-top: 10px; margin-bottom: 10px;" runat="server" id="otherSettings"
                    ...
                    <div class="DetailControlBorder">
                        <table width="95%">
                            <tr>
                                <td valign="top">Excluded System Entities:
                                </td>
                                <td valign="top">
                                    <table>
                                        <tr>
                                    ...
                                    <table border="1" cellpadding="0" cellspacing="5">
                                        ...
                                        <tr>
                                            <td width="*">
                                                <asp:ListBox runat="server" SelectionMode="Multiple" ID="lstSource" Width="250" Height="250"></asp:ListBox>
                                            </td>
                                            <td width="*">
                                                <asp:ListBox runat="server" SelectionMode="Multiple" ID="lstTarget" Width="250" Height="250"></asp:ListBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center">
