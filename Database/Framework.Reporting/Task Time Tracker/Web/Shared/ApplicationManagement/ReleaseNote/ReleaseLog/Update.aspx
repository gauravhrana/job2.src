<%@ Page Title="ReleaseLog-Update" Language="C#" AutoEventWireup="true" EnableEventValidation="false"
    MasterPageFile="~/MasterPages/Site.master" CodeBehind="Update.aspx.cs" Inherits="Shared.UI.Web.ApplicationManagement.ReleaseLog.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/ApplicationManagement/ReleaseNote/ReleaseLog/Controls/Generic.ascx" %>
