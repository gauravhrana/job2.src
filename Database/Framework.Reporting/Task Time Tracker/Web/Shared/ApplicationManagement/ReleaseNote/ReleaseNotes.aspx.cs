...
namespace Shared.UI.Web.ApplicationManagement.ReleaseLog
{
	public partial class ReleaseNotes : BasePage
	{
			...
			if (addStyle)
			{
				for (var i = 0; i < GrdParentGrid.Items.Count; i++)
				{
					...
					if (list != null)
					{
						...
						string value = PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.ReleaseNotesGridLines);
		...
		protected override void OnInit(EventArgs e)
		{
			...
			DetailUserPreferenceCategoryId              = PerferenceUtility.CreateUserPreferenceCategoryIfNotExists("ReleaseLogDetail", "ReleaseLogDetail");
