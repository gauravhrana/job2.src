...
namespace Shared.UI.Web.ApplicationManagement.ReleaseLogDetail
{
	public partial class CommonUpdate : Framework.UI.Web.BaseClasses.PageCommonUpdate
	{
		...
		protected override DataTable UpdateData()
		{
			...
			UpdatedData = Framework.Components.ReleaseLog.ReleaseLogDetailDataManager.Search(data, SessionVariables.RequestProfile).Clone();
		...
		protected override DataTable GetEntityData(int? entityKey)
		{
			...
			var results = Framework.Components.ReleaseLog.ReleaseLogDetailDataManager.Search(releaseLogDetailData, SessionVariables.RequestProfile);
			return results;
		}
