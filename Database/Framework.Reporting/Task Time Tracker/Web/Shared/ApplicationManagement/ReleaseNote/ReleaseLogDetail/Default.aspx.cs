...
namespace Shared.UI.Web.ApplicationManagement.ReleaseLogDetail
{
    public partial class Default : Framework.UI.Web.BaseClasses.PageDefault
    {
        ...
        {
			var dt = Framework.Components.ReleaseLog.ReleaseLogDetailDataManager.Search(oSearchFilter.SearchParameters, SessionVariables.RequestProfile);
            return dt;
        }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            PrimaryEntityIdColumn   = "ReleaseLogDetailId";
