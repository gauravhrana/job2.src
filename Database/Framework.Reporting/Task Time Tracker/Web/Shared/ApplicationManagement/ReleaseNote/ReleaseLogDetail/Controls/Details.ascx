...
<div id="borderdiv" runat="server">
    ...
    <table class="table table-striped">
        ...
        <tr>
            <td>
                <asp:Label ID="lblFeatureText" runat="server"><span>Application Feature: </span></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lblModuleText" runat="server"><span>Business Module: </span></asp:Label>
            </td>
            <td>
