...
namespace Shared.UI.Web.ApplicationManagement.ReleaseIssueType
{
    public partial class Delete : Framework.UI.Web.BaseClasses.PageDelete
    {
		...
		{
			var dt = Framework.Components.ReleaseLog.ReleaseLogDetailDataManager.GetByReleaseLogIssueType(releaseIssueTypeId, SessionVariables.RequestProfile);
			var releaseLogDetaildt = Framework.Components.ReleaseLog.ReleaseLogDetailDataManager.GetList(SessionVariables.RequestProfile);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            foreach (string index in deleteIndexList)
            {
				...
				Framework.Components.ReleaseLog.ReleaseIssueTypeDataManager.Delete(data, SessionVariables.RequestProfile);
            }
		...
		{
			Framework.Components.Audit.AuditHistoryDataManager.DeleteDataBySystemEntity(DeleteIds, (int)Framework.Components.DataAccess.SystemEntity.ReleaseIssueType, SessionVariables.RequestProfile);
