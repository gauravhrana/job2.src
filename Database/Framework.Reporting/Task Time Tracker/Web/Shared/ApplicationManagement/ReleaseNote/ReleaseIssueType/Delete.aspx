<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" CodeBehind="Delete.aspx.cs"
    Inherits="Shared.UI.Web.ApplicationManagement.ReleaseIssueType.Delete" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/ApplicationManagement/ReleaseNote/ReleaseIssueType/Controls/Details.ascx" %>
