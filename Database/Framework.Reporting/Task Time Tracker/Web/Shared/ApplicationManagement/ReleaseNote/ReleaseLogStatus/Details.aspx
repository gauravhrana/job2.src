<%@ Page Title="Details" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.ApplicationManagement.ReleaseLogStatus.Details" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Shared/ApplicationManagement/ReleaseNote/ReleaseLogStatus/Controls/Details.ascx" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SectionName">
    <a href="Default.aspx">ReleaseLogStatus </a> : Details
</asp:Content>
