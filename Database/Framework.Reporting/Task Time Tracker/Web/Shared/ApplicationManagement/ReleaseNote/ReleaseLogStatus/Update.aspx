<%@ Page Title="Update" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="Shared.UI.Web.ApplicationManagement.ReleaseLogStatus.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Shared/ApplicationManagement/ReleaseNote/ReleaseLogStatus/Controls/Generic.ascx" %>
