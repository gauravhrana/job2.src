<%@ Page 
	...
	Inherits="Shared.UI.Web.ApplicationManagement.ReleasePublishCategory.Default" %>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Shared/ApplicationManagement/ReleaseNote/ReleasePublishCategory/Controls/SearchFilter.ascx" %>
<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageDefaultMaster" %>

<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">ReleasePublishCategory
</asp:Content>
