...
namespace Shared.UI.Web.ApplicationManagement.ReleasePublishCategory
{
    public partial class CommonUpdate : PageCommonUpdate
	{
		...
		protected override DataTable UpdateData()
		{
			...
			UpdatedData = Framework.Components.ReleaseLog.ReleasePublishCategoryDataManager.Search(data, SessionVariables.RequestProfile).Clone();
		...
		protected override DataTable GetEntityData(int? entityKey)
		{
			...
			var results = Framework.Components.ReleaseLog.ReleasePublishCategoryDataManager.Search(releasePublishCategorydata, SessionVariables.RequestProfile);
			return results;
		}
