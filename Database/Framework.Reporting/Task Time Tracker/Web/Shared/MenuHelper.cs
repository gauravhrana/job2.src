...
namespace Shared.UI.Web
{
    public class MenuHelper
    {
        ...
        public static string GetUserPreferedMenuCategory()
        {
            ...
            dt = Framework.Components.Core.MenuCategoryDataManager.GetDetails(data, SessionVariables.RequestProfile);

            userMenuCategoryType = dt.Rows[0][StandardDataModel.StandardDataColumns.Description].ToString();

            return userMenuCategoryType;
        }

        public static DataTable GetMenuCategoryList()
        {
            ...
            var dt2 = dt.Clone();
            dt2.Columns[MenuCategoryDataModel.DataColumns.MenuCategoryId].DataType = System.Type.GetType("System.String");
            ...
            foreach (var str in lst)
            {
                ...
                newRow[StandardDataModel.StandardDataColumns.Name] = "* " + str;
                newRow[MenuCategoryDataModel.DataColumns.MenuCategoryId] = str;
                dt2.Rows.Add(newRow);
            }
        ...
        public static List<MenuDataModel> SetUserPreferenceMenu(List<MenuDataModel> listUPMenu)
        {
            ...
            if (listSiteMenu != null && listSiteMenu.Count > 0)
            {
                ...
                {
                    var isExists = listUPMenu.Where(x => x.MenuId == objMenu.MenuId).Count() > 0;
...
//			MenuColoredCategoryColor = PerferenceUtility.GetApplicationUserPreferenceByKey(ApplicationCommon.MenuColoredCategoryColor);
