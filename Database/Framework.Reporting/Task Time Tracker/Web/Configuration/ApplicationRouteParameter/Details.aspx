<%@ Page Title="ApplicationRouteParameter - Details" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.Configuration.ApplicationRouteParameter.Details"
    EnableEventValidation="false" %>
<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Configuration/ApplicationRouteParameter/Controls/Details.ascx" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            ApplicationRouteParameter Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
