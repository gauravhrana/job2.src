<%@ Page Title="ApplicationRoute - Details" MasterPageFile="~/MasterPages/Site.master" Language="C#" AutoEventWireup="true"
    CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.Configuration.ApplicationRoute.Details"
    EnableEventValidation="false" %>
<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Configuration/ApplicationRoute/Controls/Details.ascx" %>
