<%@ Page Title="Language - List" Language="C#" MasterPageFile="~/MasterPages/Default.master"
    AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Shared.UI.Web.Configuration.Language.Default" %>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Configuration/Language/Controls/SearchFilter.ascx" %>
