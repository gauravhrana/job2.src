...
namespace Shared.UI.Web.Configuration.Language
{
	public partial class Export : Shared.UI.WebFramework.BasePage
	{
		...
		{
			return FieldConfigurationUtility.GetEntityColumns(Framework.Components.DataAccess.SystemEntity.Language, "DBColumns", SessionVariables.RequestProfile);
		}
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				oList.Setup("Language", " ", "LanguageId", false, GetData, GetColumns, false);
