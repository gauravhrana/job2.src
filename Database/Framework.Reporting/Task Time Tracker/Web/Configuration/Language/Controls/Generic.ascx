<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.Language.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblLanguageId" Text="Language Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtLanguageId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtLanguageId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynLanguageId" runat="server" />
        </div>
    </div>
