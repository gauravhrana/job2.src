...
namespace Shared.Configuration.MenuCategory
{
    public partial class CommonUpdate : PageCommonUpdate
    {
        ...
        protected override DataTable UpdateData()	
        {
			...
			UpdatedData = Framework.Components.Core.MenuCategoryDataManager.Search(data, SessionVariables.RequestProfile).Clone();
			for (var i = 0; i < SelectedData.Rows.Count; i++)
			{
				data.MenuCategoryId =
					Convert.ToInt32(SelectedData.Rows[i][MenuCategoryDataModel.DataColumns.MenuCategoryId].ToString());
        ...
        protected override DataTable GetEntityData(int? entityKey)
        {
			...
			var results = Framework.Components.Core.MenuCategoryDataManager.Search(menuCategorydata, SessionVariables.RequestProfile);
            return results;
        }
        #endregion
