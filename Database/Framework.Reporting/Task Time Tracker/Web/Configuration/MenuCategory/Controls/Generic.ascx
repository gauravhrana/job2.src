<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.MenuCategory.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblMenuCategoryId" Text="MenuCategory Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtMenuCategoryId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtMenuCategoryId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynMenuCategoryId" runat="server" />
        </div>
    </div>
