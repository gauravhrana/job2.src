<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Shared.UI.Web.Configuration.FieldConfigurationModeXApplicationRole.V1.Details" %>

<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Configuration/FieldConfigurationModeXApplicationRole/Controls/Details.ascx" %>
                ...
                <table  cellpadding="2" cellspacing="4" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            FieldConfigurationModeXApplicationRole Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
