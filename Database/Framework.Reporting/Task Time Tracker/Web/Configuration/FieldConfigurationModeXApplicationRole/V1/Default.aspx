<%@ Page Title="Default" Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="Shared.UI.Web.Configuration.FieldConfigurationModeXApplicationRole.V1.Default" %>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Configuration/FieldConfigurationModeXApplicationRole/Controls/SearchFilter.ascx" %>
