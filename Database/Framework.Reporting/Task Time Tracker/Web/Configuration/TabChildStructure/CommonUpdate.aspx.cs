...
namespace Shared.UI.Web.Configuration.TabChildStructure
{
    public partial class CommonUpdate : PageCommonUpdate
    {
        ...
        {      
			...
			UpdatedData = Framework.Components.Core.TabChildStructureDatManager.Search(data, SessionVariables.RequestProfile).Clone();
            for (var i = 0; i < SelectedData.Rows.Count; i++)
            {
				...
				var dt = Framework.Components.Core.TabChildStructureDatManager.Search(data, SessionVariables.RequestProfile);
        ...
        protected override DataTable GetEntityData(int? entityKey)
        {
			...
			var results = Framework.Components.Core.TabChildStructureDatManager.Search(tabChildStructuredata, SessionVariables.RequestProfile);
            return results;
        }
        #endregion
