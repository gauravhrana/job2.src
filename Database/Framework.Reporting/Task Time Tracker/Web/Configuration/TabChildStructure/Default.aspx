<%@ Page Title="Default" Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="Shared.UI.Web.Configuration.TabChildStructure.Default" %>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Configuration/TabChildStructure/Controls/SearchFilter.ascx" %>
