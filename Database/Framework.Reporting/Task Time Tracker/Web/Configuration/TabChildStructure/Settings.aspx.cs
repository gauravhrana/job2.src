...
namespace Shared.UI.Web.Configuration.TabChildStructure
{
    public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
    {
        ...
        {
            eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.TabChildStructure, "TabChildStructure");
        }
        ...
        {
            Response.Redirect(Page.GetRouteUrl("ConfiguratonSubRoutes", new { EntityName = "TabChildStructure", Action = "Default" }), false);
        }
    }
}