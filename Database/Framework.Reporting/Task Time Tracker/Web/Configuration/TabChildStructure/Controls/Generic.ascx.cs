...
namespace Shared.UI.Web.Configuration.TabChildStructure.Controls
{
    public partial class Generic : Framework.UI.Web.BaseClasses.ControlGeneric
    {
		...
		public override int? Save(string action)
		{
			...
			if (action == "Insert")
			{
				var dtTabChildStructure = Framework.Components.Core.TabChildStructureDatManager.DoesExist(data, SessionVariables.RequestProfile);

				if (dtTabChildStructure.Rows.Count == 0)
				{
