<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.SystemForeignRelationshipType.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblSystemForeignRelationshipTypeId" Text="SystemForeignRelationshipType Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtSystemForeignRelationshipTypeId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtSystemForeignRelationshipTypeId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynSystemForeignRelationshipTypeId" runat="server" />
        </div>
    </div>
