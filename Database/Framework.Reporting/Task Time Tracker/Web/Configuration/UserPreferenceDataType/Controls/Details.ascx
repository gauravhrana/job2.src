...
<div class="panel panel-info table-bordered">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblUserPreferenceDataTypeIdText" runat="server" CssClass="control-label">UserPreferenceDataTypeId:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblUserPreferenceDataTypeId" runat="server"></asp:Label></div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"></div>
            <div class="col-sm-10"><asp:PlaceHolder ID="dynUserPreferenceDataTypeId" runat="server" /></div>
        </div>
