<%@ Page Title="SystemForeignRelationship - Update" MasterPageFile="~/MasterPages/Site.master"
    Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="Shared.UI.Web.Configuration.SystemForeignRelationship.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Configuration/SystemForeignRelationship/Controls/Generic.ascx" %>
