<%@ Page Title="Default" Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="Shared.UI.Web.Configuration.TabParentStructure.Default" %>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Configuration/TabParentStructure/Controls/SearchFilter.ascx" %>
