<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.Configuration.TabParentStructure.Controls.Details" %>
...
<div class="panel panel-info table-bordered">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblTabParentStructureIdText" runat="server" CssClass="control-label">TabParentStructureId:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblTabParentStructureId" runat="server"></asp:Label></div>
        </div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblIsAllTabText" runat="server" CssClass="control-label">IsAllTab:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblIsAllTab" runat="server"></asp:Label></div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"></div>
            <div class="col-sm-10"><asp:PlaceHolder ID="dynTabParentStructureId" runat="server" /></div>
        </div>
