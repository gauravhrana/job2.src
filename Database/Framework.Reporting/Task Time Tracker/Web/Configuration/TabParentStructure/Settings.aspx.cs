...
namespace Shared.UI.Web.Configuration.TabParentStructure
{
    public partial class Settings : Framework.UI.Web.BaseClasses.PageSettings
    {
        ...
        {
            eSettingsList.SetUp((int)Framework.Components.DataAccess.SystemEntity.TabParentStructure, "TabParentStructure");
        }
        ...
        {
            Response.Redirect(Page.GetRouteUrl("ConfiguratonSubRoutes", new { EntityName = "TabParentStructure", Action = "Default" }), false);
        }
    }
}