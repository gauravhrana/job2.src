<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.FieldConfigurationModeCategory.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblFieldConfigurationModeCategoryId" Text="FieldConfigurationModeCategory Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtFieldConfigurationModeCategoryId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtFieldConfigurationModeCategoryId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynFieldConfigurationModeCategoryId" runat="server" />
        </div>
    </div>
