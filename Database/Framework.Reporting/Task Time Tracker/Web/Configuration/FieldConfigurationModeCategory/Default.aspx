<%@ Page 
    ...
    Inherits="Shared.UI.Web.Configuration.FieldConfigurationModeCategory.Default" 
%>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageDefaultMaster" %>

<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Configuration/FieldConfigurationModeCategory/Controls/SearchFilter.ascx" %>
...
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">FieldConfigurationModeCategory</asp:Content>
