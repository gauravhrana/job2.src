<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Details.ascx.cs" Inherits="Shared.UI.Web.Configuration.Application.Controls.Details" %>
...
<div class="panel panel-info table-bordered">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblApplicationIdText" runat="server" CssClass="control-label">ApplicationId:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblApplicationId" runat="server"></asp:Label></div>
        </div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <div class="col-sm-2 control-label"><asp:Label ID="lblCodeText" runat="server" CssClass="control-label">Code:</asp:Label></div>
            <div class="col-sm-10"><asp:Label ID="lblCode" runat="server"></asp:Label></div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-2 control-label"></div>
            <div class="col-sm-10"><asp:PlaceHolder ID="dynApplicationId" runat="server" /></div>
        </div>
