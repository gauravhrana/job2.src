...
namespace Shared.UI.Web.Configuration.FieldConfigurationMode
{
    public partial class Default : PageDefault
	{
        ...
        {
			var dt = FieldConfigurationModeDataManager.Search(oSearchFilter.SearchParameters, SessionVariables.RequestProfile);
            return dt;
        }
		...
		protected override void OnInit(EventArgs e)
		{
			...
			PrimaryEntityIdColumn   = "FieldConfigurationModeId";
