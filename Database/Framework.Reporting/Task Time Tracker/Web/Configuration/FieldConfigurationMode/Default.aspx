<%@ Page 
    ...
    Inherits="Shared.UI.Web.Configuration.FieldConfigurationMode.Default" 
%>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageDefaultMaster" %>

<%@ Register Src="~/Configuration/FieldConfigurationMode/Controls/SearchFilter.ascx"
...
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">FieldConfigurationMode</asp:Content>
