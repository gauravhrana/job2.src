<%@ Page Title="Delete" MasterPageFile="~/MasterPages/Site.master" EnableEventValidation="false"
    Language="C#" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="Shared.UI.Web.Configuration.FieldConfigurationMode.Delete" %>
<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageSiteMaster" %>
<%@ Register TagName="DetailsControl" TagPrefix="uc" Src="~/Configuration/FieldConfigurationMode/Controls/Details.ascx" %>
                ...
                <table  cellpadding="2" cellspacing="2" border="0">
                    <tr>
                        <td colspan="2" align="center" class="style3">
                            FieldConfigurationMode Details
                        </td>
                    </tr>
                    <tr>
                        <td class="style2">
