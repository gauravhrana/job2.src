<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Site.master" CodeBehind="Update.aspx.cs"
    Inherits="Shared.UI.Web.Configuration.FieldConfigurationMode.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Configuration/FieldConfigurationMode/Controls/Generic.ascx" %>
