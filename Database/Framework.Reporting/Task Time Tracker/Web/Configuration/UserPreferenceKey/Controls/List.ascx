            ...
            <asp:GridView ID="GridView1" OnSorting="GridView1_Sorting" AllowSorting="true"   AutoGenerateColumns="false" runat="server">
                  <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="Name"
                                ...
                                DataNavigateUrlFormatString="~/Configuration/UserPreferenceKey/Details.aspx?SetId={0}" />
                        ...
                        <asp:HyperLinkField HeaderText ="Update"
                                ...
                                Text="Update" 
                                DataNavigateUrlFields="UserPreferenceKeyId" 
                                DataNavigateUrlFormatString="~/Configuration/UserPreferenceKey/Update.aspx?SetId={0}" />

                        <asp:HyperLinkField HeaderText="Delete"
                                ItemStyle-HorizontalAlign="Center" 
                                Text="Delete" 
                                DataNavigateUrlFields="UserPreferenceKeyId"
                                DataNavigateUrlFormatString="~/Configuration/UserPreferenceKey/Delete.aspx?SetId={0}" />
                        ...
                        <asp:HyperLinkField 
                                ...
                                Text="Clone" 
                                DataNavigateUrlFields="UserPreferenceKeyId" 
                                DataNavigateUrlFormatString="~/Configuration/UserPreferenceKey/Clone.aspx?SetId={0}" />
                    </Columns>
             </asp:GridView>
         </td>
    </tr>
