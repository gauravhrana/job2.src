<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.FieldConfigurationModeAccessMode.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblFieldConfigurationModeAccessModeId" Text="FieldConfigurationModeAccessMode Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtFieldConfigurationModeAccessModeId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtFieldConfigurationModeAccessModeId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
