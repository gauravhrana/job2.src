<%@ Page 
    ...
    Inherits="Shared.UI.Web.Configuration.DateRangeTitle.Default" 
%>


<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageDefaultMaster" %>

<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Configuration/DateRangeTitle/Controls/SearchFilter.ascx" %>
...
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">DateRangeTitle</asp:Content>
