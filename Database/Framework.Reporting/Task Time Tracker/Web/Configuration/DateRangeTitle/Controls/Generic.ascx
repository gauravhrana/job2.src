<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.DateRangeTitle.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblDateRangeTitleId" Text="DateRangeTitle Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtDateRangeTitleId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtDateRangeTitleId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynDateRangeTitleId" runat="server" />
        </div>
    </div>
