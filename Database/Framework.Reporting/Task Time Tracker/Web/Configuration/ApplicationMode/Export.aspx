...
CodeBehind="Export.aspx.cs" Inherits="Shared.UI.Web.Configuration.ApplicationMode.Export" %>
...
<asp:Content ID="exportHeading" ContentPlaceHolderID="SectionName" runat="server">
    <asp:Label ID="Label1" Text="ApplicationModeSearch" runat="server" ForeColor="Red" />
</asp:Content> 
