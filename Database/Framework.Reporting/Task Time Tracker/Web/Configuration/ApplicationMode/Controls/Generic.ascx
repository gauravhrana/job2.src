<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Generic.ascx.cs" Inherits="Shared.UI.Web.Configuration.ApplicationMode.Controls.Generic" %>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="lblApplicationModeId" Text="ApplicationMode Id:" runat="server" CssClass="col-sm-2 control-label" AssociatedControlID="txtApplicationModeId"></asp:Label>
        <div class="col-sm-8">
            <asp:TextBox ID="txtApplicationModeId" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="col-sm-2">
            <asp:PlaceHolder ID="dynApplicationModeId" runat="server" /> 
        </div>
    </div>
