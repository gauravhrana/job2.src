<%@ Page 
    ...
    Inherits="Shared.UI.Web.Configuration.ApplicationMode.Default"
%>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageDefaultMaster" %>

<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Configuration/ApplicationMode/Controls/SearchFilter.ascx" %>
...
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">ApplicationMode</asp:Content>
