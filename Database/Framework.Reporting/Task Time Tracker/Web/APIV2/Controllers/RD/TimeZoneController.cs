...
namespace Web.Api.Controllers
{
	...
	public class TimeZoneController : ApiController
	{
		...
		public void Create([FromBody]TimeZoneDataModel data)
		{
			TimeZoneDataManager.Create(data, SessionVariables.RequestProfile);
		}

		public void Update([FromBody]TimeZoneDataModel data)
		{
			TimeZoneDataManager.Update(data, SessionVariables.RequestProfile);
		}
		...
		public void Delete(string value)
		{
			var dataQuery = new TimeZoneDataModel();
			dataQuery.TimeZoneId = int.Parse(value);
			TimeZoneDataManager.Delete(dataQuery, SessionVariables.RequestProfile);
		}
	}
}
