...
namespace Web.Api.Controllers
{
	...
	public class HolidayController : ApiController
	{
		...
		public void Update([FromBody]HolidayDataModel data)
		{
			HolidayDataManager.Update(data, SessionVariables.RequestProfile);
		}
		...
		public void Delete(string value)
		{
			var dataQuery = new HolidayDataModel();
			dataQuery.HolidayId = int.Parse(value);
			HolidayDataManager.Delete(dataQuery, SessionVariables.RequestProfile);
		}
	}
}
