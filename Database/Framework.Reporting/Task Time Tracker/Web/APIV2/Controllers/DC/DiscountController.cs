...
namespace Web.Api.Controllers
{
	...
	public class DiscountController : ApiController
	{
		...
		public void Create([FromBody]DiscountDataModel data)
		{
			DiscountDataManager.Create(data, SessionVariables.RequestProfile);
		}

		public void Update([FromBody]DiscountDataModel data)
		{
			DiscountDataManager.Update(data, SessionVariables.RequestProfile);
		}
		...
		public void Delete(string value)
		{
			var dataQuery = new DiscountDataModel();
			dataQuery.DiscountId = int.Parse(value);
			DiscountDataManager.Delete(dataQuery, SessionVariables.RequestProfile);
		}
	}
}
