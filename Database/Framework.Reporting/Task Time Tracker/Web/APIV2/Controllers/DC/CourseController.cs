...
namespace Web.Api.Controllers
{
	...
	public class CourseController : ApiController
	{
		...
		public void Create([FromBody]CourseDataModel data)
		{
			CourseDataManager.Create(data, SessionVariables.RequestProfile);
		}

		public void Update([FromBody]CourseDataModel data)
		{
			CourseDataManager.Update(data, SessionVariables.RequestProfile);
		}
		...
		public void Delete(string value)
		{
			var dataQuery = new CourseDataModel();
			dataQuery.CourseId = int.Parse(value);
			CourseDataManager.Delete(dataQuery, SessionVariables.RequestProfile);
		}
	}
}
