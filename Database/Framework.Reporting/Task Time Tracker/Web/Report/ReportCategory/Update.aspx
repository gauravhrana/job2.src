<%@ Page Title="Update" EnableEventValidation="false" MasterPageFile="~/MasterPages/Site.master"
    Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="ApplicationContainer.UI.Web.ReportCategory.Update" %>

<%@ Register TagPrefix="gnrc" TagName="GenericTool" Src="~/Report/ReportCategory/Controls/Generic.ascx" %>
