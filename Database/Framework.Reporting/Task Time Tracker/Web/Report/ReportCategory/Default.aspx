<%@ Page 
	...
	Inherits="ApplicationContainer.UI.Web.ReportCategory.Default" 
%>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Report/ReportCategory/Controls/SearchFilter.ascx" %>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageDefaultMaster" %>

<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">ReportCategory</asp:Content>
