...
namespace TaskTimeTracker.UI.Web.Report.Controls
{
	public partial class List : Shared.UI.WebFramework.BaseControl
	{
		...
		{
			var data = new Framework.Components.Core.Report.Data();
			data.Name = name;
			var dt = Framework.Components.Core.Report.Search(data, AuditId);
			return dt;
		}
