<%@ Page 
	...
	Inherits="ApplicationContainer.UI.Web.Report.Default" 
%>
...
<%@ Register TagPrefix="sr" TagName="SearchFilter" Src="~/Report/Controls/SearchFilter.ascx" %>

<%@ MasterType TypeName="Framework.UI.Web.BaseClasses.PageDefaultMaster" %>

<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="ContentSectionName" runat="server" ContentPlaceHolderID="SectionName">Report</asp:Content>
