...
function MasterCtrl($scope, $cookieStore, $injector, menuService, $routeParams, $location, userService) {
    ...
    $scope.$on('$routeChangeSuccess', function () {
        ...
        if (angular.isDefined($cookieStore.get('applicationModuleCM'))) {

            // switch in cookie if different module encountered
            var cookieModule = $cookieStore.get('applicationModuleCM');
            if (cookieModule != $scope.module) {
                ...
                $cookieStore.put('applicationModuleCM', $scope.module);
            ...
            if ($scope.module == '' || $scope.module == undefined) {
                $scope.module = 'PositionManagement';
            }
        ...
        $scope.SwitchModule = function (module) {
            ...
            //storage.set('module', module);
            //$scope.module = module;
            //$cookieStore.put('applicationModuleCM', module);
        };
        ...
        //if (angular.isDefined($cookieStore.get('applicationModuleCM'))) {
        //    $scope.module = $cookieStore.get('applicationModuleCM');
        //} else {
        //    $scope.module = 'PositionManagement';
        //}
