											...
											angular.module('rootAppShell')
												.controller('saveTransactionTypeCtrl', [
													'dataAutoCompleteService', '$location', '$scope', '$injector', '$routeParams', '$modal', 'userService', '$timeout', '$log', 
													function (dataAutoCompleteService, $location, $scope, $injector, $routeParams, $modal, userService, $timeout, $log) {
