...
var app = angular.module('rootAppShell', [
    ...
    .config(function ($httpProvider, $routeProvider, $parseProvider, $logProvider, RestangularProvider) {
    	...
    	$routeProvider
            ...
            //Schedule
            .when('/:moduleName/Schedule/search', { templateUrl: '../../app/BM/Legal/views/Gen/List/listTableSchedule.html', controller: 'listTableScheduleCtrl', caseInsensitiveMatch: true })
            .when('/:moduleName/Schedule/detail/:detailId', { templateUrl: '../../app/BM/Legal/views/Gen/Detail/detailSchedule.html', controller: 'detailScheduleCtrl', caseInsensitiveMatch: true })
            .when('/:moduleName/Schedule/save/:detailId', { templateUrl: '../../app/BM/Legal/views/Gen/Save/saveSchedule.html', controller: 'saveScheduleCtrl', caseInsensitiveMatch: true })

            //Schedule State
            .when('/:moduleName/ScheduleDetail/search', { templateUrl: '../../app/BM/Legal/views/Gen/List/listTableScheduleDetail.html', controller: 'listTableScheduleDetailCtrl', caseInsensitiveMatch: true })
            .when('/:moduleName/ScheduleDetail/detail/:detailId', { templateUrl: '../../app/BM/Legal/views/Gen/Detail/detailScheduleDetail.html', controller: 'detailScheduleDetailCtrl', caseInsensitiveMatch: true })
            .when('/:moduleName/ScheduleDetail/save/:detailId', { templateUrl: '../../app/BM/Legal/views/Gen/Save/saveScheduleDetail.html', controller: 'saveScheduleDetailCtrl', caseInsensitiveMatch: true })

            //Schedule State
            .when('/:moduleName/ScheduleState/search', { templateUrl: '../../app/BM/Legal/views/Gen/List/listTableScheduleState.html', controller: 'listTableScheduleStateCtrl', caseInsensitiveMatch: true })
            .when('/:moduleName/ScheduleState/detail/:detailId', { templateUrl: '../../app/BM/Legal/views/Gen/Detail/detailScheduleState.html', controller: 'detailScheduleStateCtrl', caseInsensitiveMatch: true })
            .when('/:moduleName/ScheduleState/save/:detailId', { templateUrl: '../../app/BM/Legal/views/Gen/Save/saveScheduleState.html', controller: 'saveScheduleStateCtrl', caseInsensitiveMatch: true })

            //Schedule State
            .when('/:moduleName/ScheduleDetailActivityCategory/search', { templateUrl: '../../app/BM/Legal/views/Gen/List/listTableScheduleDetailActivityCategory.html', controller: 'listTableScheduleDetailActivityCategoryCtrl', caseInsensitiveMatch: true })
            .when('/:moduleName/ScheduleDetailActivityCategory/detail/:detailId', { templateUrl: '../../app/BM/Legal/views/Gen/Detail/detailScheduleDetailActivityCategory.html', controller: 'detailScheduleDetailActivityCategoryCtrl', caseInsensitiveMatch: true })
            .when('/:moduleName/ScheduleDetailActivityCategory/save/:detailId', { templateUrl: '../../app/BM/Legal/views/Gen/Save/saveScheduleDetailActivityCategory.html', controller: 'saveScheduleDetailActivityCategoryCtrl', caseInsensitiveMatch: true })
