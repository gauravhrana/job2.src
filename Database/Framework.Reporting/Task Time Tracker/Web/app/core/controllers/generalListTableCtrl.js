...
angular.module('rootAppShell')
    .controller('generalListTableCtrl', [
        '$scope', '$injector', '$routeParams', '$location', 'fieldConfigurationService', 'autoCompleteDataService',
            'dataAutoCompleteService', 'userService', 'cachingService', 'uiGridConstants', '$interval', '$http', '$timeout',
        ...
        function ($scope, $injector, $routeParams, $location, fieldConfigurationService, autoCompleteDataService,
            ...
            $scope.PrimaryKey = $scope.entityName + 'Id';
            ...
            fieldConfigurationService.getSearchFilterColumns({ value: $scope.entityName, value1: settingCategory },
            ...
            function onSuccessLoadColumns(response) {
                ...
                for (var i = 0; i < response.length; i++) {
                    ...
                    if (isVisible) {
                        ...
                        //if (isVisible) {
                        //    if (response[i].Name == $scope.groupByColumn || response[i].Name == $scope.subGroupByColumn) {
                        //        isVisible = false;
                        //    }
                        //}
