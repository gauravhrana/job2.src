<%@ Page Title="Details" MasterPageFile="~/MasterPages/Site.master" Language="C#" EnableEventValidation="false"
AutoEventWireup="true"  CodeBehind="Details.aspx.cs" Inherits="ApplicationContainer.UI.Web.EntityDateRangeStateType.Details" %>
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <table >
        ...
        <tr>
            <td>
                <dc:DetailsControl ID="oDetailsControl" EntityName="EntityDateRangeStateType" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="right">
