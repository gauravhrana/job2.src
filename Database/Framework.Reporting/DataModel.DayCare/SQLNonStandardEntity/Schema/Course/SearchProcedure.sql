...
BEGIN
	...
	BEGIN
		...
		SET @InputParametersLocal		=  'CourseId' 
		SET @InputValuesLocal			=  CAST(@CourseId AS VARCHAR(50))
	...
	BEGIN
		...
		INTO		#HistortyInfo
		FROM 		#TempMain a	
		INNER JOIN	CommonServices.dbo.AuditHistory c ON	c.EntityKey			= a.CourseId
		...
		FROM		#TempMain a
		INNER JOIN	#HistortyInfo							b ON	b.EntityKey			= a.CourseId
		...
		SELECT	a.*
			...
			,	b.LastAction
		FROM	#TempMain		a
		LEFT JOIN	#HistortyInfoDetails	b ON	a.CourseId=b.CourseId
		ORDER BY	a.CourseId
	END
	ELSE
	BEGIN
