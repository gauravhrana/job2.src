...
BEGIN
		...
		BEGIN
			...
			SET @InputParametersLocal		=  'BathRoomId'  + ', ' + 'Name' + ', ' + 'Description'
			SET @InputValuesLocal			=  CAST(@BathRoomId AS VARCHAR(50)) + ',' + ISNULL(@Name, 'NULL') + ',' + ISNULL(@Description, 'NULL')
		...
		AND	a.BathRoomId = ISNULL(@BathRoomId, a.BathRoomId)
