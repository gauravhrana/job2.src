...
BEGIN
		...
		BEGIN
			...
			SET @InputParametersLocal		=  'MealDetailId'  + ', ' + 'Name' + ', ' + 'Description'
			SET @InputValuesLocal			=  CAST(@MealDetailId AS VARCHAR(50)) + ',' + ISNULL(@Name, 'NULL') + ',' + ISNULL(@Description, 'NULL')

			EXEC dbo.StoredProcedureLogInsert
					@Name					= 'dbo.MealDetailSearch'
		...
		AND	a.MealDetailId = ISNULL(@MealDetailId, a.MealDetailId)
