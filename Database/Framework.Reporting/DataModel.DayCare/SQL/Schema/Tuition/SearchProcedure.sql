...
BEGIN
		...
		BEGIN
			...
			SET @InputParametersLocal		=  'TuitionId'  + ', ' + 'Name' + ', ' + 'Description'
			SET @InputValuesLocal			=  CAST(@TuitionId AS VARCHAR(50)) + ',' + ISNULL(@Name, 'NULL') + ',' + ISNULL(@Description, 'NULL')
		...
		AND	a.TuitionId = ISNULL(@TuitionId, a.TuitionId)
