...
BEGIN
		...
		BEGIN
			...
			SET @InputParametersLocal		=  'AccidentReportId'  + ', ' + 'Name' + ', ' + 'Description'
			SET @InputValuesLocal			=  CAST(@AccidentReportId AS VARCHAR(50)) + ',' + ISNULL(@Name, 'NULL') + ',' + ISNULL(@Description, 'NULL')
		...
		AND	a.AccidentReportId = ISNULL(@AccidentReportId, a.AccidentReportId)
