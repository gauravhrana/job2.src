...
namespace Framework.Components.Core
{
	public partial class HelpPageDataManager : DataAccess.BaseDataManager
	{
		...
		{
			var sql = "EXEC dbo.HelpPageSearch" +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
				", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId, requestProfile.ApplicationId);

			var oDT = new DataAccess.DBDataTable("HelpPage.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(DataModel.Framework.Core.HelpPageDataModel data, RequestProfile requestProfile)
		{
