...
namespace Framework.Components.Core
{
	public partial class TabParentStructureDataManager : StandardDataManager
	{
		...
		public static DataTable GetList(RequestProfile requestProfile)
		{
			...
			var oDT = new DBDataTable("TabParentStructure.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(TabParentStructureDataModel data, RequestProfile requestProfile)
		{
		...
		public static DataTable DoesExist(TabParentStructureDataModel data, RequestProfile requestProfile)
		{
