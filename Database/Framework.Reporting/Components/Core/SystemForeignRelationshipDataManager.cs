...
namespace Framework.Components.Core
{
	public partial class SystemForeignRelationshipDataManager : BaseDataManager
	{
		...
		{
			var sql = "EXEC dbo.SystemForeignRelationshipSearch " +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId);

			var oDT = new DBDataTable("SystemForeignRelationship.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(SystemForeignRelationshipDataModel data, RequestProfile requestProfile)
		{
