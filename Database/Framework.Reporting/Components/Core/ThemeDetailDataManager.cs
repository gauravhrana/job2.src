...
namespace Framework.Components.Core
{
	public partial class ThemeDetailDataManager : BaseDataManager
	{
		...
		{
			var sql = "EXEC dbo.ThemeDetailSearch " +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
				", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId, requestProfile.ApplicationId);

			var oDT = new DBDataTable("ThemeDetail.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(ThemeDetailDataModel data, RequestProfile requestProfile)
		{
		...
		public static DataTable DoesExist(ThemeDetailDataModel data, RequestProfile requestProfile)
		{
