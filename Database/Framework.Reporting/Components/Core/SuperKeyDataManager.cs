...
namespace Framework.Components.Core
{
	public partial class SuperKeyDataManager : BaseDataManager
	{
		...
		{
			var sql = "EXEC dbo.SuperKeySearch " +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
				", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId, requestProfile.ApplicationId);

			var oDT = new DBDataTable("SuperKey.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(SuperKeyDataModel data, RequestProfile requestProfile)
		{
		...
		public static DataTable DoesExist(SuperKeyDataModel data, RequestProfile requestProfile)
		{
