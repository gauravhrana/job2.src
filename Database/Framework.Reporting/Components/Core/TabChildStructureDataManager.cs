...
namespace Framework.Components.Core
{
	public partial class TabChildStructureDatManager : BaseDataManager
	{
		...
		{
			var sql = "EXEC dbo.TabChildStructureSearch " +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
				", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId, requestProfile.ApplicationId);

			var oDT = new DBDataTable("TabChildStructure.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(TabChildStructureDataModel data, RequestProfile requestProfile)
		{
		...
		public static DataTable DoesExist(TabChildStructureDataModel data, RequestProfile requestProfile)
		{
