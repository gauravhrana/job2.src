...
namespace Framework.Components.Core
{
	public partial class ApplicationRouteParameterDataManager : DataAccess.BaseDataManager
	{
		...
		{
			var sql = "EXEC dbo.ApplicationRouteParameterSearch" +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
				 ", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId, requestProfile.ApplicationId);

			var oDT = new Framework.Components.DataAccess.DBDataTable("ApplicationRouteParameter.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(DataModel.Framework.Core.ApplicationRouteParameterDataModel data, RequestProfile requestProfile)
		{
		...
		public static DataTable DoesExist(DataModel.Framework.Core.ApplicationRouteParameterDataModel data, RequestProfile requestProfile)
		{
