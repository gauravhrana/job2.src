...
namespace Framework.Components.Core
{
	public partial class SystemForeignRelationshipDatabaseDataManager : StandardDataManager
	{
		...
		{
			var list = GetEntityDetails(SystemForeignRelationshipDatabaseDataModel.Empty, requestProfile, 0);
		...
		public static DataTable GetDetails(SystemForeignRelationshipDatabaseDataModel data, RequestProfile requestProfile)
		{
			var list = GetEntityDetails(data, requestProfile, 0);
			return list.ToDataTable();
		}
		...
		public static DataTable DoesExist(SystemForeignRelationshipDatabaseDataModel data, RequestProfile requestProfile)
		{
