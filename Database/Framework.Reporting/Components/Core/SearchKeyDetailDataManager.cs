...
namespace Framework.Components.Core
{
	public partial class SearchKeyDetailDataManager : BaseDataManager
	{
		...
		{
			var sql = "EXEC dbo.SearchKeyDetailSearch " +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
				", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId, requestProfile.ApplicationId);

			var oDT = new DBDataTable("SearchKeyDetail.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(SearchKeyDetailDataModel data, RequestProfile requestProfile)
		{
