...
namespace Framework.Components.Core
{
	public partial class ThemeDetailsDataManager : BaseDataManager
	{
		...
		{
			var sql = "EXEC dbo.ThemeDetailsSearch " +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
				", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId, requestProfile.ApplicationId);

			var oDT = new DBDataTable("ThemeDetails.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(ThemeDetailsDataModel data, RequestProfile requestProfile)
		{
		...
		public static DataTable DoesExist(ThemeDetailsDataModel data, RequestProfile requestProfile)
		{
