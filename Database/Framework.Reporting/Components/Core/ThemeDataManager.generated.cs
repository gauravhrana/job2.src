...
namespace Framework.Components.Core
{
	public partial class ThemeDataManager : StandardDataManager
	{
		...
		{
			var list = GetEntityDetails(ThemeDataModel.Empty, requestProfile, 0);
		...
		public static DataTable GetDetails(ThemeDataModel data, RequestProfile requestProfile)
		{
			var list = GetEntityDetails(data, requestProfile, 0);
			return list.ToDataTable();
		}
		...
		public static DataTable DoesExist(ThemeDataModel data, RequestProfile requestProfile)
		{
