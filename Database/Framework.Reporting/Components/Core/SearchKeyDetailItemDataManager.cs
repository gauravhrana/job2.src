...
namespace Framework.Components.Core
{
	public partial class SearchKeyDetailItemDataManager : BaseDataManager
	{
		...
		{
			var sql = "EXEC dbo.SearchKeyDetailItemSearch " +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
				", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId, requestProfile.ApplicationId);

			var oDT = new DBDataTable("SearchKeyDetailItem.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(SearchKeyDetailItemDataModel data, RequestProfile requestProfile)
		{
