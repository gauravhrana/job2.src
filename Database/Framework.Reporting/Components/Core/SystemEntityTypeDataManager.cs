...
namespace Framework.Components.Core
{
	public partial class SystemEntityTypeDataManager : BaseDataManager
	{
		...
		{
			var sql = "EXEC dbo.SystemEntityTypeSearch " +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId);
			//", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId, requestProfile.ApplicationId);

			var oDT = new DBDataTable("SystemEntityType.List", sql, DataStoreKey);
			return oDT.DBTable;
		}		
		...
		public static DataTable GetDetails(SystemEntityTypeDataModel data, RequestProfile requestProfile)
		{
