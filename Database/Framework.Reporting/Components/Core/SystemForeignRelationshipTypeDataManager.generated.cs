...
namespace Framework.Components.Core
{
	public partial class SystemForeignRelationshipTypeDataManager : StandardDataManager
	{
		...
		{
			var list = GetEntityDetails(SystemForeignRelationshipTypeDataModel.Empty, requestProfile, 0);
		...
		public static DataTable GetDetails(SystemForeignRelationshipTypeDataModel data, RequestProfile requestProfile)
		{
			var list = GetEntityDetails(data, requestProfile, 0);
			return list.ToDataTable();
		}
		...
		public static DataTable DoesExist(SystemForeignRelationshipTypeDataModel data, RequestProfile requestProfile)
		{
