...
namespace Framework.Components.Core
{
	public partial class HelpPageContextDataManager : StandardDataManager
	{
		...
		{
			var list = GetEntityDetails(HelpPageContextDataModel.Empty, requestProfile, 0);
		...
		public static DataTable GetDetails(HelpPageContextDataModel data, RequestProfile requestProfile)
		{
			var list = GetEntityDetails(data, requestProfile, 0);
			return list.ToDataTable();
		}
		...
		public static DataTable DoesExist(HelpPageContextDataModel data, RequestProfile requestProfile)
		{
