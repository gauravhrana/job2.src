...
namespace Framework.Components.Core
{
	public partial class SubscriberApplicationRoleDataManager : StandardDataManager
	{
		...
		{
			var list = GetEntityDetails(SubscriberApplicationRoleDataModel.Empty, requestProfile, 0);
		...
		public static DataTable GetDetails(SubscriberApplicationRoleDataModel data, RequestProfile requestProfile)
		{
			var list = GetEntityDetails(data, requestProfile, 0);
			return list.ToDataTable();
		}
		...
		public static DataTable DoesExist(SubscriberApplicationRoleDataModel data, RequestProfile requestProfile)
		{
