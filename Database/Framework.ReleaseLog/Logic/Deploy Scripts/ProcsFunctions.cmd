...
for %%f in ("..\Stored Procedures\ReleaseLog\*.sql") DO sqlcmd -S %1 -d %2 -i "%%f" -b -U %3 -P %4
for %%f in ("..\Stored Procedures\ReleaseLogDetails\*.sql") DO sqlcmd -S %1 -d %2 -i "%%f" -b -U %3 -P %4
