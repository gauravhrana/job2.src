...
for %%f in ("..\Stored Procedures\AuditAction\*.sql") DO sqlcmd -S %1 -d %2 -i "%%f" -b -U %3 -P %4
for %%f in ("..\Stored Procedures\AuditHistory\*.sql") DO sqlcmd -S %1 -d %2 -i "%%f" -b -U %3 -P %4
for %%f in ("..\Stored Procedures\AuditLog\*.sql") DO sqlcmd -S %1 -d %2 -i "%%f" -b -U %3 -P %4
