...
BEGIN
		...
		BEGIN
			...
			SET @InputParametersLocal		=  'SleepId'  + ', ' + 'Name' + ', ' + 'Description'
			SET @InputValuesLocal			=  CAST(@SleepId AS VARCHAR(50)) + ',' + ISNULL(@Name, 'NULL') + ',' + ISNULL(@Description, 'NULL')
		...
		AND	a.SleepId = ISNULL(@SleepId, a.SleepId)
