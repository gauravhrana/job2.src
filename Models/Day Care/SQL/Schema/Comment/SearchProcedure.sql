...
BEGIN
		...
		BEGIN
			...
			SET @InputParametersLocal		=  'CommentId'  + ', ' + 'Name' + ', ' + 'Description'
			SET @InputValuesLocal			=  CAST(@CommentId AS VARCHAR(50)) + ',' + ISNULL(@Name, 'NULL') + ',' + ISNULL(@Description, 'NULL')
		...
		AND	a.CommentId = ISNULL(@CommentId, a.CommentId)
