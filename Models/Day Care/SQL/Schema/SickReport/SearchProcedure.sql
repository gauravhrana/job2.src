...
BEGIN
		...
		BEGIN
			...
			SET @InputParametersLocal		=  'SickReportId'  + ', ' + 'Name' + ', ' + 'Description'
			SET @InputValuesLocal			=  CAST(@SickReportId AS VARCHAR(50)) + ',' + ISNULL(@Name, 'NULL') + ',' + ISNULL(@Description, 'NULL')
		...
		AND	a.SickReportId = ISNULL(@SickReportId, a.SickReportId)
