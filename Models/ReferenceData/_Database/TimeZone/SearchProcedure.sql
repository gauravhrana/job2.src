...
CREATE Procedure dbo.TimeZoneSearch
(
		@TimeZoneId				INT							= NULL
...
BEGIN
		...
		BEGIN
			...
			SET @InputParametersLocal		=  'TimeZoneId'  + ', ' + 'Name' + ', ' + 'Description'
			SET @InputValuesLocal			=  CAST(@TimeZoneId AS VARCHAR(50)) + ',' + ISNULL(@Name, 'NULL') + ',' + ISNULL(@Description, 'NULL')
