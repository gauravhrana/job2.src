...
namespace TestCaseManagement.Components.DataAccess
{
	public partial class TestCaseDataManager : StandardDataManager
	{
		...
		public static List<TestCaseDataModel> GetList(RequestProfile requestProfile)
		{
			return GetEntityDetails(TestCaseDataModel.Empty, requestProfile, 0);
		}
		...
		public static TestCaseDataModel GetDetails(TestCaseDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(TestCaseDataModel data, RequestProfile requestProfile)
		{
