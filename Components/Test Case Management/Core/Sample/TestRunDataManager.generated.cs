...
//		{
//			var list = GetEntityDetails(TestRunDataModel.Empty, requestProfile, 0);
...
//		public static DataTable GetDetails(TestRunDataModel data, RequestProfile requestProfile)
//		{
//			var list = GetEntityDetails(data, requestProfile, 0);
//			return list.ToDataTable();
//		}
...
//		public static DataTable DoesExist(TestRunDataModel data, RequestProfile requestProfile)
//		{
