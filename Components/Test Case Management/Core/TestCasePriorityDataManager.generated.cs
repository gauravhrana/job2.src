...
namespace TestCaseManagement.Components.DataAccess
{
	public partial class TestCasePriorityDataManager : StandardDataManager
	{
		...
		public static List<TestCasePriorityDataModel> GetList(RequestProfile requestProfile)
		{
			return GetEntityDetails(TestCasePriorityDataModel.Empty, requestProfile, 0);
		}
		...
		public static TestCasePriorityDataModel GetDetails(TestCasePriorityDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(TestCasePriorityDataModel data, RequestProfile requestProfile)
		{
