...
namespace TestCaseManagement.Components.DataAccess
{
	public partial class TestCaseStatusDataManager : StandardDataManager
	{
		...
		public static List<TestCaseStatusDataModel> GetList(RequestProfile requestProfile)
		{
			return GetEntityDetails(TestCaseStatusDataModel.Empty, requestProfile, 0);
		}
