...
namespace Framework.Components.Core
{
	public partial class SearchKeyDataManager : BaseDataManager
	{
        ...
        public static List<SearchKeyDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(SearchKeyDataModel.Empty, requestProfile, 0);
		}
        ...
        public static SearchKeyDataModel GetDetails(SearchKeyDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(SearchKeyDataModel data, RequestProfile requestProfile)
		{
