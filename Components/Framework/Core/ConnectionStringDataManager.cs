...
namespace Framework.Components.Core
{
	public partial class ConnectionStringDataManager : BaseDataManager
	{
        ...
        public static List<ConnectionStringDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(ConnectionStringDataModel.Empty, requestProfile, 0);
		}
        ...
        public static ConnectionStringDataModel GetDetails(ConnectionStringDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(ConnectionStringDataModel data, RequestProfile requestProfile)
		{
