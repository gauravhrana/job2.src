...
namespace Framework.Components.Core
{
	public partial class SystemEntityXSystemEntityCategoryDataManager : BaseDataManager
	{
        ...
        public static List<SystemEntityXSystemEntityCategoryDataModel> GetList(RequestProfile requestProfile)
		{
            return GetEntityDetails(SystemEntityXSystemEntityCategoryDataModel.Empty, requestProfile, 0);
		}
        ...
        public static SystemEntityXSystemEntityCategoryDataModel GetDetails(SystemEntityXSystemEntityCategoryDataModel data, RequestProfile requestProfile)
		{
        ...
        public static List<SystemEntityXSystemEntityCategoryDataModel> GetEntityDetails(SystemEntityXSystemEntityCategoryDataModel dataQuery, RequestProfile requestProfile, int returnAuditInfo = BaseDataManager.ReturnAuditInfoOnDetails)
        {
            const string sql = @"dbo.SystemEntityXSystemEntityCategorySearch ";
            ...
            new
            {
                ...
                ,   SystemEntityXSystemEntityCategoryId             = dataQuery.SystemEntityXSystemEntityCategoryId
                ,   SystemEntityCategoryId                    = dataQuery.SystemEntityCategoryId
                ,   SystemEntityId               = dataQuery.SystemEntityId
            };

            List<SystemEntityXSystemEntityCategoryDataModel> result;

            using (var dataAccess = new DataAccessBase(DataStoreKey))
            {
                result = dataAccess.Connection.Query<SystemEntityXSystemEntityCategoryDataModel>(sql, parameters, commandType: CommandType.StoredProcedure).ToList();
            }
