...
namespace Framework.Components.Core
{
	public partial class LanguageDataManager : StandardDataManager
	{
		...
		public static List<LanguageDataModel> GetList(RequestProfile requestProfile)
		{
			return GetEntityDetails(LanguageDataModel.Empty, requestProfile, 0);
		}
		...
		public static LanguageDataModel GetDetails(LanguageDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(LanguageDataModel data, RequestProfile requestProfile)
		{
