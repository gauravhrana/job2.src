...
namespace Framework.Components.Core
{
	public partial class MenuCategoryDataManager : StandardDataManager
	{
		...
		public static List<MenuCategoryDataModel> GetList(RequestProfile requestProfile)
		{
			return GetEntityDetails(MenuCategoryDataModel.Empty, requestProfile, 0);
		}
		...
		public static MenuCategoryDataModel GetDetails(MenuCategoryDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(MenuCategoryDataModel data, RequestProfile requestProfile)
		{
