...
namespace Framework.Components.Core
{
	public partial class ApplicationRouteDataManager : DataAccess.BaseDataManager
	{
        ...
        public static List<ApplicationRouteDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(ApplicationRouteDataModel.Empty, requestProfile, 0);
		}
        ...
        public static ApplicationRouteDataModel GetDetails(DataModel.Framework.Core.ApplicationRouteDataModel data, RequestProfile requestProfile)
		{
		...
		public static void AddSearchApplicationRoutes(RequestProfile requestProfile)
		{
			...
			for (int j = 0; j < dv.Table.Rows.Count; j++)
			{
				...
				if(!DoesExist(searchAR, requestProfile))
				{
