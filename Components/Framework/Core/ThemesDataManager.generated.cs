...
namespace Framework.Components.Core
{
	public partial class ThemesDataManager : StandardDataManager
	{
		...
		public static List<ThemesDataModel> GetList(RequestProfile requestProfile)
		{
			return GetEntityDetails(ThemesDataModel.Empty, requestProfile, 0);
		}
		...
		public static ThemesDataModel GetDetails(ThemesDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(ThemesDataModel data, RequestProfile requestProfile)
		{
