...
namespace Framework.Components.Core
{
	public partial class ThemeCategoryDataManager : StandardDataManager
	{
		...
		public static List<ThemeCategoryDataModel> GetList(RequestProfile requestProfile)
		{
		...
		public static ThemeCategoryDataModel GetDetails(ThemeCategoryDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(ThemeCategoryDataModel data, RequestProfile requestProfile)
		{
