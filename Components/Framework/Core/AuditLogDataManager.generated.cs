...
namespace Framework.Components.Core
{
	public partial class AuditLogDataManager : StandardDataManager
	{
		...
		public static List<AuditLogDataModel> GetList(RequestProfile requestProfile)
		{
			return GetEntityDetails(AuditLogDataModel.Empty, requestProfile, 0);
		}
		...
		public static AuditLogDataModel GetDetails(AuditLogDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(AuditLogDataModel data, RequestProfile requestProfile)
		{
