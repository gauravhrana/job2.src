...
namespace Framework.Components.Core
{
	public partial class SystemEntityCategoryDataManager : StandardDataManager
	{
		...
		public static List<SystemEntityCategoryDataModel> GetList(RequestProfile requestProfile)
		{
			return GetEntityDetails(SystemEntityCategoryDataModel.Empty, requestProfile, 0);
		}
		...
		public static SystemEntityCategoryDataModel GetDetails(SystemEntityCategoryDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(SystemEntityCategoryDataModel data, RequestProfile requestProfile)
		{
