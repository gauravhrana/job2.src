...
namespace Framework.Components.Core
{
	public partial class ReportXReportCategoryDataManager : BaseDataManager
	{
        ...
        public static List<ReportXReportCategoryDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(ReportXReportCategoryDataModel.Empty, requestProfile, 0);
        }
        ...
        public static ReportXReportCategoryDataModel GetDetails(ReportXReportCategoryDataModel data, RequestProfile requestProfile)
        {
        ...
        public static List<ReportXReportCategoryDataModel> GetEntityDetails(ReportXReportCategoryDataModel dataQuery, RequestProfile requestProfile, int returnAuditInfo = BaseDataManager.ReturnAuditInfoOnDetails)
        {
            const string sql = @"dbo.ReportXReportCategorySearch ";
            ...
            new
            {
                ...
                ,   ReportXReportCategoryId             = dataQuery.ReportXReportCategoryId
                ,   ReportCategoryId                    = dataQuery.ReportCategoryId
                ,   ReportId               = dataQuery.ReportId
            };

            List<ReportXReportCategoryDataModel> result;

            using (var dataAccess = new DataAccessBase(DataStoreKey))
            {
                result = dataAccess.Connection.Query<ReportXReportCategoryDataModel>(sql, parameters, commandType: CommandType.StoredProcedure).ToList();
            }
