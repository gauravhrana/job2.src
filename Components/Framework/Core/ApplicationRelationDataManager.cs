...
namespace Framework.Components.Core
{
	public partial class ApplicationRelationDataManager : DataAccess.BaseDataManager
	{
		...
		public static List<ApplicationRelationDataModel> GetList(RequestProfile requestProfile)
		{
            return GetEntityDetails(ApplicationRelationDataModel.Empty, requestProfile, 0);		
		}
        ...
        public static ApplicationRelationDataModel GetDetails(ApplicationRelationDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(DataModel.Framework.Core.ApplicationRelationDataModel data, RequestProfile requestProfile)
		{
            var list = GetEntityDetails(data, requestProfile, 0);
            return list.Count > 0;
		}
