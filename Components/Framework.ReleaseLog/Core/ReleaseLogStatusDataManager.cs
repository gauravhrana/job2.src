...
namespace Framework.Components.ReleaseLog
{
	public partial class ReleaseLogStatusDataManager : StandardDataManager
	{
        ...
        public static List<ReleaseLogStatusDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(ReleaseLogStatusDataModel.Empty, requestProfile, 0);
		}
        ...
        public static ReleaseLogStatusDataModel GetDetails(ReleaseLogStatusDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(ReleaseLogStatusDataModel data, RequestProfile requestProfile)
		{
        ...
        public static void Sync(int newApplicationId, int oldApplicationId, RequestProfile requestProfile)
        {
            ...
            var oDT = new DBDataTable("ReleaseLogStatus.Search", sql, DataStoreKey);
