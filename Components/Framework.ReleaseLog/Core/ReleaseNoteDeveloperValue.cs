...
namespace Framework.Components.ReleaseLog
{
	...
	public partial class ReleaseNoteDeveloperValueDataManager : StandardDataManager
	{
		...
		{
			var sql = "EXEC dbo.ReleaseNoteDeveloperValueSearch" +
		...
		static private List<ReleaseNoteDeveloperValueDataModel> ToList(DataTable dt)
		{
			var list = new List<ReleaseNoteDeveloperValueDataModel>();

			if (dt != null && dt.Rows.Count > 0)
			{
				foreach (DataRow dr in dt.Rows)
				{
					var dataItem = new ReleaseNoteDeveloperValueDataModel();

					dataItem.ReleaseNoteDeveloperValueId = (int?)dr[ReleaseNoteDeveloperValueDataModel.DataColumns.ReleaseNoteDeveloperValueId];
					dataItem.DateCreated = (DateTime)dr[ReleaseNoteDeveloperValueDataModel.DataColumns.DateCreated];
					dataItem.DateModified = (DateTime)dr[ReleaseNoteDeveloperValueDataModel.DataColumns.DateModified];
		...
		public static DataTable GetDetails(ReleaseNoteDeveloperValueDataModel data, RequestProfile requestProfile)
		{
		...
		public static DataTable DoesExist(ReleaseNoteDeveloperValueDataModel data, RequestProfile requestProfile)
		{
