...
namespace Framework.Components.ReleaseLog
{
	...
	public partial class ReleaseLogDetailDataManager : BaseDataManager
    {
		...
		public static string ToSQLParameter(ReleaseLogDetailDataModel data, string dataColumnName)
		{
			...
			switch (dataColumnName)
			{
				...
				case ReleaseLogDetailDataModel.DataColumns.PrimaryDeveloper:
					...
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_STRING_OR_DATE, ReleaseLogDetailDataModel.DataColumns.PrimaryDeveloper, data.PrimaryDeveloper);
					}
					else
					{
        ...
        public static DataTable GetList(RequestProfile requestProfile)
        {
            ...
            var oDt = new DBDataTable("ReleaseLogDetail.List", sql, DataStoreKey);
            return oDt.DBTable;
        }
		...
		public static DataTable GetChildReleaseLogDetailItemList(ReleaseLogDetailDataModel data, RequestProfile requestProfile)
		{
			// formulate SQL  
			var sql = "EXEC dbo.ReleaseLogDetailSearch " +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
