...
namespace Framework.Components.ReleaseLog
{
	public partial class DevelopmentCategoryDataManager : StandardDataManager
	{
        ...
        public static List<DevelopmentCategoryDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(DevelopmentCategoryDataModel.Empty, requestProfile);
		}
        ...
        public static DevelopmentCategoryDataModel GetDetails(DevelopmentCategoryDataModel data, RequestProfile requestProfile)
		{
            var list = GetEntityDetails(data, requestProfile);
		...
		public static bool DoesExist(DevelopmentCategoryDataModel data, RequestProfile requestProfile)
		{
