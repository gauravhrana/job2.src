...
namespace Framework.Components.ReleaseLog
{
	public partial class ReleaseNoteBusinessDifficultyDataManager : StandardDataManager
	{
        ...
        public static List<ReleaseNoteBusinessDifficultyDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(ReleaseNoteBusinessDifficultyDataModel.Empty, requestProfile, 0);
		}
        ...
        public static ReleaseNoteBusinessDifficultyDataModel GetDetails(ReleaseNoteBusinessDifficultyDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(ReleaseNoteBusinessDifficultyDataModel data, RequestProfile requestProfile)
		{
