...
namespace TaskTimeTracker.Components.Module.ApplicationDevelopment
{
	public partial class AllEntityDetailDataManager : BaseDataManager
	{
        ...
        public static List<AllEntityDetailDataModel> GetList(RequestProfile requestProfile)
		{
            return GetEntityDetails(AllEntityDetailDataModel.Empty, requestProfile, 1);
		}
