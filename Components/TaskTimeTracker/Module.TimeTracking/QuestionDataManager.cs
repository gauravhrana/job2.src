...
namespace TaskTimeTracker.Components.BusinessLayer
{
    public partial class QuestionDataManager : BaseDataManager
    {
        ...
        public static List<QuestionDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(QuestionDataModel.Empty, requestProfile, 0);
        }
        ...
        public static string ToSQLParameter(QuestionDataModel data, string dataColumnName)
        {
            ...
            switch (dataColumnName)
            {
                ...
                case QuestionDataModel.DataColumns.QuestionCategory:
                    if (!string.IsNullOrEmpty(data.QuestionCategory))
                    {
                        returnValue = string.Format(SQL_TEMPLATE_PARAMETER_STRING_OR_DATE, QuestionDataModel.DataColumns.QuestionCategory, data.QuestionCategory);
                    }
                    else
                    {
                        returnValue = string.Format(SQL_TEMPLATE_PARAMETER_NULL, QuestionDataModel.DataColumns.QuestionCategory);
                    }
                    break;
        ...
        public static QuestionDataModel GetDetails(QuestionDataModel data, RequestProfile requestProfile)
        {
