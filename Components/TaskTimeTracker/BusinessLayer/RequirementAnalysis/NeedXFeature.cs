...
namespace TaskTimeTracker.Components.BusinessLayer
{
	public partial class NeedXFeatureDataManager : BaseDataManager
	{
        ...
        public static DataTable GetList(RequestProfile requestProfile)
		{
			...
			var oDT = new DBDataTable("NeedXFeature.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(NeedXFeatureDataModel data, RequestProfile requestProfile)
		{
			var sql = "EXEC dbo.NeedXFeatureSearch " +
                " " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
				", " + ToSQLParameter(data, NeedXFeatureDataModel.DataColumns.NeedXFeatureId);

			var oDT = new DBDataTable("NeedXFeature.Details", sql, DataStoreKey);
