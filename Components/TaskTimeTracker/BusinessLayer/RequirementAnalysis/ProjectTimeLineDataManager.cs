...
namespace TaskTimeTracker.Components.BusinessLayer
{
    public partial class ProjectTimeLineDataManager : BaseDataManager
    {
        ...
        public static List<ProjectTimeLineDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(ProjectTimeLineDataModel.Empty, requestProfile, 1);
        }
		...
		public static ProjectTimeLineDataModel GetDetails(ProjectTimeLineDataModel data, RequestProfile requestProfile)
		{
