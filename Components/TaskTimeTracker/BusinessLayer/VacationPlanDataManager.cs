...
namespace TaskTimeTracker.Components.BusinessLayer
{
    public partial class VacationPlanDataManager : StandardDataManager
    {
        ...
        public static DataTable GetDetails(VacationPlanDataModel data, RequestProfile requestProfile)
        {
        ...
        public static int Create(VacationPlanDataModel data, RequestProfile requestProfile)
        {
            ...
            var vacationPlanId = DBDML.RunScalarSQL("VacationPlan.Insert", sql, DataStoreKey);
            return Convert.ToInt32(vacationPlanId);
        }
        ...
        public static DataTable DoesExist(VacationPlanDataModel data, RequestProfile requestProfile)
        {
