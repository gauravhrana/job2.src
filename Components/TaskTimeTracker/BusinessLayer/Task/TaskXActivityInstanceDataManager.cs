...
namespace TaskTimeTracker.Components.BusinessLayer.Task
{
    public partial class TaskXActivityInstanceDataManager : StandardDataManager
    {
        ...
        public static List<TaskXActivityInstanceDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(TaskXActivityInstanceDataModel.Empty, requestProfile);
        }
        ...
        public static TaskXActivityInstanceDataModel GetDetails(TaskXActivityInstanceDataModel data, RequestProfile requestProfile)
        {
