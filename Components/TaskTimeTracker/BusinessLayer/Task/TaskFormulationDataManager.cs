...
namespace TaskTimeTracker.Components.BusinessLayer.Task
{
    public partial class TaskFormulationDataManager : BaseDataManager
    {
        ...
        public static List<TaskFormulationDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(TaskFormulationDataModel.Empty, requestProfile, 1);
        }
        #endregion GetList
