...
namespace TaskTimeTracker.Components.BusinessLayer
{
    public partial class TaskXDeliverableArtifactDataManager : BaseDataManager
    {
        ...
        public static List<TaskXDeliverableArtifactDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(TaskXDeliverableArtifactDataModel.Empty, requestProfile);
        }
        ...
        public static TaskXDeliverableArtifactDataModel GetDetails(TaskXDeliverableArtifactDataModel data, RequestProfile requestProfile)
        {
