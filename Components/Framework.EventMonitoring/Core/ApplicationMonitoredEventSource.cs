...
namespace Framework.Components.EventMonitoring
{
	public partial class ApplicationMonitoredEventSourceDataManager : BaseDataManager
	{
		...
		public static DataTable GetList(RequestProfile requestProfile)
		{
			...
			var oDT = new DataAccess.DBDataTable("ApplicationMonitoredEventSource.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(ApplicationMonitoredEventSourceDataModel data, RequestProfile requestProfile)
		{
		...
		public static DataTable DoesExist(ApplicationMonitoredEventSourceDataModel data, RequestProfile requestProfile)
		{
			var sql = "EXEC dbo.ApplicationMonitoredEventSourceSearch " +
			" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
			", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId,requestProfile.ApplicationId) +
