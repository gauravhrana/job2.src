...
namespace Framework.Components.EventMonitoring
{
    public partial class NotificationRegistrarDataManager : BaseDataManager
    {
        ...
        public static NotificationRegistrarDataModel GetDetails(NotificationRegistrarDataModel data, RequestProfile requestProfile)
        {
        ...
        public static bool DoesExist(NotificationRegistrarDataModel data, RequestProfile requestProfile)
        {
