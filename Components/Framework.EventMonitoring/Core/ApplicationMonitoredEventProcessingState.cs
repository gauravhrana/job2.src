...
namespace Framework.Components.EventMonitoring
{
    public partial class ApplicationMonitoredEventProcessingStateDataManager : BaseDataManager
    {
		...
		public static DataTable GetList(RequestProfile requestProfile)
        {
            ...
            var oDT = new DataAccess.DBDataTable("ApplicationMonitoredEventProcessingState.List", sql, DataStoreKey);
            return oDT.DBTable;
        }
		...
		public static DataTable GetDetails(ApplicationMonitoredEventProcessingStateDataModel data, RequestProfile requestProfile)
        {
		...
		public static DataTable DoesExist(ApplicationMonitoredEventProcessingStateDataModel data, RequestProfile requestProfile)
        {
            var sql = "EXEC dbo.ApplicationMonitoredEventProcessingStateSearch " +
            " " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId,requestProfile.AuditId) +
            ", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId,requestProfile.ApplicationId) +
