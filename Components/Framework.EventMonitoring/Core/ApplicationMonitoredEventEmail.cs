...
namespace Framework.Components.EventMonitoring
{
    public partial class ApplicationMonitoredEventEmailDataManager : BaseDataManager
    {
		...
		public static DataTable GetList(RequestProfile requestProfile)
        {
            ...
            var oDT = new DataAccess.DBDataTable("ApplicationMonitoredEventEmail.List", sql, DataStoreKey);
            return oDT.DBTable;
        }
		...
		public static DataTable GetDetails(ApplicationMonitoredEventEmailDataModel data, RequestProfile requestProfile)
        {
		...
		public static DataTable DoesExist(ApplicationMonitoredEventEmailDataModel data, RequestProfile requestProfile)
        {
            var sql = "EXEC dbo.ApplicationMonitoredEventEmailSearch " +
            " " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId,requestProfile.AuditId) +
            ", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId,requestProfile.ApplicationId) +
