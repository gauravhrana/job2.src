...
namespace Framework.Components.EventMonitoring
{
	public partial class NotificationPublisherXEventTypeDataManager : BaseDataManager
	{
		...
		public static DataTable GetList(RequestProfile requestProfile)
		{
			...
			var oDT = new Framework.Components.DataAccess.DBDataTable("NotificationPublisherXEventType.List", sql, DataStoreKey);
			return oDT.DBTable;
		}
		...
		public static DataTable GetDetails(NotificationPublisherXEventTypeDataModel data, RequestProfile requestProfile)
		{
