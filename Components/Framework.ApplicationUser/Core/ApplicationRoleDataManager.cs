...
namespace Framework.Components.ApplicationUser
{
    public partial class ApplicationRoleDataManager : StandardDataManager
    {
        ...
        public static List<ApplicationRoleDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(ApplicationRoleDataModel.Empty, requestProfile, 0);
        }
        ...
        public static ApplicationRoleDataModel GetDetails(ApplicationRoleDataModel data, RequestProfile requestProfile)
        {
            ...
            switch (action)
            {
                case "Create":
                    sql += "dbo.ApplicationRoleInsert  " + "\r\n" +
						...
						", " + ToSQLParameter(data, ApplicationRoleDataModel.BaseDataColumns.ApplicationId);
                    break;
        ...
        public static bool DoesExist(ApplicationRoleDataModel data, RequestProfile requestProfile)
        {
