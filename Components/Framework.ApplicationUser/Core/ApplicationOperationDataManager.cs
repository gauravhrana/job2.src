...
namespace Framework.Components.ApplicationUser
{
    public partial class ApplicationOperationDataManager : StandardDataManager
    {
        ...
        public static List<ApplicationOperationDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(ApplicationOperationDataModel.Empty, requestProfile, 0);
        }
