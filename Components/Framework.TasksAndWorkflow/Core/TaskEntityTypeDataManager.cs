...
{
	public partial class TaskEntityTypeDataManager : StandardDataManager
	{
        private static readonly string DataStoreKey = "";

		static TaskEntityTypeDataManager()
		{
        ...
        public static List<TaskEntityTypeDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(TaskEntityTypeDataModel.Empty, requestProfile, 0);
		}
        ...
        public static TaskEntityTypeDataModel GetDetails(TaskEntityTypeDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(TaskEntityTypeDataModel data, RequestProfile requestProfile)
		{
