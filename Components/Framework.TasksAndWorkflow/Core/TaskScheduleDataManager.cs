...
{
	public partial class TaskScheduleDataManager : BaseDataManager
	{

		static readonly string DataStoreKey = "";

		static TaskScheduleDataManager()
		{
        ...
        public static List<TaskScheduleDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(TaskScheduleDataModel.Empty, requestProfile, 0);
		}
        ...
        public static TaskScheduleDataModel GetDetails(TaskScheduleDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(TaskScheduleDataModel data, RequestProfile requestProfile)
		{
			var doesExistRequest				= new TaskScheduleDataModel();			
			doesExistRequest.TaskEntityId		= data.TaskEntityId;
			doesExistRequest.TaskScheduleTypeId = data.TaskScheduleTypeId;
