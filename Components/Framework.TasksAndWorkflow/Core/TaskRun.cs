...
{
    public partial class TaskRun : BaseDataManager
    {
        ...
        {
            var sql = "EXEC dbo.TaskRunSearch " +
                " " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId);

            var oDT = new Framework.Components.DataAccess.DBDataTable("TaskRun.List", sql, DataStoreKey);
            return oDT.DBTable;
        }
		...
		public static DataTable GetDetails(TaskRunDataModel data, RequestProfile requestProfile)
        {
		...
		public static DataTable DoesExist(TaskRunDataModel data, RequestProfile requestProfile)
        {
