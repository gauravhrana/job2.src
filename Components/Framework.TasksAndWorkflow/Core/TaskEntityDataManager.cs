...
{
	public partial class TaskEntityDataManager : StandardDataManager
	{
        private static readonly string DataStoreKey = "";

		static TaskEntityDataManager()
		{
        ...
        public static List<TaskEntityDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(TaskEntityDataModel.Empty, requestProfile, 0);
		}
        ...
        public static TaskEntityDataModel GetDetails(TaskEntityDataModel data, RequestProfile requestProfile)
		{
		...
		public static bool DoesExist(TaskEntityDataModel data, RequestProfile requestProfile)
		{
