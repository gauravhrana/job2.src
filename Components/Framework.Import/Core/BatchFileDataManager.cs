...
namespace Framework.Components.Import
{
    public partial class BatchFileDataManager : StandardDataManager
    {
        ...
        public static List<BatchFileDataModel> GetList(RequestProfile requestProfile)
        {
            return GetEntityDetails(BatchFileDataModel.Empty, requestProfile, 0);
        }
        ...
        public static BatchFileDataModel GetDetails(BatchFileDataModel data, RequestProfile requestProfile)
        {
        ...
        public static List<BatchFileDataModel> GetEntityDetails(BatchFileDataModel dataQuery, RequestProfile requestProfile, int returnAuditInfo = BaseDataManager.ReturnAuditInfoOnDetails)
        {
            ...
            List<BatchFileDataModel> result;

            using (var dataAccess = new DataAccessBase(DataStoreKey))
            {
                result = dataAccess.Connection.Query<BatchFileDataModel>(sql, parameters, commandType: CommandType.StoredProcedure).ToList();
            }
        ...
        public static bool DoesExist(BatchFileDataModel data, RequestProfile requestProfile)
        {
