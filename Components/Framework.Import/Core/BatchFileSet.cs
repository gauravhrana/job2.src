...
namespace Framework.Components.Import
{
	public partial class BatchFileSetDataManager : StandardDataManager
    {
        ...
        {
			var sql = "EXEC dbo.BatchFileSetSearch" +
                " " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
                ", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId, requestProfile.ApplicationId);

            var oDT = new DataAccess.DBDataTable("BatchFileSet.List", sql, DataStoreKey);
            return oDT.DBTable;
        }
        ...
        public static DataTable GetDetails(BatchFileSetDataModel data, RequestProfile requestProfile)
        {
        ...
        public static DataTable DoesExist(BatchFileSetDataModel data, RequestProfile requestProfile)
        {
