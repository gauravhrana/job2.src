...
namespace Framework.Components.Import
{
    public partial class BatchFileHistoryDataManager : StandardDataManager
    {
        ...
        public static DataTable GetList(RequestProfile requestProfile)
        {
            ...
            var oDT = new DataAccess.DBDataTable("BatchFileHistory.List", sql, DataStoreKey);
            return oDT.DBTable;
        }
        ...
        public static DataTable GetDetails(BatchFileHistoryDataModel data, RequestProfile requestProfile)
        {
			var sql = "EXEC dbo.BatchFileHistorySearch " +
				" " + ToSQLParameter(BaseDataModel.BaseDataColumns.AuditId, requestProfile.AuditId) +
				", " + ToSQLParameter(BaseDataModel.BaseDataColumns.ApplicationId, requestProfile.ApplicationId) +
            ...
            var oDT = new DataAccess.DBDataTable("BatchFileHistory.Details", sql, DataStoreKey);
            return oDT.DBTable;
        }
        ...
        public static DataTable DoesExist(BatchFileHistoryDataModel data, RequestProfile requestProfile)
        {
