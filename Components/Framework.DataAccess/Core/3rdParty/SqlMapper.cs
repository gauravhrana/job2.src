...
this IDbConnection cnn, string sql, dynamic param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
		...
		//private static void AppendSQLExceptionDetail(Exception exception, CommandDefinition command)
		//{
...
this IDbConnection cnn, string sql, object param, IDbTransaction transaction, int? commandTimeout, CommandType? commandType
        ...
        private static IEnumerable<T> QueryImpl<T>(this IDbConnection cnn, CommandDefinition command, Type effectiveType)
        {
	        ...
	        var sp = new Log4Net.TraceContext();
	        var counter = 0;
            ...
            try
            {
				...
				sp = Log4Net.LogSqlInfoStart(cmd.CommandText, cnn.Database, param, 8);
            ...
            {
				Log4Net.LogSQLInfoStop(sp, counter, 8);
