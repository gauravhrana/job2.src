		...
		public static string ToSQLParameter(TxTradeAndSettleDatesDataModel data, string dataColumnName)
		{
			...
			switch (dataColumnName)
			{
				case TxTradeAndSettleDatesDataModel.DataColumns.TxTradeAndSettleDatesId:
					if (data.TxTradeAndSettleDatesId != null)
					{
					...
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_NULL, TxTradeAndSettleDatesDataModel.DataColumns.TxTradeAndSettleDatesId);
					}
					break;
				...
				case TxTradeAndSettleDatesDataModel.DataColumns.FromSearchTradeDate:
					...
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_STRING_OR_DATE, TxTradeAndSettleDatesDataModel.DataColumns.FromSearchTradeDate, data.FromSearchTradeDate);
					}
					else
					{
				...
				case TxTradeAndSettleDatesDataModel.DataColumns.ToSearchTradeDate:
					...
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_STRING_OR_DATE, TxTradeAndSettleDatesDataModel.DataColumns.ToSearchTradeDate, data.ToSearchTradeDate);
					}
					else
					{
				...
				case TxTradeAndSettleDatesDataModel.DataColumns.FromSearchActualDate:
					...
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_STRING_OR_DATE, TxTradeAndSettleDatesDataModel.DataColumns.FromSearchActualDate, data.FromSearchActualDate);
					}
					else
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_NULL, TxTradeAndSettleDatesDataModel.DataColumns.FromSearchActualDate);
					}
					break;
				...
				case TxTradeAndSettleDatesDataModel.DataColumns.ToSearchActualDate:
					...
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_STRING_OR_DATE, TxTradeAndSettleDatesDataModel.DataColumns.ToSearchActualDate, data.ToSearchActualDate);
					}
					else
					{
				...
				case TxTradeAndSettleDatesDataModel.DataColumns.FromSearchContractualDate:
					...
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_STRING_OR_DATE, TxTradeAndSettleDatesDataModel.DataColumns.FromSearchContractualDate, data.FromSearchContractualDate);
					}
					else
					{
				...
				case TxTradeAndSettleDatesDataModel.DataColumns.ToSearchContractualDate:
					...
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_STRING_OR_DATE, TxTradeAndSettleDatesDataModel.DataColumns.ToSearchContractualDate, data.ToSearchContractualDate);
					}
					else
					{
				...
				case TxTradeAndSettleDatesDataModel.DataColumns.CreatedDate:
					...
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_STRING_OR_DATE, TxTradeAndSettleDatesDataModel.DataColumns.CreatedDate, data.CreatedDate);
					}
					else
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_NULL, TxTradeAndSettleDatesDataModel.DataColumns.CreatedDate);
					}
					break;
				...
				case TxTradeAndSettleDatesDataModel.DataColumns.UpdatedDate:
					...
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_STRING_OR_DATE, TxTradeAndSettleDatesDataModel.DataColumns.UpdatedDate, data.UpdatedDate);
					}
					else
					{
						returnValue = string.Format(SQL_TEMPLATE_PARAMETER_NULL, TxTradeAndSettleDatesDataModel.DataColumns.UpdatedDate);
					}
					break;
